                  ...
                  children: [
                    Container(
                        ...
                        child: DecoratedBox(
                          ...
                          child: Align(
                              alignment: Alignment.center, child: Text("AAPL")),
                        )),
                    SizedBox(
...
class SearchStockWindow extends StatefulWidget {
  @override
  _SearchStockWindowState createState() => _SearchStockWindowState();
}

class _SearchStockWindowState extends State<SearchStockWindow>{
  @override
