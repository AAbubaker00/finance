...
class CustomMaterialStyle implements Style {
  ...
  @override
  Color get arcLabelOutsideLeaderLine => MaterialPalette.red.shadeDefault;

  @override
  Color get defaultSeriesColor => MaterialPalette.red.shadeDefault;

  @override
  Color get arcStrokeColor => ColorUtil.fromDartColor(Colors.red);
  ...
  @override
  Color get noDataColor => MaterialPalette.red.shadeDefault;

  @override
  Color get rangeAnnotationColor => MaterialPalette.red.shadeDefault;

  @override
  Color get sliderFillColor => MaterialPalette.white;

  @override
  Color get sliderStrokeColor => MaterialPalette.red.shadeDefault;
