...
class QuoteObject {
  ...
  QuoteObject.fromMap(var document, {String n, String s, String e})
      : name = n,
        currency = e == 'LSE'? 'GBX' : ForexConversion().currencySymbols.firstWhere(
            (currency) =>
                currency['symbol'] ==
        ...
        exchange = e,
        regularMarketPrice =
            double.parse(document.getElementsByClassName('price')[0].children.first.text.replaceAll(new RegExp(r'[A-Z]',), '').replaceAll(' ', '')),
