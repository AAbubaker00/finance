...
class Quote {
  ...
  Quote.fromMap(Map data)
      : name = data.containsKey('longName')
        ...
        containsDividendDate = data.containsKey('dividendDate') && data['dividendDate'] != '',
        containsTrailingAnnualDividendRate =
            data.containsKey('trailingAnnualDividendRate') && data['trailingAnnualDividendRate'] != '',
        containsTrailingAnnualDividendYield =
            data.containsKey('trailingAnnualDividendRate') && data['trailingAnnualDividendRate'] != null;
}
