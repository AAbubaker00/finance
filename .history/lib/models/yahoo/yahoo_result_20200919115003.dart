...
class YahooQuoteResult {
  ...
  factory YahooQuoteResult.fromJson(Map<String, dynamic> quoteJsonData) {
    return YahooQuoteResult(
        ...
        twoHundredDayAverageChangePercent:quoteJsonData['twoHundredDayAverageChangePercent'],
        ...
        firstTradeDateMilliseconds:quoteJsonData['firstTradeDateMilliseconds'],
