...
class YahooQuote{
  YahooQuote_response yahooQuoteResponse
}


class YahooQuote_esponse {
  YahooQuote_result result;
  String error;

  YahooQuote_response({this.result, this.error});

  YahooQuote_response.fromJson(Map<String, dynamic> parsedJSON) {
    YahooQuote_response(
        result: parsedJSON['property'], error: parsedJSON['error']);
  }
}
