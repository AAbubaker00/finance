...
class YahooApiService {
  ...
  static String _sAssetsEndPoint = "ht tps://query1.finance.yahoo.com/v10/finance/quoteSummary/";
  
  static String lloy.l?modules=assetProfile"
  ...
  void getYahooDividends(String symbol, String exchange) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        List<List<dynamic>> dividendData = csv.CsvToListConverter().convert(response.body);
