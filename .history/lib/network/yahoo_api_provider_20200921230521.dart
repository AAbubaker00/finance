...
class YahooApiService {
  ...
  void getYahooCompanyAssets(String symbol, String exchange) async {
    ...
    _sAssetsEndPoint = "https://query1.finance.yahoo.com/v10/finance/quoteSummary/lloy.l?modules=assetProfile";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        responseJson = responseJson["quoteSummary"]["result"][]["assetProfile"];
