...
import 'package:finance/models/yahoo/yahoo_assets_results.dart';
...
class YahooApiService {
  ...
  Future<List<Yahoo_Assets_Results>> getYahooCompanyAssets(
      String symbol, String exchange) async {
    exchangeCheck(symbol, exchange);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (var a in responseJson) {
          asssets.add(Yahoo_Assets_Results.fromJson(a));
        }

        return asssets;
      }

      return List<Yahoo_Assets_Results>();
