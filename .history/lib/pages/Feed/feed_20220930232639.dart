...
class _FeedState extends State<Feed> {
  ...
  Widget build(BuildContext context) {
    ...
    return CWScaffold(
        ...
        child: Container(
            decoration: BoxDecoration(
                boxShadow: [
                  BoxShadow(
                    color:
                        widget.dataObject.theme ? Colors.black.withOpacity(.4) : Colors.grey.withOpacity(0.4),
                    spreadRadius: 5,
                    blurRadius: 7,
      ...
      body: CWListView(
        children: feed.docs.map((post) => PostCard(dataObject: widget.dataObject,post: (post.data(),)).toList(),
      ),
    );
  }
}
