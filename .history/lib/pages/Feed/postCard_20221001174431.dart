      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(post.user,style: CustomTextStyles(dataObject.theme,dataObject.context)
                              .holdingSubValueStyle, ),
              Text(DateTime.now().difference(DateTime.parse(post.date)).toString(), style: CustomTextStyles(dataObject.theme,dataObject.context)
                              .holdingSubValueStyle, )
            ],
          ),
          Text(post.title, style: CustomTextStyles(dataObject.theme,dataObject.context)
                              .holdingSubValueStyle, ),
