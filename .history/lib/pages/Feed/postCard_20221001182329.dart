...
class PostCard extends StatelessWidget {
  ...
  PostCard({Key key, this.dataObject, this.post, this.isFirst}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => print('s'),
      child: Ink(
        decoration: isFirst? CustomDecoration(dataObject.theme).baseContainerDecoration: CustomDecoration(dataObject.theme).baseContainerDecoration,
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(top: 5.0, bottom: 17),
              child: Text(
