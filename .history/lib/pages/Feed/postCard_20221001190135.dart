            ...
            Row(
              children: [
                Row(
                  children: [
                    InkWell(
                      onTap: () async { post.likes.add(dataObject.user.uid); await DatabaseService().feedCollection.doc(feedUid).set(PostObject(title, description, likes, user, userUid, date, img, section, comments))},
                      child: Image.asset(
