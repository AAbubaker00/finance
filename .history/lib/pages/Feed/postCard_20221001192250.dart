          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                ...
                style: CustomTextStyles(dataObject.theme, dataObject.context).seeAllTextStyle.copyWith(                          color: UserThemes(dataObject.theme).textColor, fontWeight: FontWeight.w500),
),
            ),
            Padding(
