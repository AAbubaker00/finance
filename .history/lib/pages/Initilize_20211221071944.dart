...
class Initialize {
  ...
  Initialize({DocumentSnapshot documentSnapshot, this.context, this.states, this.initalData, this.rates}) {
    ...
    if (currentUser.isAnonymous) {
      ...
      userDetails = initalData['userDetails'];
    } else {
     ...
     Navigator.pushReplacement(
          ...
          MaterialPageRoute(
              ...
              settings: RouteSettings(arguments: {
                'initalData': portfoliosJson['initalData'],
                'portfolios': portfoliosJson['portfolios'],
                'userDetails': portfoliosJson['userDetails'],
                'filteredStocks': portfoliosJson['filteredStocks'],
                'lastUpdate': portfoliosJson['lastUpdate'],
                'lastMarketCall': portfoliosJson['lastMarketCall'],
                'offlineData': true,
                'states': statesJson == '' ? SampleData().getSampleStates()['states'] : statesJson['states'],
                'rates': portfoliosJson['rates']
              })));
