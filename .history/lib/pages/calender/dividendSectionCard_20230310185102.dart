...
class DividendSection extends StatelessWidget {
  ...
  DividendSection({Key key, this.dataObject, this.sectionData}) : super(key: key);
      ...
      children: [
        Container(
          ...
          decoration: CustomDecoration(dataObject.theme).curvedContainerDecoration.copyWith(
            ...
            // border: Border.all(color: greenVarient),
            //   color: UserThemes(dataObject.theme)
            //       .greenVarient
            //       .withOpacity(DateTime.now().isAfter(DateTime.parse(sectionData['date'])) ? .8 : .3)
                  ),
          child: Column(
            ...
            RichText(
                ...
                text: TextSpan(children: <TextSpan>[
                  TextSpan(
                    ...
                    style: CustomTextStyles(dataObject.theme, dataObject.context).feedDateStyle,
                  ),
