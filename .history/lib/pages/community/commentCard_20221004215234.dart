...
class CommentCard extends StatelessWidget {
  ...
  CommentCard({Key key, this.dataObject, this.comment, this.feedUid, this.post}) : super(key: key);
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      print(post.comments.contains(CommentObject().commentObjectToMap(comment)));
