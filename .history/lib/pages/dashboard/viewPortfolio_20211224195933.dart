...
class _ViewPortfolioState extends State<ViewPortfolio> with  with AutomaticKeepAliveClientMixin, WidgetsBindingObserver {
  @override
  void dispose() {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                FittedBox(
                  fit: BoxFit.fitWidth,
                  child: Text('VALUE', style: CustomTextStyles(widget.dataObject.themeMode).tableHeaderStyle),
                ),
                Row(
        ...
        children: [
          ...
          Ink(
            ...
            child: GridView.count(
              ...
              crossAxisCount: 1,
              mainAxisSpacing: 5,
              childAspectRatio: (widget.dataObject.ratio <= 1.6) ? 8.5 : ((widget.dataObject.width/ widget.dataObject.height) / .115),
              children: holdings.map((holding) {
                return InkWell(
                  ...
                  onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ViewHolding(dataObject: widget.dataObject,),
                          settings: RouteSettings(arguments: {
                            'holding': holding,
