          ...
          body: ListView(children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color: DarkTheme(isDark).backgroundColour, borderRadius: BorderRadius.circular(10)),
                child: Text(
                  "We're sorry to see you go. If you want to permanently delete your account click Delete Account.",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      color: DarkTheme(isDark).textColorVarient, fontSize: 20, fontWeight: FontWeight.w400),
                ),
              ),
            ),
            Padding(
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color: DarkTheme(isDark).purpleVarient, borderRadius: BorderRadius.circular(10)),
                child: TextButton(
