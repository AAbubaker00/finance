          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // ),
                Column(
                  children: List.generate(widget.dataObject.portfolios.length+1, (index) => index == widget.dataObject.portfolios.length+1? Container() : widget.dataObject.portfolios.) widget.dataObject.portfolios
