...
class _DashboardState extends State<Dashboard> {
  ...
  Future<bool> initalise() async {
    while (portfolios.length != doc['portfolios'].length) {
      for (var portfolio in doc['portfolios']) {
        ...
        portfolios.add(pObject);
      }

      for(var portfolio in portfolios){
        portfolio.changePercent = (portfolio.change / portfolio.invested
      }
    }

    return Future.value(true);

    // print(portfolios.first.holdings.first.currency);
  }
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        children: List.generate(portfolios.length + 1,
                                (index) => index == portfolios.length ? Container() : portfolios[index])
