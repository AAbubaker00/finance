...
class _DashboardState extends State<Dashboard> {
  ...
  Future<bool> initalise() async {
    // widget.dataObject.accountObject = AccountObject.fromMap(doc['account']);

    print(AccountObject.fromMap(doc['account']).email);

    // print(widget.dataObject.accountObject.email);
