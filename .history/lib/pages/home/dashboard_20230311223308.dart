...
class _DashboardState extends State<Dashboard> {
  ...
  Future<bool> initalise() async {
    ...
    if (widget.dataObject.portfolios.length != doc['portfolios'].length || widget.dataObject.update) {
      ...
      widget.dataObject.update = false;
  ...
  Widget build(BuildContext context) {
    widget.dataObject.doc = Provider.of<DocumentSnapshot>(context);

    print(widget.dataObject.update.toString());
