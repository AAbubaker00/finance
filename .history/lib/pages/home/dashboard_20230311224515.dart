...
class _DashboardState extends State<Dashboard> {
  ...
  Future<bool> initalise() async {
    ...
    if (widget.dataObject.oldDoc != null) {
      print(widget.dataObject.oldDoc['portfolios'] != doc['portfolios']);
if(mapEquals(      print(doc['portfolios']);
, b))
      print(mapEquals(widget.dataObject.oldDoc['portfolios'], doc['portfolios']).toString());
    }

    if (widget.dataObject.portfolios.length != doc['portfolios'].length ||
        widget.dataObject.oldDoc['portfolios'] != doc['portfolios']) {
      ...
      for (var portfolio in doc['portfolios']) {
        ...
        for (var holding in portfolio['holdings']) {
          try {
            ...
            hObject.quantity = holding['quantity'];
