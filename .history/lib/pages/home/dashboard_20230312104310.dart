    ...
    if (widget.dataObject.portfolios.length != doc['portfolios'].length ||
      ...
      for (var portfolio in doc['portfolios']) {
        ...
        for (var holding in portfolio['holdings']) {
          QuoteObject oHolding = QuoteObject();

          oHolding.quantity = holding['quantity'];
          oHolding.purchasePrice = holding['purchasePrice'];
          oHolding.symbol = holding['symbol'];
          

          pObject.holdings.add(oHolding);
        }
