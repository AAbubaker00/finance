...
class _DashboardState extends State<Dashboard> {
  ...
  getMarketQuotes() async {
    try {
      ...
      print(widget.dataObject.portfolios.first.holdings.first.name);
    } catch (e) {
      print(e.toString());
    }
  ...
  Future<bool> initalise() async {
    ...
    if (widget.dataObject.portfolios.length != doc['portfolios'].length ||
      ...
      for (var portfolio in doc['portfolios']) {
        var pObject = PortfolioObject.fromMap(portfolio);

        for (var hObject in portfolio['holdings']) {
          pObject.holdings.add(QuoteObject.docFromMap(hObject));
        }
