...
import 'package:Valuid/shared/pageWarnings/offline.dart';
...
class _DashboardState extends State<Dashboard> {
  ...
  Future<bool> initalise() async {
    ...
    if (widget.dataObject.firstLoad == false || widget.dataObject.oldDoc == null ||
  ...
  getNetworkState() async {
    isOnline = await Network('').getConnectionStatus();
