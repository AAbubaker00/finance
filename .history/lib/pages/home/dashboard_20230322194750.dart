  ...
  getMarketQuotes() async {
    ...
    try {
      for (var portfolio in widget.dataObject.portfolios) {
        List<QuoteObject> b = await YahooApiService().getYahooQuoteList(portfolio.holdings);
        b.length > 0 ? portfolio.holdings = QuoteObject().combineToList(portfolio.holdings, b) : null;
      }
                ...
                children: [
                  ...
                  Flexible(
                    child: Padding(
                      ...
                      child: Text(
                        widget.dataObject.user.displayName,
