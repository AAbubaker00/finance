          ...
          body: ListView(children: [
            ...
            Padding(
              ...
              child: Text(
                ...
                style:
                    TextStyle(color: DarkTheme(isDark).textColor, fontSize: 17, fontWeight: FontWeight.w400),
              ),
            ),
            Padding(
              ...
              child: Form(
                ...
                data['userDetails']['userName'] = name.isEmpty ? data['userDetails']['userName'] : name;
                data['userDetails']['userEmail'] = email.isEmpty ? data['userDetails']['userEmail'] : email;
