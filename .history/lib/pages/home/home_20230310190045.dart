...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    // PrintFpdasunctions().printStartEndLine(CustomTextStyles( context).appBarTitleStyle.fontSize);
    ...
    return Container(
      ...
      child: CustomScaffold(
        ...
        onItemTap: (index) {},
        children: [
          StreamProvider<QuerySnapshot>(create: create, initialData: initialData)
          StreamBuilder(
