              ...
              children: [
                Column(
                  children: [
                    ...
                    Text(
                      "Total Invested", style: TextStyle(fontSize: 20, color: Colors.white70)
                    )
                  ],
                ),
                Column(
                  children: [Text("552", style: TextStyle(fontSize: 20, color: Colors.white70)), Text("Total Return", style: TextStyle(fontSize: 20, color: Colors.white70))],
                )
              ],
            ),
            Column(
