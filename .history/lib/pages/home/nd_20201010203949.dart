        ...
        return Container(
          child: DecoratedBox(
            ...
            child: Container(
              ...
              child: DecoratedBox(
                decoration: BoxDecoration(
                  border: Border(left: BorderSide(color: Colors.red, width: 2), top: BorderSide(color: Colors.grey[300], width: 2), right: BorderSide(color: Colors.red, width: 2), bottom: BorderSide(color: Colors.grey[300], width: 2))
                ),
                              child: Row(
                  children: [
                    Column(
