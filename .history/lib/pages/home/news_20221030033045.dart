...
class _NewsState extends State<News> {
  Future<bool> getNews() async {
    ...
    if (widget.dataObject.news.isEmpty ||
      ...
      for (var holding in widget.dataObject.onStockHoldings) {
      ...
      if (selectedProvider == 'Yahoo') {
        for (var holding in widget.dataObject.onCryptoHoldings) {
  ...
  Widget build(BuildContext context) {
    void viewPortfoliosBottomSheet() {
          ...
          return MainCustomBottomSheet(
            ...
            widget: Container(
              child: ListView(
                ...
                children: widget.dataObject.portfolios.map<Widget>((p) {
                  return Column(
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                            ...
                            onTap: () {
                              widget.dataObject.onPortfolio = p;
                              bottomSheetSetState(() {});
                              ...
                              Future.delayed(Duration(milliseconds: 300), () => Navigator.pop(ctxt));
                              Future.delayed(Duration(milliseconds: 900), () => setState(() {}));
                      ...
                      CustomDivider(dataObject: widget.dataObject),
                    ],
                  );
                }).toList(),
              ),
            ...
            return CWScaffold(
                ...
                appBarTitleWidget: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      InkWell(
                        onTap: () => viewPortfoliosBottomSheet(),
                ...
                body: CWListView(
                  ...
                  children: widget.dataObject.userFire.isAnonymous
                      ...
                      : widget.dataObject.news
                          .firstWhere(
                              (pNews) => pNews['name'] == widget.dataObject.onPortfolio['name'])['news']
                          .map<Widget>((feed) => Padding(
                                padding: EdgeInsets.only(
                                    bottom: widget.dataObject.news
                                                .firstWhere((pNews) =>
                                                    pNews['name'] ==
                                                    widget.dataObject.onPortfolio['name'])['news']
                                                .last ==
                                            feed
                                        ? 10
                                        : 0,
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              Padding(
                                                                ...
                                                                child: Text('More News on ${feed['symbol']}',
                                                                    style: CustomTextStyles(
