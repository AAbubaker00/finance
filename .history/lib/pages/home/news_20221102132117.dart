    ...
    if (widget.dataObject.news.isEmpty ||
      ...
      for (var holding in widget.dataObject.stocks) {
        ...
        if (result.isNotEmpty) {
          ...
          yahooNews.shuffle();
          widget.dataObject.news = yahooNews;
        }
      }
                      ...
                      : widget.dataObject.news.first
                          .map<Widget>((feed) => Padding(
                                ...
                                child: Container(
                                  ...
                                  //     color: VarientColours()
                                  //         .customColours[widget.dataObject.news.first['news'].indexOf(feed)]
                                  //         .withOpacity(.2),
                                  //     border: Border.symmetric(
                                  //         horizontal: BorderSide(
                                  //             color: VarientColours()
                                  //                 .customColours[
                                  //                     widget.dataObject.news.first['news'].indexOf(feed)]
                                  //                 .withOpacity(.1),
                                  //             width: .7))),
                                  child: Column(
                                    ...
                                    children: [
                                      // Padding(
                                      //   padding:
                                      //       const EdgeInsets.only(bottom: 15.0, top: 10, right: 15, left: 5),
                                      //   child: Text(
                                      //     feed['name'],
