        ...
        builder: (context, snapshot) {
          ...
          if (isNewsLoaded) {
            return CWScaffold(
                ...
                appBarTitleWidget: SingleChildScrollView(
                ...
                body: CustomScrollView(
                  ...
                  slivers:
                      ...
                      widget.dataObject.news.first['news']
                          .map<Widget>((feed) => SliverStickyHeader(
                                header: Container(
                                      ...
                                      style:
                                          CustomTextStyles(widget.dataObject.theme, widget.dataObject.context)
                                              ...
                                              .copyWith(
                                                  ...
                                                  color: UserThemes(widget.dataObject.theme).blueVarient_2)),
                                ),
                                sliver: SliverList(
                                  ...
                                  (context, index) => Container(
                                    ...
                                    child: Column(
                                              ...
                                              children: [
                                                NewsCard(
                                                  dataObject: widget.dataObject,
                                                  feed: feed['news'][index],
                                                ),
                                                feed['news'].getRange(0, 4).toList().last != feed['news'][index]
                                                    ? CustomDivider(
                                                        dataObject: widget.dataObject,
                                                      )
                                                    : Padding(
