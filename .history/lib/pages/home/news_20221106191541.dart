                    ...
                    child: Container(
                      decoration: BoxDecoration(
                          border: Border(
                              bottom: BorderSide(
                                  width: .7,
                                  color: UserThemes(widget.dataObject.theme).seperator.withOpacity(.7)))),
                      ...
                      : widget.dataObject.news
                          .map<Widget>((feed) => Padding(
                                ...
                                child: Ink(
                                  ...
                                  decoration: widget.dataObject.news.first == feed
