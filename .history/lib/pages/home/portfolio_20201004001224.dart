...
class _ViewPortfolioState extends State<ViewPortfolio> with SingleTickerProviderStateMixin{
  List stocks = [
    "apple",
    "apple",
    "apple",
  ...
  TabController _tabController = TabController(length: 2,initialIndex: 0);
  ...
  void initState() {
    ...
    _tabController = TabController(length: 2, vsync: this, initialIndex: )
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: new NestedScrollView(
        ...
        body: new TabBarView(
          children: <Widget>[Text("aaaa"), Text("aaa")],
          controller: _tabController,
        ),
      ),
    );
