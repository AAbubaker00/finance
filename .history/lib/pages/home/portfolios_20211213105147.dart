        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(portfolioName, style: CustomTextStyles(themeMode).sectionHeader),
                InkWell(
                    splashColor: Colors.transparent,
                    focusColor: Colors.transparent,
                    hoverColor: Colors.transparent,
                    highlightColor: Colors.transparent,
                    onTap: () => Navigator.pushNamed(context, '/editPortfolio', arguments: data)
                        .then((value) => setState(() => portfolioName = data['portfolio']['name'])),
                    child: ClipRRect(
                        child: Image.asset(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // IconButton(
                          //   onPressed: () => setState(() => isPrivate = !isPrivate),
                          //   icon: Icon(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                FittedBox(fit: BoxFit.fitWidth, child: Text('EARNINGS', style: headerStyle)),
                                SizedBox(
                                  height: 5,
                                ),
                                FittedBox(
