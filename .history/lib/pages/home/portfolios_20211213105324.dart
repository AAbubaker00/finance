                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    //   child: Text(
                                    //     'VALUE',
                                    //     style:                                               style: CustomTextStyles(themeMode).headerStyle,
,
                                    //   ),
                                    // ),
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text('${portfolioValue.toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}',
...
,
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          FittedBox(
                                              fit: BoxFit.fitWidth,
                                              child: Text('EARNINGS', style:                                               style: CustomTextStyles(themeMode).headerStyle,
)),
                                          SizedBox(
                                            height: 5,
                                          ),
