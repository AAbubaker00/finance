  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: SafeArea(
        ...
        body: TabBarView(controller: _tabController, children: [getHoldings()]),
      )),
    );
  }
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text('Holdings', style: CustomTextStyles(themeMode).sectionHeader),
              ),
              Ink(
                width: width,
                child: GridView.count(
                  ...
                  children: portfolios[0]['assets'][0]['items'].map<Widget>((holding) {
                    return InkWell(
                      // onLongPress: () => _editHoldingFunction(holding),
                      // onTap: ()
                      //     // {
                      //     //   // editholding = holding;
                      //     //   _viewHoldingFunction(holding);
                      //     // },
                      //     =>
                      //     Navigator.pushNamed(context, '/viewHolding', arguments: {
                      //   'holding': holding,
                      //   'themeMode': themeMode,
