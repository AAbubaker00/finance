...
class _PortfoliosState extends State<Portfolios> with TickerProviderStateMixin {
  ...
  TabBar get _tabBar => TabBar(
        ...
        unselectedLabelColor: color: UserThemes(themeMode).blueVarient, ,
        labelStyle: TextStyle(fontWeight: FontWeight.w500),
        unselectedLabelStyle: TextStyle(color: UserThemes(themeMode).textColor, fontWeight: FontWeight.w500),
