              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: TextFormField(
                      focusNode: focusNode,
                      style: TextStyle(fontSize: 16, color: UserThemes(isDark).textColor),
                      decoration: InputDecoration(
                        icon: ClipRRect(
                          child: Image.asset(
                            'assets/icons/search.png',
                            color: UserThemes(isDark).textColorVarient.withOpacity(.5),
                            fit: BoxFit.fill,
                            scale: 25,
                          ),
                        ),
                        ...
                        hintStyle: TextStyle(
                            color: UserThemes(isDark).textColorVarient.withOpacity(.5), fontSize: 16),
