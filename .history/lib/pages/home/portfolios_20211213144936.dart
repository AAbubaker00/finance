              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: TextFormField(
                      focusNode: focusNode,
                      style: TextStyle(fontSize: 16, color: DarkTheme(isDark).textColor),
                      decoration: InputDecoration(
                        ...
                        hintStyle: TextStyle(
                            color: DarkTheme(isDark).textColorVarient.withOpacity(.5), fontSize: 16),
                        hintText: "Search Assets",
                      ),
                      onChanged: (txt) async {
                        txt = txt.toLowerCase();
                        setState(() {
                          assetSearch = stocks.where((stock) {
                  ...
                  Row(
                    children: [
                      DropdownButton<String>(
                        ...
                        isDense: true,
                        items: sortOptions.map<DropdownMenuItem<String>>((String option) {
                      ...
                      // IconButton(
                      //   onPressed: () {
                      //     // Navigator.pushNamed(context, '/finCalender',
                      //     //     arguments: {'stocks': stocks, 'data': data});
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: TextFormField(
                      focusNode: focusNode,
                      style: TextStyle(fontSize: 16, color: UserThemes(themeMode).textColor),
                      decoration: InputDecoration(
                        icon: ClipRRect(
                          child: Image.asset(
                            'assets/icons/search.png',
                            color: UserThemes(themeMode).textColorVarient.withOpacity(.5),
                            fit: BoxFit.fill,
                            scale: 25,
                          ),
                        ),
                        ...
                        disabledBorder: InputBorder.none,
                        hintStyle: TextStyle(
                            color: UserThemes(themeMode).textColorVarient.withOpacity(.5), fontSize: 16),
                        hintText: "Search Assets",
                      ),
                      onChanged: (txt) async {
                        txt = txt.toLowerCase();
                  ...
                  Row(
                    children: [
                      DropdownButton<String>(
                        dropdownColor: UserThemes(themeMode).insideColour,
                        icon: Icon(
                          Icons.sort,
                          color: UserThemes(themeMode).textColorVarient.withOpacity(.5),
                          size: 25,
                        ...
                        items: sortOptions.map<DropdownMenuItem<String>>((String option) {
                          return DropdownMenuItem<String>(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                  color: selectedSortOption == option
                                      ? UserThemes(themeMode).goldVarient
