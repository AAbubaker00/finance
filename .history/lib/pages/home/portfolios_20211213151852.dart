...
class _PortfoliosState extends State<Portfolios> with TickerProviderStateMixin {
  ...
  TabBar get _tabBar => TabBar(
        ...
        tabs: [
          Tab(
            child: Text('Holdings'.toUpperCase()),
          ),
          Tab(
            child: Text('Diversification'.toUpperCase()),
          ),
          // Tab(
          //   child: Text('SETTINGS'),
          // ),
...
// print(holdingType['items'].first['marketData']['chartData']['max']);
    ...
    return Container(
      ...
      child: SafeArea(
        ...
        body: TabBarView(controller: _tabController, children: [getHoldings(), Text('data'), ]),
      )),
    );
  }
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: Container(
                          decoration: BoxDecoration(
                    color: UserThemes(themeMode).backgroundColour, borderRadius: BorderRadius.circular(5)),
