...
class _PortfoliosState extends State<Portfolios> with TickerProviderStateMixin {
  ...
  TabBar get _tabBar => TabBar(
        ...
        labelColor: UserThemes(themeMode).blueVarient,
        unselectedLabelColor: UserThemes(themeMode).textColorVarient,
        ...
        // labelPadding: EdgeInsets.symmetric( 10),
    ...
    return Container(
      ...
      child: SafeArea(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          actions: [
            Icon(Icons.sort_by_alpha_rounded, color: UserThemes(themeMode).iconColour),
            SizedBox(width: 15,),
            Icon(Icons.sort, color: UserThemes(themeMode).iconColour),
            SizedBox(width: 15,),
            Icon(Icons.settings, color: UserThemes(themeMode).iconColour),
            SizedBox(width: 15,)
          ],
          title: InkWell(
              child: Row(
                ...
                children: [
                  Text(portfolios[0]['name'], style: CustomTextStyles(themeMode).pageHeaderStyle.copyWith(fontSize: 20),),
                  SizedBox(
                    width: 5,
                  ),
                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        child: TextFormField(
                          focusNode: focusNode,
                          style: TextStyle(fontSize: 15, color: UserThemes(themeMode).textColor),
                          decoration: InputDecoration(
                            ...
                            hintStyle: TextStyle(color: UserThemes(themeMode).textColor, fontSize: 15),
                            hintText: "SEARCH HOLDINGS",
                          ),
                          onChanged: (txt) async {
                            txt = txt.toLowerCase();
                            setState(() {
                              assetSearch = holdings.where((stock) {
                                var quoteName = stock['marketData']['quote']['longName'].toLowerCase();
                    ...
                    Padding(
                      ...
                      child: Icon(Icons.add_circle_outline_sharp, color: UserThemes(themeMode).iconColour),
                    )
                  ],
                ),
              ),
