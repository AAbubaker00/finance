                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          ...
                          if (fireUser.isAnonymous || _u.providerData[0].providerId == 'google.com') {
                            setState(() {
                              isDelete = true;
                            });
                          } else {
                        ...
                        Container(
                          ...
                          child: TextButton(
                            ...
                            child: Text(
                              'KEEP ACCOUNT',
                              style:
                                  TextStyle(color: DarkTheme(isDark).textColor, fontSize: 18, fontWeight: FontWeight.w600),
                            ),
                          ),
                        ),
                        Container(
                          ...
                          child: TextButton(
                            ...
                            child: Text(
                              'DELETE ACCOUNT',
                              style:
                                  TextStyle(color: DarkTheme(isDark).backColour, fontSize: 18, fontWeight: FontWeight.w600),
                            ),
                          ),
                        ),
                      ],
