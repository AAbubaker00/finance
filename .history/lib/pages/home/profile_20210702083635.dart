              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Delete Account',
                    style: TextStyle(
                        color: DarkTheme(isDark).textColor, fontSize: 22, fontWeight: FontWeight.bold),
                  ),
                  SizedBox(
                    height: 20,
                  ),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          color: DarkTheme(isDark).purpleVarient.withOpacity(isDataChanged ? 1 : .4),
                        ...
                        onPressed: () async {
                          if (_formKey.currentState.validate() && isDataChanged) {
                            ...
                            await DatabaseService(uid: user.uid)
                              ...
                              'userName': data['userDetails']['userName'] : name,
                              'userEmail': data['userDetails']['userEmail'] : email,
