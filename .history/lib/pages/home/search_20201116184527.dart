                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          Text("H ${stock['quote']['regularMarketDayHigh']}"),
                          Text("L ${stock['quote']['regularMarketDayLow']}"),
                          Text("Vol ${stock['quote']['regularMarketVolume']}"),
                          Text(
                              "Market  ${stock['quote']['marketCap'].toString().replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}"),
                        ],
                      )
                    ],
                  ),
