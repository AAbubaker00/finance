                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          Text("H ${stock['quote']['regularMarketDayHigh'].toString())}"),
                          Text("L ${double.parse(stock['quote']['regularMarketDayLow'].toString())}"),
                          Text("Vol ${double.parse(stock['quote']['regularMarketVolume'].toString())}"),
                          Text(
                              "Market Cap ${double.parse(stock['quote']['marketCap'].toString()).toString().replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}"),
                        ],
                      )
                    ],
                  ),
