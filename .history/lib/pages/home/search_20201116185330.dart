                    ...
                    children: [
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text(stock['quote']['longName'].toString()),
                                ],
                              ),
                              Row(
                                children: [
                                  Text(stock['quote']['regularMarketPrice'].toString()),
                                  Column(
                                    children: [
                                      Text(stock['quote']
                                          ['regularMarketChange'].toString()),
                                      Text(stock['quote']
                                          ['regularMarketChangePercent'].toString()),
                                    ],
                                  ),
                                ],
                              )
                      ...
                      Row(
                        children: [
                          ...
                          Text("L ${stock['quote']['regularMarketDayLow'].toString()}"),
                          Text("Vol ${stock['quote']['regularMarketVolume'].toString()}"),
                          Text(
