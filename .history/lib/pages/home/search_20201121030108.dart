                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                      "${stock['quote']['regularMarketChange'].toStringAsFixed(2)}", style: TextStyle(color: (double.parse(stock['quote']['regularMarketChange'].toString()) < 0? Colors.red: Colors.green) ),),
                                  Text(
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                              "H ${stock['quote']['regularMarketDayHigh'].toString()}"),
                          Text(
