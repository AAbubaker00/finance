                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Text('H ', style: TextStyle(color: Colors.grey[600]),),
                              Text(
                                  "${stock['quote']['regularMarketDayHigh'].toString()}", style: TextStyle(color: Colors.black)),
                            ],
                          ),
                          Row(
                            children: [
                              ...
                              Text(
                                  "${stock['quote']['regularMarketDayLow'].toString()}", style: TextStyle(color: Colors.black),),
                            ],
                          ),
                          Row(
                            children: [
                              Text('Vol ', style: TextStyle(color: Colors.grey[600])),
                              Text(
                                  "${stock['quote']['regularMarketVolume'].toString()}", style: TextStyle(color: Colors.black)),
                            ],
                          ),
                          Row(
                            children: [
                              Text('Market Cap ', style: TextStyle(color: Colors.grey[600])),
                              Text(
                                  "${stock['quote']['marketCap'].toString().replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}", style: TextStyle(color: Colors.black)),
                            ],
                          ),
                        ],
                      )
