...
class _SearchState extends State<Search> {
  ...
  Widget build(BuildContext context) {
    void _showSelectedStockPanel(Map stock) {
      showModalBottomSheet(
          ...
          context: context,
          builder: (context) {
            return _stockPanel(stock, context);
          });
    }
  ...
  _stockPanel(Map stock, BuildContext context) {
    return Column(
      children: [
        Expanded(
              ...
              child: Container(
                ...
                child: DecoratedBox(
                  decoration: BoxDecoration(
                      color: Colors.black,
                      borderRadius: BorderRadius.circular(10)),
                  child: Text('Add to Portfolio', style: TextStyle(color: Colors.white,),textAlign: TextAlign.center,)
                ),
              ),
            ),
          ),
