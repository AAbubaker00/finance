                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text('Select Portfolio', style: TextStyle(fontSize: 20)),
                            ),
                            SizedBox(
                              height: MediaQuery.of(context).size.height * 0.04,
                              child: Container(
                            ...
                            Padding(padding: EdgeInsets.all(10), child: Text('Options', style: TextStyle(color: Colors.black, fontSize: 20),),),
                            Container(
                              color: Colors.white,
                              padding: EdgeInsets.all(10),
                              child: Align(
