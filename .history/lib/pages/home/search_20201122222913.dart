                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                validator: (txt) =>
                                    txt.isEmpty ? 'Enter Price*' : (double.tryParse(txt) != null? null: 'Enter a Valid Amount'),
                                decoration: InputDecoration(
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                validator: (txt) =>
                                    txt.isEmpty ? 'Enter N. of Shares' : (double.tryParse(txt) != null? null: 'Enter a Valid Amount'),
                                decoration: InputDecoration(
                                  labelText: 'N. Shares',
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(10),
                            ...
                            SizedBox(
                              ...
                              child: Container(
                                ...
                                child: ListView.builder(
                                    itemCount:
                                        portfolioData['portfolios'].length,
                                    scrollDirection: Axis.horizontal,
                                    itemBuilder: (context, index) {
                                      return InkWell(
                                        onTap: () {
