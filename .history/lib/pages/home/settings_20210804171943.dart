...
class _SettingsState extends State<Settings> {
  ...
  Widget build(BuildContext context) {
    ...
    setOptionDescitpionStyle = TextStyle(color: DarkTheme(isDark).textColorVarient)
                              ...
                              Expanded(
                                child: Ink(
                                  ...
                                  padding:
                                     ...
                                     decoration: BoxDecoration(
                              border: Border(bottom: BorderSide(color: DarkTheme(isDark).border.withOpacity(.7)))
                            ),
                                    child: Column(
                                      children: [
                                        Row(
                                        ...
                                        Text('Dividends, Dividends Ex-Dates Price Alerts, Splits', style: TextStyle(color: DarkTheme(isDark).textColorVarient),)
                                      ],
                                    ),
                                  ),
                                ),
