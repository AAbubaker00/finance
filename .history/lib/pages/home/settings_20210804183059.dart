...
class _SettingsState extends State<Settings> {
  TextStyle setOptionStyle, headerStyle, setOptionDescriptionStyle;
  ...
  Widget build(BuildContext context) {
    ...
    setOptionDescriptionStyle = TextStyle(color: DarkTheme(isDark).textColorVarient);
            ...
            child: ListView(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.symmetric(horizontal:BorderSide( color: DarkTheme(isDark).border)),
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      border: Border(
                                          bottom:
                                              BorderSide(color: DarkTheme(isDark).border.withOpacity(.7)))),
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'Account ID, Email, Username, Account Deletion',
                                            style: setOptionDescriptionStyle,
                                          )
                                        ],
                                      ),
                                      Icon(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            'Sync to Cloude',
                                            style:
                                                setOptionStyle.copyWith(color: DarkTheme(isDark).textColor),
                                          ),
                                          SizedBox(
                                            height: 5,
                                          ),
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Dividends, Dividends Ex-Dates, Price Alerts, Splits',
                                              style: setOptionDescriptionStyle,
                                            )
                                          ],
                                        ),
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          border: Border(
                                              bottom: BorderSide(
                                                  color: DarkTheme(isDark).border.withOpacity(.7)))),
                                      child: Row(
                                        crossAxisAlignment: CrossAxisAlignment.center,
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Column(
                                            ...
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text('Prices Update Frequency', style: setOptionStyle),
                                              SizedBox(
                                                height: 5,
                                              ),
                                              Text(
                                                'Real-Time, 10-min Delay, 15-min Delay',
                                                style: setOptionDescriptionStyle,
                                              )
                                            ],
                                          ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Import', style: setOptionStyle),
                                            SizedBox(
                                              height: 5,
                                            ),
                                            Text(
                                              'Upload Existing Portfolios from Device',
                                              style: setOptionDescriptionStyle,
                                            )
                                          ],
                                        ),
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text('Export', style: setOptionStyle),
                                              SizedBox(
                                                height: 5,
                                              ),
                                              Text(
                                                'Download Portfolios to Device',
                                                style: setOptionDescriptionStyle,
                                              )
                                            ],
                                          ),
