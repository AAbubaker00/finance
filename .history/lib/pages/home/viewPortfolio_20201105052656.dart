...
class _ViewPortfolioState extends State<ViewPortfolio>
  ...
  List months = [
    {'id': "January", 'stocks': [], 'status': 'na', 'upcoming': 'no'},
    {'id': "February", 'stocks': [], 'status': 'na', 'upcoming': 'no'},
    {'id': "March", 'stocks': [], 'status': 'na', 'upcoming': 'no'},
    {'id': "April", 'stocks': [], 'status': 'na', 'upcoming': 'no'},
    {'id': "May", 'stocks': [], 'status': 'na', 'upcoming': 'no'},
    {'id': "June", 'stocks': [], 'status': 'na', 'upcoming': 'no'},
    {'id': "July", 'stocks': [], 'status': 'na', 'upcoming': 'no'},
    {'id': "August", 'stocks': [], 'status': 'na', 'upcoming': 'no'},
    {'id': "September", 'stocks': [], 'status': 'na', 'upcoming': 'no'},
    {'id': "October", 'stocks': [], 'status': 'na', 'upcoming': 'no'},
    {'id': "November", 'stocks': [], 'status': 'na', 'upcoming': 'no'},
    {'id': "December", 'stocks': [], 'status': 'na', 'upcoming': 'no'}
  ];
