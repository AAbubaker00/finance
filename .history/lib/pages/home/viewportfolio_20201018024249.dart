                ...
                Container(
                  ...
                  child: DecoratedBox(
                    ...
                    child: Column(
                      ...
                      children: [Text(s['symbol']), Text(s['name']), Text('${(double.parse(s['buyPrice'].toString())*double.parse(s['shares'].toString())).toStringAsFixed(fractionDigits)}')]
                    ),
                  ),
                ),
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [Text("Value: £34k"), Text("shares: 32342"), Text('Avg. Cost: 2122')],
                      ),
                      Column(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        crossAxisAlignment: CrossAxisAlignment.end,
                        children: [Text("£2732 gain"), Text('APPL: ^ 0.54%'), Text("")],
                      ),
                    ],
                  ),
                ),
