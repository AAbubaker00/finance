                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text('${s['symbol']}: '),
                              Text(
                                  '${((double.parse(s['marketPrice'].toString()) - double.parse(s['buyPrice'].toString())) / double.parse(s['buyPrice'].toString())*100).toStringAsFixed(2)}%', style: TextStyle(Color.black),)
                            ],
                          ),
                          Text("")
                        ],
