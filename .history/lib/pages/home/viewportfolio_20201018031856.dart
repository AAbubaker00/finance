                    ...
                    child: DecoratedBox(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Text(s['name']),
                            Text(
                                '${(double.parse(s['buyPrice'].toString()) * double.parse(s['shares'].toString())).toStringAsFixed(2)}')
                          ]),
                    ),
                  ),
                ),
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                  ...
                                  style: TextStyle(color: ((double.parse(s['marketPrice'].toString()) - double.parse(s['buyPrice'].toString())) / double.parse(s['buyPrice'].toString())*100) > 0? Colors.green: Colors.red),)
                            ],
                          ),
                          Text("")
                        ],
