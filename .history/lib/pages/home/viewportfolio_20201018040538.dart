          ...
          child: Container(
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                  ...
                  border: Border(
                    left: BorderSide(
                        color: (double.parse(stocks[index]['change'].toString()) > 0
                            ? Colors.green
                            : Colors.red),
                        width: 3),
                  )),
                      ...
                      child: DecoratedBox(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  '${((double.parse(stocks[index]['buyPrice'].toString()) * double.parse(stocks[index]['shares'].toString())).toStringAsFixed(2)).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}')
                            ]),
                      ),
                    ),
                  ),
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Value: ${stocks[index]['change']}"),
                            Text("shares: ${stocks[index]['shares']}"),
                            Text('Avg. Cost: 2122')
                          ],
                        ),
                        Column(
                          ...
                          children: [
                            Text(
                              "${stocks[index]['change']} £ gain",
                              style: TextStyle(
                                  color: ((double.parse(stocks[index]['marketPrice']
                                                      .toString()) -
                                                  double.parse(stocks[index]['buyPrice']
                                                      .toString())) /
                                              double.parse(
                                                  stocks[index]['buyPrice'].toString()) *
                                              100) >
                                          0
                                      ? Colors.green
                                      : Colors.red),
                            ...
                            Row(
                              children: [
                                Text('${stocks[index]['symbol']}: '),
                                Text(
                                  '${((double.parse(stocks[index]['marketPrice'].toString()) - double.parse(stocks[index]['buyPrice'].toString())) / double.parse(stocks[index]['buyPrice'].toString()) * 100).toStringAsFixed(2)}%',
                                  style: TextStyle(
                                      color: ((double.parse(stocks[index]['marketPrice']
                                                          .toString()) -
                                                      double.parse(stocks[index]['buyPrice']
