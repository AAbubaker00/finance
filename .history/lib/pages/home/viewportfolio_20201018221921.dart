    ...
    return Scaffold(
      body: DefaultTabController(
        ...
        child: NestedScrollView(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  Column(
                                    children: [
                                      Text(data['totalShares']),
                                      Text("Total Shares")
                                    ],
                                  ),
                                  Column(
                                    children: [
                                      Text(double.parse(data['investedValue'].toString()).toStringAsFixed(fractionDigits)),
                                      Text("Total Invested")
                                    ],
                                  ),
                                  Column(
          ...
          body: TabBarView(
            children: <Widget>[_assets(), Text("bb"), Text("cc")],
            controller: _tabController,
          ),
        ),
      ),
