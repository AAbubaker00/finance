      ...
      body: DefaultTabController(
        ...
        child: NestedScrollView(
          ...
          headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
            return <Widget>[
              SliverAppBar(
                actions: [IconButton(icon: Icon(Icons.sort), onPressed: null)],
...
class DropdownScreen extends StatefulWidget {
  State createState() =>  _DropdownScreenState();
}
class _DropdownScreenState extends State<_DropdownScreenState> {
  Item sortOption;
