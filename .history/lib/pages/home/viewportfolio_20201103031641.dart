...
/* -------------------------------------------------------------------------- */
  ...
  sectorChart() {
    List sectorChartDataTable = [];

    for (var sector in sectors) {
      sectorChartDataTable
          .add(new Sectors(name: sector['name'], value: sector['value']));
    }

    return charts.Series<Sectors, String>(
      id: 'Sectors',
      domainFn: (Sectors sector, _) => name.
    );
  }
}
