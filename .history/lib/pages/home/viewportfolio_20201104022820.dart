        ...
        child: Row(
              children: [
                Column(
                  children: [
                    Row(
                      children: [Text('Net Assets Return'), Text('')], //value of whole account
                    ),
                    Row(
                      children: [Text('Number Of holdings'), Text('')], //oldest stock held date
                    ),
                    Row(
                      children: [Text('Base Currency'), Text('')], //oldest stock held date
                    ),
                    Row(
                      children: [Text('P/E Ratio'), Text('')], //oldest stock held date
                    ),
                    Row(
                      children: [Text('Largest Sector Holding'), Text('')], //oldest stock held date
                    ),
                  ],
                ),Column(
                  children: [
                    Row(
                      children: [Text('inital Assets Value'), Text('')], //oldest stock held date
                    ),
                    Row(
                      children: [Text('Shares Outstanding'), Text('')], //oldest stock held date
                    ),
                    Row(
                      children: [Text('Launch Date'), Text('')], //oldest stock held date
                    ),
                    Row(
                      children: [Text('P/B Ratio'), Text('')], //oldest stock held date
                    ),
                    Row(
                      children: [Text('Largest Asset Holding'), Text('')], //oldest stock held date
                    ),
                  ],
                ),
              ],
