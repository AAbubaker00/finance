...
class _ViewPortfolioState extends State<ViewPortfolio>
  ...
  List months = [
    {'id': "January", 'stocks': [], 'status': 'na'},
    {'id': "February", 'stocks': [], 'status': 'na'},
    {'id': "March", 'stocks': [], 'status': 'na'},
    {'id': "April", 'stocks': [], 'status': 'na'},
    {'id': "May", 'stocks': [], 'status': 'na'},
    {'id': "June", 'stocks': [], 'status': 'na'},
    {'id': "July", 'stocks': [], 'status': 'na'},
    {'id': "August", 'stocks': [], 'status': 'na'},
    {'id': "September", 'stocks': [], 'status': 'na'},
    {'id': "October", 'stocks': [], 'status': 'na'},
    {'id': "November", 'stocks': [], 'status': 'na'},
    {'id': "December", 'stocks': [], 'status': 'na'}
  ];
    ...
    for (var month in months) {
      for (var stock in stocks) {
        try {
          ...
          DateTime parsDivDate = DateTime.parse(sDivMonth);
          // print(parsDivDate.month);

          if (parsDivDate.month == (months.indexOf(month) + 1)) {
            month['status'].add("2"); = 'active';
            month['status']
            print(month);
          }
        } catch (e) {}
              ...
              child: DecoratedBox(
                  ...
                  child: GridView.count(
                    ...
                    children: months.map((month) {
                      ...
                      // print(stocks[0]);
                      try {
                        // print(DateTime.parse(stocks[1]['marketData']
                        //         ['calanderEvents']['dividendDate']['fmt'])
                        //     .month);

                        // print(months.indexOf(month));

                        for (int i = 0; i < stocks.length + 1;) {
                          String sDivMonth = stocks[i]['marketData']
                              ['calanderEvents']['dividendDate']['fmt'];
                          DateTime parsDivDate = DateTime.parse(sDivMonth);
                          print(stocks[i]['marketData']['calanderEvents']
                              ['dividendDate']['fmt']);
                          ...
                          //     DateTime.parse(stock['marketData']
                          //             ['calanderEvents']['dividendDate']['fmt'])
                          //         .month) {
                          //   print(month['id']);
                          // }
                          // print(DateTime.parse(stock['marketData']
                          //         ['calanderEvents']['dividendDate']['fmt'])
                          //     .month);
                        }
