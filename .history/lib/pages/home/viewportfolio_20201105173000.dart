...
class _ViewPortfolioState extends State<ViewPortfolio>
  ...
  List months = [
    {'id': "January", 'stocks': [], 'status': 'na', 'upcoming': 'yes'},
    {'id': "February", 'stocks': [], 'status': 'na', 'upcoming': 'yes'},
    {'id': "March", 'stocks': [], 'status': 'na', 'upcoming': 'yes'},
    {'id': "April", 'stocks': [], 'status': 'na', 'upcoming': 'yes'},
    {'id': "May", 'stocks': [], 'status': 'na', 'upcoming': 'yes'},
    {'id': "June", 'stocks': [], 'status': 'na', 'upcoming': 'yes'},
      ...
      for (var stock in stocks) {
        try {
          ...
          if (parexSectorivDate.month == (months.indexOf(month) + 1)) {
            ...
            if (upComingDividends.isEmpty && (months.indexOf(month) + 1) >= DateTime.now().month ) {
      ...
      child: Column(
        children: [
          ...
          Container(
            child: Column(
              children: [
                Text((isSelectedMonth == true)? 'Upcoming Dividends': 'Next Dividends'),
                Container(
                  child: ListView(
                    children: upComingDividends.map((key, value){
                      if(key == 'stocks'){
