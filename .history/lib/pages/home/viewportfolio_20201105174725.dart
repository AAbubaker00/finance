...
class _ViewPortfolioState extends State<ViewPortfolio>
  ...
  List months = [
    {'id': "January", 'stocks': [], 'status': 'na', 'upcoming': 'yes', 'totalPayment': '0'},
    {'id': "February", 'stocks': [], 'status': 'na', 'upcoming': 'yes', 'totalPayment': '0'},
    {'id': "March", 'stocks': [], 'status': 'na', 'upcoming': 'yes', 'totalPayment': '0'},
    {'id': "April", 'stocks': [], 'status': 'na', 'upcoming': 'yes', 'totalPayment': '0'},
    {'id': "May", 'stocks': [], 'status': 'na', 'upcoming': 'yes', 'totalPayment': '0'},
    {'id': "June", 'stocks': [], 'status': 'na', 'upcoming': 'yes', 'totalPayment': '0'},
    {'id': "July", 'stocks': [], 'status': 'na', 'upcoming': 'yes', 'totalPayment': '0'},
    {'id': "August", 'stocks': [], 'status': 'na', 'upcoming': 'yes', 'totalPayment': '0'},
    {'id': "September", 'stocks': [], 'status': 'na', 'upcoming': 'yes', 'totalPayment': '0'},
    {'id': "October", 'stocks': [], 'status': 'na', 'upcoming': 'yes', 'totalPayment': '0'},
    {'id': "November", 'stocks': [], 'status': 'na', 'upcoming': 'yes', 'totalPayment': '0'},
    {'id': "December", 'stocks': [], 'status': 'na', 'upcoming': 'yes', 'totalPayment': '0'}
  ];
  ...
  bool iexSectorividendsTab = false;
  bool isChartsTab = false;
  bool isSelectedMonth = false;

  Map selectedMonth = {};
  List<Map<String, dynamic>> upComingDividends = [{}];
      ...
      for (var stock in stocks) {
        try {
          ...
          if (parexSectorivDate.month == (months.indexOf(month) + 1)) {
            ...
            print(stock['marketData']['quote']["trailingAnnualDividendYield"]);

            if (upComingDividends.isEmpty &&
                (months.indexOf(month) + 1) >= DateTime.now().month) {
              upComingDividends.add(month);
              print(month);
            }
    ...
    return Container(
      child: Column(
        children: [
          Container(
              padding: EdgeInsets.only(left: 10, right: 10),
              height: MediaQuery.of(context).copyWith().size.height * 0.27,
          ...
          Container(
            child: Column(
              children: [
                Text((isSelectedMonth == true)
                    ? 'Upcoming Dividends'
                    : 'Next Dividends'),
                Container(
                  child: ListView(
                    children: upComingDividends.map((month) {
                      return 
                    }).toList(),
                  )
                                 )
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        children: [
                          Container(
                              padding: EdgeInsets.only(top: 10),
                              child: SizedBox(child: stocksChart())),
                        ],
                      ))
                    ],
                  ),
