                      ...
                      Column(
                        children: [
                          ...
                          Column(
                            children: [
                              Text(
                                  'exDividend Dtae: ${upcomingDividendStocks[index]['marketData']['calanderEvents']['dividendDate']['fmt']}'),
                              Text('Dividend Date: ${upcomingDividendStocks[index]['marketData']['calanderEvents']['exdividendDate']['fmt']}'),
                            ],
                          )
                        ],
                      )
