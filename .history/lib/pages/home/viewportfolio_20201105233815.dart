                  ...
                  child: Row(
                    children: [
                      ...
                      Column(
                        children: [
                          Text(
                              'Amount: ${upcomingDividendStocks[index]['marketData']['calanderEvents']['exDividendDate']['fmt']}'),
                          Text(
                              'Yield: ${upcomingDividendStocks[index]['marketData']['calanderEvents']['dividendDate']['fmt']}'),
                              Text('Shares: ${upcomingDividendStocks[index]['shares']}')
                        ],
                      )
                    ],
                  ),
