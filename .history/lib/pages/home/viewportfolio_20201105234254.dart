                ...
                child: DecoratedBox(
                  ...
                  child: Row(
                    children: [
                      Column(
                        children: [
                          Text(upcomingDividendStocks[index]['marketData']
                              ['quote']['symbol']),
                          Text(upcomingDividendStocks[index]['marketData']
                              ['quote']['longName']),
                        ],
                      ...
                      Column(
                        children: [
                          Text(
                              'exDiv Date: ${upcomingDividendStocks[index]['marketData']['calanderEvents']['exDividendDate']['fmt']}'),
                          Text(
                              'Div Date: ${upcomingDividendStocks[index]['marketData']['calanderEvents']['dividendDate']['fmt']}'),
                        ],
                      ),
                      Column(
                        children: [
                          Text(
                              'Amount: ${upcomingDividendStocks[index]['marketData']['defaultKeyStatistics']['lastDividendValue']['raw']}'),
                          Text(
                              'Yield: ${upcomingDividendStocks[index]['marketData']['quote']['trailingAnnualDividendYield']}'),
                          Text(
                              'Shares: ${upcomingDividendStocks[index]['shares']}')
                        ],
                      ),
                      Column(children: [
                        Text('${(double.parse(upcomingDividendStocks[index]['marketData']['defaultKeyStatistics']
                                ['lastDividendValue']['raw']
                            .toString()) *
                        double.parse(upcomingDividendStocks[index]['shares'].toString()))}')
                      ],)
                    ],
                  ),
                ),
