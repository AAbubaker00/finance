                      ...
                      Row(
                        children: [
                          Column(
                            children: [
                              Text('${upcomingDividendStocks[index]['marketData']
                                  ['quote']['symbol']}, ${upcomingDividendStocks[index]['marketData']
                                  ['quote']['longName']}'),
                              Text(
                          ...
                          Column(
                            children: [
                              Text(
                                  'piad: ${upcomingDividendStocks[index]['shares']}${upcomingDividendStocks[index]['marketData']['defaultKeyStatistics']['lastDividendValue']['raw']}'),
                              // Text('Total Payment'),
                              Text(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              Text('Shares'),
                              Text(
                                  '${upcomingDividendStocks[index]['shares']}'),
                            ],
                          ),
                          Column(
                            children: [
                              Text(
                                  'piad: ${upcomingDividendStocks[index]['marketData']['defaultKeyStatistics']['lastDividendValue']['raw']}'),
                              // Text('Total Payment'),
                              Text(
                                  '${(double.parse(upcomingDividendStocks[index]['marketData']['defaultKeyStatistics']['lastDividendValue']['raw'].toString()) * double.parse(upcomingDividendStocks[index]['shares'].toString()))}'),
                            ],
