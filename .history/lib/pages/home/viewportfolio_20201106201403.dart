        ...
        ConstrainedBox(
          ...
          child: ListView(
              ...
              children: (months.firstWhere(
                      (month) => month['status'] == 'active' && months.indexOf(upComingDividends) < months.indexOf(month), orElse: () => {'stocks'[]}))['stocks'].map<Widget>((stock) {
                return (stocks.isEmpty)? Center(child: Text('No Scheduled Dividends ')): Text("sdada");
              }).toList()),
        )
      ],
    ));
