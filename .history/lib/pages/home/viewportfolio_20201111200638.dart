...
class _ViewPortfolioState extends State<ViewPortfolio>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButtonLocation: FloatingActionButtonLocation.f,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              "${(double.parse(s['marketData']['quote']
                                                          ['regularMarketPrice'].toString()) * double.parse(s['shares'].toString())).toStringAsFixed(2)}",
                              style: TextStyle(
