...
/*                              Section: Holdings                             */
/* -------------------------------------------------------------------------- */
  List<Color> sectorColors = [Colors.white, Colors.red, Colors.blue];

  _holding() {
    return Container(
      child: ListView(
          children: sectors.map((sctr) {
        print(sectorColors.indexOf(Colors.blue));
        print(sectors.indexOf(sctr));
        return Container(
          color: (sectors.indexOf(sctr) == 0)
              ? sectorColors[sectors.indexOf(sctr)]
              : sectorColors[sectors.indexOf(sctr) - 1],
          child: DecoratedBox(
            decoration: BoxDecoration(
                color: (sectors.indexOf(sctr) == 1)? Colors.blue: sectorColors[(sectors.indexOf(sctr)) + 1],
