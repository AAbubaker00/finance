                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          Text(
                                            '${stk['change']}  (${((double.parse((stk['marketData']['quote']['regularMarketPrice']).toString()) - double.parse(stk['buyPrice'].toString())) / double.parse(s['buyPrice'].toString()) * 100).toStringAsFixed(2)} %)',
                                            style: TextStyle(
