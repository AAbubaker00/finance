...
/*                              Section: Holdings                             */
/* -------------------------------------------------------------------------- */
  List<Color> sectorColors = [Colors.white, Colors.red, Colors.purple];
    ...
    return Container(
      child: ListView(
        ...
        return Container(
          ...
          child: DecoratedBox(
            decoration: BoxDecoration(
                color: sectorColors[(sectors.indexOf(sctr)) + 1],
                      ...
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                            ...
                            border: Border(
                              left: BorderSide(
                                  color:
                                      (double.parse(stk['change'].toString()) > 0
                                          ? Colors.green
                                          : Colors.red),
                                  width: 3),
                            )),
                              ...
                              child: Container(
                                ...
                                child: DecoratedBox(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        Text(stk['symbol']),
                                        Text(stk['marketData']['quote']
                                            ['longName']),
                                        Text(
                                            '${double.parse(stk['buyPrice'].toString())} @ ${stk['shares']}')
                                      ]),
                                ),
                              ),
                            ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        "${(double.parse(stk['marketData']['quote']['regularMarketPrice'].toString()) * double.parse(stk['shares'].toString())).toStringAsFixed(2)}",
                                        style: TextStyle(
                                            color: ((double.parse(stk['marketData']
                                                                        [
                                                                        'quote']
                                                                    [
                                                                    'regularMarketPrice']
                                      ...
                                      Row(
                                        children: [
                                          Text(
                                            '${stk['change']}  (${((double.parse((stk['marketData']['quote']['regularMarketPrice']).toString()) - double.parse(stk['buyPrice'].toString())) / double.parse(stk['buyPrice'].toString()) * 100).toStringAsFixed(2)} %)',
                                            style: TextStyle(
                                                color: ((double.parse(stk['marketData']
                                                                            [
                                                                            'quote']
