                  ...
                  SliverPersistentHeader(
                    delegate: _SliverAppBarDelegate(
                      TabBar(
                        ...
                        tabs: [
                          Tab(child: Text("Securities", style: TextStyle(color:  Color(0xFFF5F6F8), fontSize: 10))),
                          Tab(child: Text("Dividends", style: TextStyle(color:  Color(0xFFF5F6F8), fontSize: 10))),
                          Tab(child: Text("Analysis", style: TextStyle(color:  Color(0xFFF5F6F8), fontSize: 10))),
                        ],
                      ),
                    ),
                    pinned: true,
