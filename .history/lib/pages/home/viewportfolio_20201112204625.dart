      ...
      child: SafeArea(
          ...
          body: DefaultTabController(
            ...
            child: NestedScrollView(
                  ...
                  SliverPersistentHeader(
                    delegate: _SliverAppBarDelegate(
                      TabBar(
                        ...
                        tabs: [
                          Tab(child: Text("Securities", style: TextStyle(color:  Color(0xFFF5F6F8), fontSize: 15))),
                          Tab(child: Text("Dividends", style: TextStyle(color:  Color(0xFFF5F6F8), fontSize: 15))),
                          Tab(child: Text("Analysis", style: TextStyle(color:  Color(0xFFF5F6F8), fontSize: 15))),
                        ],
                      ),
                    ),
                    pinned: true,
              ...
              body: TabBarView(
                children: <Widget>[
                  (isSectorSort? _showSectorAllocations(): _showAllocations()),
                  _dividends(),
                  _analysis(),
                ],
                controller: _tabController,
              ...
              child: GridView.count(
                    ...
                    children: months.map((month) {
                      return InkWell(
                        ...
                        child: AutofillHints.creditCardExpirationYear(
                      ...
                      Text(
                        (investedValue > 999999)
                            ...
                            : investedValue.toStringAsFixed(2).replaceAllMapped(
                                new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'),
                                (Match m) => '${m[1]},'),
                        style: TextStyle(fontSize: 25, color: stdc),
                      ),
                    ],
                  ),
                  SizedBox(
                    ...
                    child: Container(
                      ...
                      child: DecoratedBox(
                        ...
                        child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(s['symbol'], style: TextStyle(color:  Color(0xFFF5F6F8),),),
                              Text(s['marketData']['quote']['longName'], style: TextStyle(color:  Color(0xFFF5F6F8),),),
                              Text(
                                  '${double.parse(s['buyPrice'].toString())} @ ${s['shares']}', style: TextStyle(color:  Colors.white38,)),
                            ]),
                      ),
                    ),
                  ),
