              ...
              headerSliverBuilder:
                ...
                return <Widget>[
                  SliverAppBar(
                    ...
                    backgroundColor: fas,
                    expandedHeight: MediaQuery.of(context).size.h
                    floating: true,
                    pinned: true,
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text((change > 0)?
                      '+${change.toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} (${((change / investedValue) * 100).toStringAsFixed(2)}%)': "${change.toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} (${((change / investedValue) * 100).toStringAsFixed(2)}%)",
                      style: TextStyle(
                          fontSize: 20,
