  ...
  _dividends() {
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          SizedBox(
            height: MediaQuery.of(context.owner.hashCode*0.5),
            child: Container(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        ...
                        child: Card(
                          color: (months[index]['upcoming'].toString() == 'yes')
                              ? Colors.white
                              : Colors.grey[850],
                          child: Stack(
                            children: [
                              Center(child: Text(months[index]['id'])),
                              Align(
                                alignment: Alignment.bottomRight,
                                child: Icon(
                                  Icons.brightness_1,
                                  color: (months[index]['status'] == 'active')
                                      ? Colors.red
                                      : Colors.transparent,
                                  size: 5,
                                ),
