        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Text(
                  'Next Dividends',style: TextStyle(color: Colors.white)
                ),
                Text('Month Total: ${upComingDividends['totalPayment']}', style: TextStyle(color: Colors.white))
              ],
            ),
          ),
          ConstrainedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                                '${upcomingDividendStocks[index]['marketData']['quote']['symbol']}', style: TextStyle(color: Colors.white)),
                            Text(
                                '${upcomingDividendStocks[index]['marketData']['quote']['longName']}', style: TextStyle(color: Colors.white)),
                            Text(
                                '${DateTime.parse(upcomingDividendStocks[index]['marketData']['calanderEvents']['dividendDate']['fmt']).day} ${months[(DateTime.parse(upcomingDividendStocks[index]['marketData']['calanderEvents']['dividendDate']['fmt']).month) - 1]['id']} ${DateTime.parse(upcomingDividendStocks[index]['marketData']['calanderEvents']['dividendDate']['fmt']).year}', style: TextStyle(color: Colors.white)),
                          ],
                        ),
                        Column(
                          children: [
                            Text(
                                '${upcomingDividendStocks[index]['shares']}@${upcomingDividendStocks[index]['marketData']['defaultKeyStatistics']['lastDividendValue']['raw']}', style: TextStyle(color: Colors.white)),
                            // Text('Total Payment'),
                            Text(
                                '${(double.parse(upcomingDividendStocks[index]['marketData']['defaultKeyStatistics']['lastDividendValue']['raw'].toString()) * double.parse(upcomingDividendStocks[index]['shares'].toString()))}', style: TextStyle(color: Colors.white)),
                          ],
                        )
                      ],
                    ),
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text(
                                      '${s['change']}  (${((double.parse(s['change'].toString()) - double.parse(s['buyPrice'].toString())) / double.parse(s['buyPrice'].toString()) * 100).toStringAsFixed(2)}%)',
                                      style: TextStyle(
                                          color: ((double.parse(s['marketData']
                                                                      ['quote'][
                                                                  'regularMarketPrice']
