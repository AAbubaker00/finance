                        ...
                        Container(
                          child: DecoratedBox(
                            ...
                            child: Column(
                              children: [
                                Text(
                                    '${months[(DateTime.parse(upcomingDividendStocks[index]['marketData']['calanderEvents']['dividendDate']['fmt']).month) - 1]['id']}', style: TextStyle(color: Colors.white)),
                                Text(
                                    '${DateTime.parse(upcomingDividendStocks[index]['marketData']['calanderEvents']['dividendDate']['fmt']).day}', style: TextStyle(color: Colors.white)),
                                Text(
                                    '${DateTime.parse(upcomingDividendStocks[index]['marketData']['calanderEvents']['dividendDate']['fmt']).year}', style: TextStyle(color: Colors.white))
                              ],
                            ),
                          ),
                        )
