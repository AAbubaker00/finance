                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          "${(double.parse(s['marketData']['quote']['currency'].toString()) * double.parse(s['shares'].toString())).toStringAsFixed(2)}",
                                          style: TextStyle(
                                              color: Colors.white, fontSize: 25),
                                        ),
                                      ],
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  '${((double.parse(s['change'].toString()) - double.parse(s['buyPrice'].toString())) / double.parse(s['buyPrice'].toString()) * 100).toStringAsFixed(2)}%',
                                  style: TextStyle(
                                      color: ((double.parse(s['marketData']
                                                                  ['quote'][
                                                              'regularMarketPrice']
