                ...
                return <Widget>[
                  SliverAppBar(
                    ...
                    flexibleSpace: FlexibleSpaceBar(
                        centerTitle: true, background: _summary()),
                  ),
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          //       Text('Month Total: ${upComingDividendstock['totalPayment']}',
          //           style: TextStyle(color: Colors.white))
          //     ],
          //   ),
          // ),
                        ...
                        Container(
                          ...
                          child: DecoratedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                    '${monthstock[(DateTime.parse(upcomingDividendStockstock[index]['marketData']['calanderEvents']['dividendDate']['fmt']).month) - 1]['id']}',
                                    style: TextStyle(
                                        color: Colors.white, fontSize: 15)),
                                Text(
                                  '${DateTime.parse(upcomingDividendStockstock[index]['marketData']['calanderEvents']['dividendDate']['fmt']).day}',
                                  style: TextStyle(
                                      color: Colors.white, fontSize: 30),
                                ),
                                Text(
                                    '${DateTime.parse(upcomingDividendStockstock[index]['marketData']['calanderEvents']['dividendDate']['fmt']).year}',
                                    style: TextStyle(
                            ...
                            child: Row(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Text(
                                          '${upcomingDividendStockstock[index]['marketData']['quote']['symbol']}, ',
                                          style: TextStyle(
                                              color: Colors.white,
                                              fontSize: 20),
                                        ),
                                        Text(
                                            '${upcomingDividendStockstock[index]['marketData']['quote']['longName']}',
                                            style: TextStyle(
                                                color: Colors.grey[600],
                                                fontSize: 15)),
                                      ],
                                    ...
                                    Text(
                                        'Shares: ${upcomingDividendStockstock[index]['shares']}',
                                        style: TextStyle(color: Colors.white)),
                                    Text(
                                        'EXDATE: ${upcomingDividendStockstock[index]['marketData']['calanderEvents']['exDividendDate']['fmt']}',
                                        style: TextStyle(
                                            color: Colors.grey[600],
                                            fontSize: 10)),
                                  ],
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                        'Announced: ${upcomingDividendStockstock[index]['marketData']['defaultKeyStatistics']['lastDividendValue']['raw']}',
                                        style:
                                            TextStyle(color: Colors.grey[600])),
                                    Row(
                                      children: [
                                        Text(
                                            '${(double.parse(upcomingDividendStockstock[index]['marketData']['defaultKeyStatistics']['lastDividendValue']['raw'].toString()) * double.parse(upcomingDividendStockstock[index]['shares'].toString()))}',
                                            style: TextStyle(
                                                color: Colors.white,
                                                fontSize: 30,
                                                fontWeight: FontWeight.bold)),
                                        Text(
                                            '${upcomingDividendStockstock[index]['marketData']['quote']['currency']}',
                                            style: TextStyle(
                                                color: Colors.grey[600])),
                                      ],
                                    )
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Text('£', style: subTxtSty),
                Text(
                  portfolioValue.toStringAsFixed(2).replaceAllMapped(
                      new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'),
                      (Match m) => '${m[1]},'),
                  style: TextStyle(fontSize: 50, color: stdc),
                ),
              ],
            ),
            Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      (change > 0)
                          ? '+${change.toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} (${((change / investedValue) * 100).toStringAsFixed(2)}%)'
                          : "${change.toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} (${((change / investedValue) * 100).toStringAsFixed(2)}%)",
                      style: TextStyle(
                          fontSize: 20,
...
/* -------------------------------------------------------------------------- */
  ...
  _showSectorAllocations() {
    return Container(
      child: ListView(
        ...
        return Container(
          color: sectorColorstock[sectors.indexOf(sctr)],
          child: Theme(
                ...
                children: [
                  Container(
                    child: GridView.count(
                      ...
                      mainAxisSpacing: 10,
                      childAspectRatio: 5,
                      children: sctr['stocks'].map<Widget>((s) {
                        return InkWell(
                          child: Container(
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  '${((double.parse(stock['change'].toString()) - double.parse(stock['buyPrice'].toString())) / double.parse(stock['buyPrice'].toString()) * 100).toStringAsFixed(2)}%',
                                  style: TextStyle(
                                      color: ((double.parse(stock['marketData']
                                                                  ['quote'][
                                                              'regularMarketPrice']
  ...
  //                               Text(
  //                                 "${(double.parse(stock['marketData']['quote']['regularMarketPrice'].toString()) * double.parse(stock['shares'].toString())).toStringAsFixed(2)}",
  //                                 style: TextStyle(color: Color(0xFFF5F6F8)),
  //                               ),
  //                               Row(
  //                                 children: [
  //                                   Text(
  //                                     '${stock['change']}  (${((double.parse(stock['change'].toString()) - double.parse(stock['buyPrice'].toString())) / double.parse(stock['buyPrice'].toString()) * 100).toStringAsFixed(2)}%)',
  //                                     style: TextStyle(
  //                                         color: ((double.parse(stock['marketData']
  //                                                                     ['quote'][
  //                                                                 'regularMarketPrice']
...
extension StringExtension on String {
  String capitalizeFirst() {
    return '${thistock[0].toUpperCase()}${this.substring(1)}';
  }
