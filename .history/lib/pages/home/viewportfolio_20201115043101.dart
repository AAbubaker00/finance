                ...
                child: DecoratedBox(
                  ...
                  child: Column(
                    children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  '${((double.parse(stock['change'].toString()) - double.parse(stock['buyPrice'].toString())) / double.parse(stock['buyPrice'].toString()) * 100).toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}%',
                                  style: TextStyle(
                                      color: ((double.parse(stock['marketData']
                                                                  ['quote'][
                                                              'regularMarketPrice']
                      ...
                      Container(
                        child: Text(stock['marketData']['quote']['fullExchangeName'], style: TextStyle(color: Colors.grey[600]),),
                      )
                    ],
                  ),
                ),
