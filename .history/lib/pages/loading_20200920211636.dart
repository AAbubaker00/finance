...
import 'package:csv/csv_to_list_converter.dart';
import 'dart:convert';
...
class _LoadingState extends State<Loading> {
  ...
  void initState() async {
    ...
    http.Response response = await http.get("https://query1.finance.yahoo.com/v7/finance/download/AAPL?period1=1569010146&period2=1600632546&interval=1d&events=history");
    List<List<dynamic>> csvData = CsvToList
  }
