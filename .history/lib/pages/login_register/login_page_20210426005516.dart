            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Column(
                  children: <Widget>[
                    TextFormField(
                      validator: (txt) => txt.isEmpty ? 'Enter _email' : null,
                    ...
                    Text('We do not recognize the email or password',   style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.red),)
                    SizedBox(
                      height: 30,
                    ),
                    Container(
                      ...
                      child: FlatButton(
                        onPressed: () async {
                          if (_formKey.currentState.validate() && _password != '' && _email != '') {
