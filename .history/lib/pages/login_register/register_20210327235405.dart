...
class _RegisterState extends State<Register> {
  ...
  _termsOfServicePanel() {
    return Column(
      ...
      children: [
        new Html(
          data: '<div data-custom-class="body">
...
<div style="color: #595959; font-size: 14px; font-family: Arial; padding-top: 16px;">These terms of use were created using <a style="color: #3030f1 !important;" href="https://termly.io/products/terms-and-conditions-generator/?ftseo">Termly&rsquo;s Terms and Conditions Generator</a>.</div>',
