                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: DarkTheme(1).goldVarient_2,
                          borderRadius: BorderRadius.circular(30),
                        ),
                        child: TextFormField(
                          cursorColor: DarkTheme(1).backColour,
                          validator: (txt) => txt.isEmpty ? 'Enter Name' : null,
                          style: TextStyle(fontSize: 20),
                          decoration: InputDecoration(
                              labelText: 'Name',
                              border: InputBorder.none,
                              labelStyle: TextStyle(color: DarkTheme(1).backColour),
                ...
                children: [
                  ButtonTheme(
                    ...
                    child: FlatButton(
                      ...
                      color: DarkTheme(0).backColour,
                      child: Text(
                        'Register',
                        style: TextStyle(color: DarkTheme(1).goldVarient),
                      ),
                      onPressed: () async {
                  ...
                  FlatButton(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          'Log In',
                          style: TextStyle(color: DarkTheme(1).backColour, fontWeight: FontWeight.w800),
                        )
                      ],
                    ),
                    onPressed: () {
