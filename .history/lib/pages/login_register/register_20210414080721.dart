...
class _RegisterState extends State<Register> {
  ...
  Future<bool> createAccount() async {
    if (_formKey.currentState.validate()) {
      dynamic result =
          await _auth.registerWithEmailAndPassword(email: _email, password: _password, name: _name);
      if (result == null) {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<bool>(
      future: isLoading? createAccount() : null,
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              'Log In',
                              style:
                                  TextStyle(color: DarkTheme(false).backColour, fontWeight: FontWeight.w800),
                            )
                          ],
                        ),
                        onPressed: () {
