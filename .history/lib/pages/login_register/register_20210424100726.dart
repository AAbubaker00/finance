              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(30), color: DarkTheme(false).goldVarient_2),
                    child: Padding(
                      ...
                      child: Center(
                        child: InkWell(
                          ...
                          child: Text(
                            'Register',
                            style: TextStyle(
                                color: DarkTheme(false).goldVarient_2, fontWeight: FontWeight.w800, fontSize: 20),
                          ),
                        ),
                      ),
                    ),
                  ...
                  //       'Register',
                  //       style: TextStyle(
                  //           color: DarkTheme(false).backColour, fontWeight: FontWeight.w800, fontSize: 20),
                  //     ),
                  //     onPressed: () async {
                  //       if (_formKey.currentState.validate()) {
                  //         dynamic result = await _auth.registerWithEmailAndPassword(
