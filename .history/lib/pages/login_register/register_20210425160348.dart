      ...
      return Container(
        ...
        child: SafeArea(
          ...
          appBar: PreferredSize(
            ...
            child: AppBar(
              elevation: 0,
              backgroundColor: DarkTheme(false).goldVarient,
              iconTheme: IconThemeData(
                color: DarkTheme(false).backColour, //change your color here
              ),
            ),
          ),
          body: ListView(
                ...
                child: Stack(
                  children: [
                    Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(left:100.0, right: 100, bottom: 100, top: 50),
                        child: Center(
                    ...
                    Positioned(
                      ...
                      child: Container(
                        height: 50,
                        decoration: BoxDecoration(
                            border: Border(top: BorderSide(color: DarkTheme(false).border, width: 7))),
                        child: Center(
                          child: InkWell(
                            onTap: () {
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  'Login',
                                  style: TextStyle(
                                      color: DarkTheme(false).blueVarient,
