              ...
              Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text(
                      '*We need to verify that you have access to the given email*',
                    ...
                    Text(
                      ...
                      style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: isError? Colors.red:  Colors.transparent),
                      textAlign: TextAlign.center,
                    ),
