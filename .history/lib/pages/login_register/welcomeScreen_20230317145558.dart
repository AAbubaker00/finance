...
import 'package:Valuid/models/user/user.dart' as u;
                        ...
                        InkWell(
                          ...
                          child: Align(
                            ...
                            child: Text(
                              "Forgot Password?",
                              style:
                                  CustomTextStyles(context).holdingSubValueStyle.copyWith(color: blueVarient),
                            ),
                          ),
                        ),
                      ],
                    ...
                    child: isWrongCred
                        ...
                        : isAccountExist
                            ...
                            : Text(
                                ...
                                style: CustomTextStyles(context).deleteTextStyle.copyWith(color: redVarient),
                                textAlign: TextAlign.center,
                              ),
                  ),
                  CWApplyButton(
                      ...
                      if (_formKey.currentState.validate()) {
                        ...
                        if (result == false) {
                          ...
                          Navigator.pushAndRemoveUntil(
                              context, MaterialPageRoute(builder: (context) => Wrapper()), (route) => false);
                        }
                      }
                    },
                  ),
