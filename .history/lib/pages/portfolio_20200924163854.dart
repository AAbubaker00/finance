...
import 'package:flutter_palette/'
import 'dart:ui';
        ...
        body: Stack(
          children: [
            ...
            Positioned(
              ...
              right: 0,
              left: 0,
              child: Theme.of(context).copyWith(accentColor: ColorPalette.fontColor, unselectedWidgetColor: ColorPa)(
                              child: ExpansionTile(
                  title: Align( alignment: Alignment.centerRight, child:Text("View Portfolio Stasistics", style: TextStyle(color: Colors.white),)),
                  children: [
                    ListTile(
                      title: Text("lol"),
                    )
