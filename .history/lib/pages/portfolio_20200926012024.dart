...
import 'package:flip_card/flip_card.dart' as 
import 'dart:ui';
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            Positioned(left: 0, right: 0, top: _fromTop-20, child: Container(padding: EdgeInsets.all(5), child:Row(children: [Text("Top Stocks")],))),
            Positioned(
              bottom: 0,
              top: _fromTop,
              right: 0,
