                ...
                child: Container(
                  padding: EdgeInsets.only(left: 10),
                    child: Row(
                      ...
                      children: [Text("Top Stocks"), FlatButton(onPressed: (){},child: Transform.rotate(angle: 270*math.pi/180,child: Align(alignment:  Alignment.centerRight, child: Icon(Icons.arrow_drop_down_circle),)))],
                    ))),
            Positioned(
                left: 10,
                right: 10,
