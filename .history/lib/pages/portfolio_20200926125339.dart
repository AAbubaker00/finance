                ...
                child: Container(
                  padding: EdgeInsets.only(left: 10),
                    child: Row(
                      ...
                      children: [Text("Top Stocks"), FlatButton(splashColor: Colors.transparent, highlightColor: Colors.transparent, onPressed: (){},child: Transform.rotate(angle: 270*m)  Icon(Icons.menu))],
                    ))),
            Positioned(
                left: 10,
                right: 10,
