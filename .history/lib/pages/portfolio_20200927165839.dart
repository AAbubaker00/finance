        ...
        body: Stack(
          children: [
            ...
            Positioned(
              ...
              child: Column(
                  children: [
                    Flip.FlipCard(width: MediaQuery.of(context).size.width*0.7, height: MediaQuery.of(context).size.height*0.2, child: Charts()),
                    IconButton(onPressed: () => flipCardKey?.currentState?.toggleCard(), icon: Icon(Icons.arrow_forward_ios))
