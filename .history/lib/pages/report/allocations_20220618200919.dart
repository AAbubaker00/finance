        ...
        children: [
          ...
          DataTable(
              ...
              headingRowColor: MaterialStateProperty.resolveWith<Color>((states) {
                return UserThemes(dataObjectwidget.dataObject.theme).seperator.withOpacity(.5);
              }),
              headingRowHeight: 30,
              headingTextStyle: CustomTextStyles(widget.dataObject.theme).sectionSubTextStyle.copyWith(
                  color: UserThemes(dataObjectwidget.dataObject.theme).textColorVarient, fontWeight: FontWeight.w400),
              dataRowHeight: 35,
              dividerThickness: 0,
                      ...
                      DataCell(Text(
                          ...
                          style: CustomTextStyles(widget.dataObject.theme).tableValueStyle.copyWith(
                              ...
                              color: asset.turn.isNegative
                                  ? UserThemes(dataObjectwidget.dataObject.theme).redVarient
                                  : UserThemes(dataObjectwidget.dataObject.theme).greenVarient))),
                    ]);
              }).toList()),
        ],
      ),
        ...
        barRods: [
          BarChartRodData(
            ...
            backDrawRodData: BackgroundBarChartRodData(
              show: true,
              y: 100,
              colors: [UserThemes(dataObjectwidget.dataObject.theme).backgroundColour.withOpacity(.5)],
            ),
          ),
        ],
