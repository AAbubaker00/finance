        ...
        children: [
          ...
          DataTable(
              ...
              headingRowColor: MaterialStateProperty.resolveWith<Color>((states) {
                return UserThemes(dataObject:widget.dataObject.theme).seperator.withOpacity(.5);
              }),
              headingRowHeight: 30,
              headingTextStyle: CustomTextStyles(widget.dataObject.theme).sectionSubTextStyle.copyWith(
                  color: UserThemes(dataObject:widget.dataObject.theme).textColorVarient, fontWeight: FontWeight.w400),
              dataRowHeight: 35,
              dividerThickness: 0,
                      ...
                      DataCell(Text(
                          ...
                          style: CustomTextStyles(widget.dataObject.theme).tableValueStyle.copyWith(
                              ...
                              color: asset.turn.isNegative
                                  ? UserThemes(dataObject:widget.dataObject.theme).redVarient
                                  : UserThemes(dataObject:widget.dataObject.theme).greenVarient))),
                    ]);
              }).toList()),
        ],
      ),
        ...
        barRods: [
          BarChartRodData(
            ...
            backDrawRodData: BackgroundBarChartRodData(
              show: true,
              y: 100,
              colors: [UserThemes(dataObject:widget.dataObject.theme).backgroundColour.withOpacity(.5)],
            ),
          ),
        ],
