...
class Diversification extends StatefulWidget {
  final Map data;
  Diversification(this.data, {Key key}) : super(key: key);

  @override
  _DiversificationState createState() => _DiversificationState(data);
}
...
class _DiversificationState extends State<Diversification> {
  ...
  _DiversificationState(this.data);
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                          ...
                                                          color: sectorSelectedIndex ==
                                                                  sectorCDT.indexOf(sector)
                                                              ? VarientColours()
                                    ...
                                    children: [
                                      Center(
                                        ...
                                        child: CustomCharts(themeMode).customePieChart(
                                          ...
                                          centerData:
                                              sectorCDT[sectorSelectedIndex].weight.toStringAsFixed(2),
                                        ),
                                      )),
                                      Center(
                                          child: SizedBox(
                                        ...
                                        child: CustomCharts(themeMode).customePieChart(
                                          ...
                                          centerData:
                                              ((sectorCDT[sectorSelectedIndex].turn * 100) / totalReturn)
                                                  .toStringAsFixed(2),
                                        ),
                                      )),
                                    ],
                                        ...
                                        rows: sectorCDT.map((s) {
                                          return DataRow(
                                              ...
                                              cells: [
                                                ...
                                                DataCell(
                                                  Text(
                                                      '$currencySymbol${s.value.toStringAsFixed(2).addCommas()}',
                                                      style: tableDataStyle),
                                                ),
                                                DataCell(Text(
                                                    s.turn.isNegative
                                    ...
                                    children: [
                                      Center(
                                        ...
                                        child: CustomCharts(themeMode).customePieChart(
                                          ...
                                          centerData:
                                              industryCDT[industrySelectedIndex].weight.toStringAsFixed(2),
                                        ),
                                      )),
                                      Center(
                                          child: SizedBox(
                                        ...
                                        rows: industryCDT.map((i) {
                                          return DataRow(
                                              ...
                                              cells: [
                                                ...
                                                DataCell(
                                                  Text(
                                                      '$currencySymbol${i.value.toStringAsFixed(2).addCommas()}',
                                                      style: tableDataStyle),
                                                ),
                                                DataCell(Text(
                                                    i.turn.isNegative
