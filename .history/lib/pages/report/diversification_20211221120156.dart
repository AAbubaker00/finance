...
class _DiversificationState extends State<Diversification> {
  ...
  TextStyle CustomTextStyles(themeMode).sectionSubTextStyle, tableDataStyle, sectionHeader, disclaimerHeader, disclaimerSub, tableNameStyle;
  ...
  Widget build(BuildContext context) {
    ...
    CustomTextStyles(themeMode).sectionSubTextStyle = TextStyle(
      fontSize: 17,
