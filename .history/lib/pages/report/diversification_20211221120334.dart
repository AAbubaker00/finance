...
class _DiversificationState extends State<Diversification> {
  ...
  TextStyle CustomTextStyles(themeMode).holdingSubValueStyle, sectionHeader, disclaimerHeader, disclaimerSub, tableNameStyle;
  ...
  Widget build(BuildContext context) {
    ...
    CustomTextStyles(themeMode).holdingSubValueStyle = TextStyle(
      fontSize: 15,
