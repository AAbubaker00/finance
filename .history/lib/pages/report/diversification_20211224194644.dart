            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Allocations', style: CustomTextStyles(themeMode).pageHeaderStyle)
                ],
              ),
            ),
            Container(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text('Top 5 Holdings', style: CustomTextStyles(themeMode).sectionHeader),
                  ),
                  DataTable(
                      columnSpacing: 10,
                      horizontalMargin: 0,
                      ...
                      headingRowColor: MaterialStateProperty.resolveWith<Color>((states) {
                        return UserThemes(themeMode).seperator.withOpacity(.5);
                      }),
                      headingRowHeight: 30,
                      headingTextStyle: CustomTextStyles(themeMode).sectionSubTextStyle.copyWith(
                            ...
                            cells: [
                              ...
                              DataCell(
                                Text('${((asset.value / investedValue) * 100).toStringAsFixed(2)}%',
                                    style: CustomTextStyles(themeMode).tableValueStyle),
                              ),
                              DataCell(Center(
                              ...
                              DataCell(Text(
                                  ...
                                  style: CustomTextStyles(themeMode).tableValueStyle.copyWith(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text('SECTORS', style: CustomTextStyles(themeMode).sectionHeader),
                    ),
                    Container(
                        padding: EdgeInsets.all(10),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: DataTable(
                                  ...
                                  headingRowHeight: 30,
                                  headingTextStyle: CustomTextStyles(themeMode).sectionSubTextStyle,
                                  dataRowHeight: 35,
                                  dividerThickness: 0,
                                  dataTextStyle: TextStyle(),
                                  columns: <DataColumn>[
              ...
              child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(top: 15.0, bottom: 15, left: 10, right: 10),
                        child: Text('INDUSTRIES', style: CustomTextStyles(themeMode).sectionHeader),
                      ),
                      Container(
                        decoration: CustomDecoration(themeMode, false).baseContainerDecoration,
                        padding: EdgeInsets.all(10),
                                    ...
                                    return DataRow(
                                        ...
                                        cells: [
                                          ...
                                          DataCell(Text(
                                              ...
                                              style: CustomTextStyles(themeMode).tableHeaderStyle.copyWith(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text('REGIONS', style: CustomTextStyles(themeMode).sectionHeader),
                      ),
                      DataTable(
                          columnSpacing: 10,
                          horizontalMargin: 5,
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.only(top: 10.0, bottom: 5),
                          child: Text('EXCHANGE', style: CustomTextStyles(themeMode).sectionHeader),
                        ),
                        DataTable(
                            columnSpacing: 10,
                            horizontalMargin: 5,
                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(top: 10.0, bottom: 5),
                        child: Text('CURRENCIES', style: CustomTextStyles(themeMode).sectionHeader),
                      ),
                      DataTable(
                          columnSpacing: 10,
                          horizontalMargin: 5,
