...
class Diversification extends StatefulWidget {
  ...
  const Diversification({Key key, this.dataObject}) : super(key: key);
...
class _DiversificationState extends State<Diversification> {
  ...
  // TextStyle disclaimerHeader, disclaimerSub;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: UserThemes(widget.dataObject.themeMode).backgroundColour,
        elevation: 0,
        iconTheme: IconThemeData(color: UserThemes(widget.dataObject.themeMode).backColour),
      ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Allocations', style: CustomTextStyles(widget.dataObject.themeMode).pageHeaderStyle)
                ],
              ),
            ),
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(color: UserThemes(widget.dataObject.themeMode).border, width: 1)),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  Padding(
                    padding: EdgeInsets.only(bottom: 20.0, top: 10),
                    child: Text('Top 5 Holdings', style: CustomTextStyles(widget.dataObject.themeMode).sectionHeader),
                  ),
                  DataTable(
                      columnSpacing: 10,
                      horizontalMargin: 0,
                      ...
                      headingRowColor: MaterialStateProperty.resolveWith<Color>((states) {
                        return UserThemes(widget.dataObject.themeMode).seperator.withOpacity(.5);
                      }),
                      headingRowHeight: 30,
                      headingTextStyle: CustomTextStyles(widget.dataObject.themeMode).sectionSubTextStyle.copyWith(
                      ...
                      rows: topFiveAssetChartData.map((asset) {
                        return DataRow(
                            ...
                            cells: [
                              DataCell(
                                Container(
                                  width: widget.dataObject.width * .2,
                                  child: Row(
                                    children: [
                                      Flexible(
                                        child: Text(
                              ...
                              DataCell(
                                Text('${((asset.value / investedValue) * 100).toStringAsFixed(2)}%',
                                    style: CustomTextStyles(widget.dataObject.themeMode).tableValueStyle),
                              ),
                              DataCell(Center(
                                  child: Text('${widget.dataObject.userCurrencySymbol}${asset.value.toStringAsFixed(2).addCommas()}',
                                      style: CustomTextStyles(widget.dataObject.themeMode).tableValueStyle))),
                              DataCell(Text(
                                  ...
                                  style: CustomTextStyles(widget.dataObject.themeMode).tableValueStyle.copyWith(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text('SECTORS', style: CustomTextStyles(widget.dataObject.themeMode).sectionHeader),
                    ),
                    Container(
                        padding: EdgeInsets.all(10),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: DataTable(
                                  ...
                                  headingRowHeight: 30,
                                  headingTextStyle: CustomTextStyles(widget.dataObject.themeMode).sectionSubTextStyle,
                                  dataRowHeight: 35,
                                  dividerThickness: 0,
                                  dataTextStyle: TextStyle(),
                                  columns: <DataColumn>[
                                  ...
                                  rows: sectorCDT.map((s) {
                                    return DataRow(
                                        ...
                                        cells: [
                                          DataCell(
                                            Container(
                                              width: widget.dataObject.width * .4,
                                              child: Row(
                                                children: [
                                                  Flexible(
                                                    child: Text(
                                          ...
                                          DataCell(
                                            Text('${widget.dataObject.userCurrencySymbol}${s.value.toStringAsFixed(2).addCommas()}',
                                                style: CustomTextStyles(widget.dataObject.themeMode).tableValueStyle),
                                          ),
                                          DataCell(Text(
                                              s.turn.isNegative
              ...
              child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(top: 15.0, bottom: 15, left: 10, right: 10),
                        child: Text('INDUSTRIES', style: CustomTextStyles(widget.dataObject.themeMode).sectionHeader),
                      ),
                      Container(
                        decoration: CustomDecoration(widget.dataObject.themeMode, false).baseContainerDecoration,
                        padding: EdgeInsets.all(10),
                                  ...
                                  rows: industryCDT.map((i) {
                                    return DataRow(
                                        ...
                                        cells: [
                                          ...
                                          DataCell(
                                            Text('${widget.dataObject.userCurrencySymbol}${i.value.toStringAsFixed(2).addCommas()}',
                                                style: CustomTextStyles(widget.dataObject.themeMode).tableValueStyle),
                                          ),
                                          DataCell(Text(
                                              i.turn.isNegative
                                              ...
                                              style: CustomTextStyles(widget.dataObject.themeMode).tableHeaderStyle.copyWith(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text('REGIONS', style: CustomTextStyles(widget.dataObject.themeMode).sectionHeader),
                      ),
                      DataTable(
                          columnSpacing: 10,
                          horizontalMargin: 5,
                          ...
                          rows: regionsCDT.map((r) {
                            return DataRow(
                                ...
                                cells: [
                                  ...
                                  DataCell(
                                    Text('${widget.dataObject.userCurrencySymbol}${r.value.toStringAsFixed(2).addCommas()}',
                                        style: CustomTextStyles(widget.dataObject.themeMode).tableValueStyle),
                                  ),
                                  DataCell(Text(
                                      r.turn.isNegative
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.only(top: 10.0, bottom: 5),
                          child: Text('EXCHANGE', style: CustomTextStyles(widget.dataObject.themeMode).sectionHeader),
                        ),
                        DataTable(
                            columnSpacing: 10,
                            horizontalMargin: 5,
                            ...
                            rows: exchangeCDT.map((ex) {
                              return DataRow(
                                  ...
                                  cells: [
                                    ...
                                    DataCell(
                                      Text('${widget.dataObject.userCurrencySymbol}${ex.value.toStringAsFixed(2).addCommas()}',
                                          style: CustomTextStyles(widget.dataObject.themeMode).tableValueStyle),
                                    ),
                                    DataCell(Text(
                                        ex.turn.isNegative
                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(top: 10.0, bottom: 5),
                        child: Text('CURRENCIES', style: CustomTextStyles(widget.dataObject.themeMode).sectionHeader),
                      ),
                      DataTable(
                          columnSpacing: 10,
                          horizontalMargin: 5,
                          ...
                          rows: currencyCDT.map((c) {
                            return DataRow(
                                ...
                                cells: [
                                  ...
                                  DataCell(
                                    Text('${widget.dataObject.userCurrencySymbol}${c.value.toStringAsFixed(2).addCommas()}',
                                        style: CustomTextStyles(widget.dataObject.themeMode).tableValueStyle),
                                  ),
                                  DataCell(Text(
                                      c.turn.isNegative
                                          ? '-${widget.dataObject.userCurrencySymbol}${(c.turn * -1).toStringAsFixed(2).addCommas()}'
                                          : '+${widget.dataObject.userCurrencySymbol}${c.turn.toStringAsFixed(2).addCommas()}',
                                      style: CustomTextStyles(widget.dataObject.themeMode).tableValueStyle.copyWith(
        ...
        barRods: [
          BarChartRodData(
            ...
            backDrawRodData: BackgroundBarChartRodData(
              show: true,
              y: 100,
              colors: [UserThemes(widget.dataObject.themeMode).backgroundColour.withOpacity(.5)],
            ),
          ),
        ],
