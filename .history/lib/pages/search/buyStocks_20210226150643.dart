...
class BuyStock extends StatefulWidget {
  BuyStock({Key key}) : super(key: key);

  @override
  _BuyStockState createState() => _BuyStockState();
}

class _ViewStockState extends State<BuyStock> {
                          ...
                          Row(
                            ...
                            children: [
                              Text('${selectedStock['quote']['symbol']} ',
                                  style: TextStyle(
                                      color: DarkTheme().textColorVarient, fontWeight: FontWeight.w400)),
                              Icon(
                                Icons.circle,
                                size: 5,
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(selectedStock['quote']['currency'],
                                    style:
                                        TextStyle(color: DarkTheme().textColor, fontWeight: FontWeight.w100)),
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        hintStyle: TextStyle(
                                            color: DarkTheme().blueVarient, fontWeight: FontWeight.w300),
                                        hintText: hintText_0,
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                            color:
                                                isSharesError ? DarkTheme().redVarient : Colors.transparent),
                                      ),
                                    ),
                                    Container(
                                      width: MediaQuery.of(context).size.width * 0.8,
