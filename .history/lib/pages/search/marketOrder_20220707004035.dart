...
class _MarketOrderState extends State<MarketOrder> {
              ...
              child: Column(
                ...
                children: [
                  Column(
                    children: [
                      // Text(
                      //   '${widget.instrument['quote']['symbol']}Transaction',
                      ...
                      Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              '$currencySymbol',
                              style: CustomTextStyles(widget.dataObject.theme, widget.dataObject.context).overallCurrencyStyle,
                            ),
                          ),
                          Text(
                            ...
                            style: CustomTextStyles(widget.dataObject.theme, widget.dataObject.context).overallValueStyle,
                          ),
                          Padding(
                            padding: const EdgeInsets.only(bottom: 3.0, left: 1),
                            child: Text(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        style: CustomTextStyles(widget.dataObject.theme, widget.dataObject.context).loginHeaderTextStyle,
                        decoration: InputDecoration(
                          contentPadding: EdgeInsets.all(0),
                          isDense: true,
                          hintStyle: CustomTextStyles(widget.dataObject.theme, widget.dataObject.context).loginHeaderTextStyle.copyWith(
                      ...
                      InkWell(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'TRANSACTION DATE',
                              style: CustomTextStyles(widget.dataObject.theme, widget.dataObject.context).holdingSubValueStyle,
                            ),
                            SizedBox(
                              height: 7,
                            ),
  ...
  Widget _sortPopupMenu() => PopupMenuButton(
        ...
        child: Text(
          selectedPortfolio,
          style: CustomTextStyles(widget.dataObject.theme, widget.dataObject.context).portfolioNameStyle.copyWith(
