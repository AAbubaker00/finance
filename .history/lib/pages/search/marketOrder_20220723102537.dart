                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                instrumentExchange == 'LSE'
                                    ? '${(double.parse((widget.instrument['quote']['regularMarketPrice'] / 100).toStringAsFixed(2)) - (double.parse((instrument['quote']['regularMarketPrice'] / 100).toStringAsFixed(2))).toInt()).toStringAsFixed(2).replaceRange(0, 1, '')}'
                                    : '${(widget.instrument['quote']['regularMarketPrice'] - instrument['quote']['regularMarketPrice'].toInt()).toStringAsFixed(2).replaceRange(0, 1, '')}',
                                style: CustomTextStyles(widget.dataObject.theme, widget.dataObject.context)
                                    .overallCurrencyStyle,
                              ),
                            ),
