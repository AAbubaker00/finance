                      ...
                      children: [
                        Text(
                            (instrument['quote']['regularMarketChange'] >= 0)
                                ? '+$currencySymbol${instrument['quote']['regularMarketChange'].toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} (${(widget.instrument['quote']['regularMarketChangePercent']).toStringAsFixed(2)}%)'
                                : '-$currencySymbol${(instrument['quote']['regularMarketChange'] * -1).toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} (${(widget.instrument['quote']['regularMarketChangePercent']).toStringAsFixed(2)}%)',
                            style: TextStyle(
