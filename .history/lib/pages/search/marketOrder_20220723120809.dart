...
appBarTitle: widget.instrument['quote'].containsKey('longName')
                  ...
                  : widget.instrument['quote']['shortName'].toString(),      preferredSizeValue: 2.5,
                  ...
                  if (_formKey.currentState.validate() && isPortfolioSelected) {
                    ...
                    for (var portfolio in widget.dataObject.portfolios) {
                      if (portfolio['name'] == selectedPortfolio) {
                        var isHoldingExist = portfolio['assets'][0]['items']
                            .firstWhere((holding) => holding['symbol'] == instrumentSymbol, orElse: () => null);
