        ...
        children: [
          ...
          Container(
                child: widget.instrument['logo'] == null
                    ? Container(
                        height: 20, //(ratio <= 1.6) ? _height * 0.06 : _height * 0.2,
                        width: 20,
                    ...
                    : ClipRRect(
                        ...
                        child: Image.network(widget.instrument['logo'],
                            errorBuilder: (context, error, stackTrace) => Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        UserThemes(widget.dataObject.theme).backgroundColour.withOpacity(.7),
                                    borderRadius: BorderRadius.circular(10),
                                  ),
                                  child: Padding(
                            ...
                            height: 20, //(ratio <= 1.6) ? _height * 0.06 : _height * 0.2,
                            width: 20, //(ratio <= 1.6) ? _width * 0.045 : _width * 0.11,
                            fit: BoxFit.fill),
                      ),
              ),
        ],
