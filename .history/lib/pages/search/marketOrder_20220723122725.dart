            ...
            children: [
              ...
              Container(
                  ...
                  child: Row(children: [
                    ...
                    Text(
                      '${widget.dataObject.userCurrencySymbol}${(Initialise(baseCurrency: widget.dataObject.userCurrency).getRate(widget.dataObject.rates, widget.dividends.currency) * widget.dividends.shares * double.parse(widget.dividends.amount.replaceAll(RegExp("[^\\d.]"), ""))).toStringAsFixed(2)}',
                      style: CustomTextStyles(widget.dataObject.theme, widget.dataObject.context)
