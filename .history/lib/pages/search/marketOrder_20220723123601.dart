...
quantity = double.parse(hintText_0);
  ...
  getReturn(){
    instrumentReturn =  ((widget.instrument['quote']['regularMarketPrice'] / (instrumentExchange == 'LSE'? 100 : 1)) - purchasePrice) * quantity;f
  }
            ...
            children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: CWApplyButton(
                        ...
                        isChange:
                            quantity > 0 && purchasePrice > 0 && selectedPortfolio != 'Select Portfolio',
                        function: () async {
                              ...
                              if (portfolio['name'] == selectedPortfolio) {
                                ...
                                if (isHoldingExist == null) {
                                  ...
                                  for (var database_data_portfolio
                                      in widget.dataObject.databaseData['portfolios']) {
                                    if (database_data_portfolio['name'] == selectedPortfolio) {
                                      for (var database_holding in database_data_portfolio['assets'][0]
                                          ['items']) {
              ...
              Container(
                  ...
                  child: Row(children: [
                    ...
                    Text(
                      instrumentExchange == 'LSE'?
                      '${((widget.instrument['quote']['regularMarketPrice'] / 100) - purchasePrice) *}'
                      ,
                      style: CustomTextStyles(widget.dataObject.theme, widget.dataObject.context)
