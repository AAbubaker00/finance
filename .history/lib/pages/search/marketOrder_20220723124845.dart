...
class _MarketOrderState extends State<MarketOrder> {
  ...
  void initState() {
    ...
    if (widget.isView) {
      ...
      purchasePrice = double.parse(hintText_1);
      quantity = double.parse(hintText_0);
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Text(
                ...
                style: CustomTextStyles(widget.dataObject.theme, widget.dataObject.context)
                    ...
                    .copyWith(
                        fontWeight: FontWeight.w500, color: instrumentReturn >= 0?  UserThemes(widget.dataObject.theme).greenVarient : UserThemes(widget.dataObject.theme).greenVarient),
              ),
            ])),
      ),
