  ...
  Widget build(BuildContext context) {
    return CWScaffold(
      ...
      customFloatinfActionButtonWidget: Padding(
        ...
        child: Container(
            decoration: CustomDecoration(widget.dataObject.theme).curvedBaseContainerDecoration.copyWith(color: UserThemes(widget.dataObject.theme).blueVarient.withOpacity(.5)),
