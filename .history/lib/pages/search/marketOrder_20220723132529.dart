      ...
      showModalBottomSheet(
          ...
          builder: (ctxt) {
            return CWConfirmBottomSheetButton(
              ...
              context: ctxt,
              btnText:
                  'Are you sure you want to delete ${widget.instrument['quote'].containsKey('longName') ? instrument['quote']['longName'] : instrument['quote']['shortName']} investment from ${widget.dataObject.onPortfolio['name']} portfolio?',
              function: () async {
