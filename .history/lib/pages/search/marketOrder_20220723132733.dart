...
class _MarketOrderState extends State<MarketOrder> {
  ...
  void initState() {
    ...
    if (widget.isView) {
      ...
      purchasePrice = double.parse(hintText_0);
      quantity = double.parse(hintText_1);
  ...
  getReturn() {
    instrumentReturn =
        ((widget.instrument['quote']['regularMarketPrice'] / (instrumentExchange == 'LSE' ? 100 : 1)) -
                purchasePrice) *
            quantity;
  ...
  double purchasePrice = 0, quantity = 0, instrumentReturn = 0.0;
  ...
  Widget build(BuildContext context) {
      ...
      showModalBottomSheet(
          ...
          builder: (ctxt) {
            return CWConfirmBottomSheetButton(
              ...
              context: ctxt,
              btnText:
                  'Are you sure you want to delete ${widget.instrument['quote'].containsKey('longName') ? widget.instrument['quote']['longName'] : widget.instrument['quote']['shortName']} investment from ${widget.dataObject.onPortfolio['name']} portfolio?',
              function: () async {
    ...
    return CWScaffold(
      ...
      floatingActionButttonLocation: FloatingActionButtonLocation.centerFloat,
      showFloatingBtn: true,
      customFloatingActionButton: true,
      customFloatinfActionButtonWidget: Padding(
      ...
      appBarTitle: widget.instrument['quote'].containsKey('longName')
