              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    decoration: CustomDecoration(widget.dataObject.theme, false).baseContainerDecoration,
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'ORDER TYPE',
                                style: CustomTextStyles(widget.dataObject.theme).tableHeaderStyle,
                              ),
                              Container(
                                // color: Colors.red,
                                child: DropdownButton<String>(
                                  ...
                                  icon: Text(
                                    selectedEvent,
                                    style:
                                        CustomTextStyles(widget.dataObject.theme).portfolioSubValuetyle,
                                  ),
                                  autofocus: true,
                                  underline: Container(
                        ...
                        Divider(color: UserThemes(widget.dataObject.theme).seperator),
                        Padding(
                          padding: EdgeInsets.symmetric(vertical: 5.0),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            ...
                            children: [
                              ...
                              Container(
                                // color: Colors.red,
                                width: widget.dataObject.width * 0.5,
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    focusedBorder: UnderlineInputBorder(
                                        borderSide: BorderSide(
                                            color: UserThemes(widget.dataObject.theme).border)),
