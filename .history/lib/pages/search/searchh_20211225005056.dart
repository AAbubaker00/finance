...
class _SearchState extends State<Search> {
  ...
  Widget build(BuildContext context) {
    ...
    chgeHeaderStyle =
        TextStyle(color: DarkTheme(isDark).textColorVarient, fontSize: 20, fontWeight: FontWeight.w400);
    chgeSubStyle = TextStyle(color: DarkTheme(isDark).textColor, fontSize: 20, fontWeight: FontWeight.w400);
              ...
              title: Padding(
                ...
                child: Ink(
                  ...
                  decoration: BoxDecoration(
                      color: DarkTheme(isDark).primary.withOpacity(.6),
                      border: Border.all(color: DarkTheme(isDark).border.withOpacity(.3)),
                      borderRadius: BorderRadius.circular(circularRadius)),
                  child: TextField(
                    style: TextStyle(fontSize: 17, color: DarkTheme(isDark).textColor),
                    decoration: InputDecoration(
                      ...
                      isDense: true,
                      labelStyle: TextStyle(color: DarkTheme(isDark).textColorVarient),
                      hintText: "Search...",
                      suffixIcon: Icon(
                        Icons.search,
                        size: 25,
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    IconButton(
                                        ...
                                        highlightColor: Colors.transparent,
                                        onPressed: () {},
                                        icon: Icon(Icons.add, color: DarkTheme(isDark).textColorVarient))
                                  ],
                                ),
                              ...
                              InkWell(
                                ...
                                child: Icon(
                                  ...
                                  color: isDataChange
                                      ...
                                      : DarkTheme(isDark).greenVarient.withOpacity(.3),
                                  size: 50,
                                ),
                              )
                            ],
                    ...
                    ? Container(
                        child: ClipRRect(
                          child: Image.asset(
                            ...
                            color: DarkTheme(isDark).iconColour.withOpacity(.2),
                          ...
                          return Center(
                            child: Container(
                              decoration: BoxDecoration(
                                  border: Border(
                                      bottom:
                                          BorderSide(color: DarkTheme(isDark).iconColour.withOpacity(.2)))),
