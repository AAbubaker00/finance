...
class _SearchState extends State<Search> {
  ...
  double circularRadius = 15, ratio;
  ...
  SnappingSheetController snapSheetController;
  ...
  Widget build(BuildContext context) {
    ...
    chgeHeaderStyle =
        TextStyle(color: UserThemes(isDark).textColorVarient, fontSize: 20, fontWeight: FontWeight.w400);
    chgeSubStyle = TextStyle(color: UserThemes(isDark).textColor, fontSize: 20, fontWeight: FontWeight.w400);
              ...
              title: Padding(
                ...
                child: Ink(
                  ...
                  decoration: BoxDecoration(
                      color: UserThemes(isDark).primary.withOpacity(.6),
                      border: Border.all(color: UserThemes(isDark).border.withOpacity(.3)),
                      borderRadius: BorderRadius.circular(circularRadius)),
                  child: TextField(
                    style: TextStyle(fontSize: 17, color: UserThemes(isDark).textColor),
                    decoration: InputDecoration(
                      ...
                      isDense: true,
                      labelStyle: TextStyle(color: UserThemes(isDark).textColorVarient),
                      hintText: "Search...",
                      suffixIcon: Icon(
                        Icons.search,
                        size: 25,
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    IconButton(
                                        ...
                                        highlightColor: Colors.transparent,
                                        onPressed: () {},
                                        icon: Icon(Icons.add, color: UserThemes(isDark).textColorVarient))
                                  ],
                                ),
                              ...
                              InkWell(
                                ...
                                child: Icon(
                                  ...
                                  color: isDataChange
                                      ...
                                      : UserThemes(isDark).greenVarient.withOpacity(.3),
                                  size: 50,
                                ),
                              )
                            ],
                    ...
                    ? Container(
                        child: ClipRRect(
                          child: Image.asset(
                            ...
                            color: UserThemes(isDark).iconColour.withOpacity(.2),
                          ...
                          return Center(
                            child: Container(
                              decoration: BoxDecoration(
                                  border: Border(
                                      bottom:
                                          BorderSide(color: UserThemes(isDark).iconColour.withOpacity(.2)))),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Icon(
                                        ...
                                        color: UserThemes(isDark).iconColour.withOpacity(.3),
                                      ),
                                      Text(
                                        change['name'],
