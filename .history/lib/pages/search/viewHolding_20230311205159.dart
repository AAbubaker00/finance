...
class _ViewHolding extends State<ViewHolding> {
  ...
  void initState() {
    ...
    hintText_0 = widget.dataObject.onHolding.purchasePrice.toString();
    hintText_1 = widget.dataObject.onHolding.quantity.toString();
  }
          ...
          children: [
            ...
            Padding(
              ...
              child: CWApplyButton(
                ...
                function: () async {
                  // QuoteObject replace = widget.dataObject.onPortfolio.holdings.firstWhere((holding) => holding)
                  if (purchasePrice > 0) {
                  ...
                  await DatabaseService(uid: widget.dataObject.user.uid).updateUserData(data: widget.dataObject);
                },
              ),
            ),
          ],
