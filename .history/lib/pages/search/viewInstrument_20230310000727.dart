                      ...
                      children: [
                        Text(
                            (instrument['marketPrice'] >= 0)
                                ? '+$currencySymbol${instrument['marketPrice'].toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} (${(instrument['quote']['regularMarketChange']).toStringAsFixed(2)}%)'
