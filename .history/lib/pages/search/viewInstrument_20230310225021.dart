...
class _ViewInstrument extends State<ViewInstrument> {
  Future<bool> initializeData() async {
    ...
    if (instrument.isEmpty) {
      ...
      CustomeBottomSheet()
          .underDevelopment(context,  text: 'This instrument is not supported yet.');
  ...
  getReturn() {
    instrumentReturn =
        ((instrument['marketPrice'] / (instrumentExchange == 'LSE' ? 100 : 1)) - pp) * q;
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text( '${(instrument['marketPrice'] - instrument['marketPrice'].toInt()).toStringAsFixed(2).replaceRange(0, 1, '')}',
                                  style: CustomTextStyles( widget.dataObject.context)
                                      .overallCurrencyStyle,
                                ),
                              ),
                      ...
                      children: [
                        Text(
                            ...
                            style: TextStyle(
                                ...
                                fontSize: 15,
                                color: (instrument['marketPrice'] > 0)
                                    ? greenVarient
                                    : redVarient)),
                        Text(' DAILY',
                            style: CustomTextStyles( widget.dataObject.context)
