...
class ViewInstrument extends StatefulWidget {
  ...
  const ViewInstrument({Key key, this.dataObject}) : super(key: key);
  @override
            ...
            Column(
              children: [
                ...
                Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text(
                    '${widget.dataObject.onHolding.cu}${instrumentReturn.toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}',
