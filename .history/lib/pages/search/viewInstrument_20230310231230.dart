                ...
                children: [
                  Text(
                      (widget.dataObject.onHolding.regularMarketPrice >= 0)
                          ...
                          : '-$currencySymbol${(widget.dataObject.onHolding.regularMarketPrice * -1).toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} (${(widget.dataObject.onHolding.r).toStringAsFixed(2)}%)',
                      style: TextStyle(
