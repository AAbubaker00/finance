                  ...
                  Row(
                    ...
                    children: [
                      Text('${selectedStock['quote']['symbol']} ',
                          style: TextStyle(color: DarkTheme().textColorVarient, fontWeight: FontWeight.w400)),
                      Icon(
                        Icons.circle,
                        size: 5,
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                color: DarkTheme().backgroundColour, borderRadius: BorderRadius.circular(10)),
                            child: Padding(
                              padding: EdgeInsets.all(15.0),
                              child: Text(
                                'Enter the purchase or sell price of a single order or the Avg purchase or Sell price of multiple orders',
                                style: TextStyle(
                                    color: DarkTheme().textColor, fontSize: 15, fontWeight: FontWeight.w400),
                                textAlign: TextAlign.center,
                              ),
                            ),
                          ),
                          ...
                          Align(
                            ...
                            child: Text(
                              ...
                              style:
                                  TextStyle(color: isDateError ? DarkTheme().redVarient : Colors.transparent),
                            ),
                          ),
                          Padding(
                          ...
                          Container(
                            ...
                            child: Center(
                              child: ListView(
                                ...
                                children:
                                    (isAddNewPortfolio ? newPortfolio : modifiedPortfolios).map<Widget>((p) {
                                  return InkWell(
                                    onTap: () {
                                        ...
                                        child: Center(
                                          child: Padding(
                                            ...
                                            child: Text(
                                              ...
                                              style: TextStyle(
                                                  color: DarkTheme().textColor, fontWeight: FontWeight.w200),
                                            ),
                                          ),
                                        ),
                                      ),
