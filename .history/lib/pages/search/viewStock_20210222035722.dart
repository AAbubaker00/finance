  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<bool>(
      ...
      builder: (context, snapshot) {
        if(snapshot.connectionState == Conne)
      },
    );
...
/* --------------------- checking if stock already exits -------------------- */
                            ...
                            //               stock['shares'] =
                            //                   double.parse(stock['shares'].toString()) + quantity;
                            //               stock['Invested'] = stock['Invested'] + (purchasePrice * quantity);
                            //               stock['history'].add({
                            //                 [
                            //                   {
                            //                     'type': 'Market Buy',
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      color:
                                          !isPortfolioSelected ? DarkTheme().redVarient : Colors.transparent),
                                ),
                              ),
                            ],
                          ),
