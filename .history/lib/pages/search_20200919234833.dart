...
class Search extends StatefulWidget {
  ...
  List<StoredData> od = List<StoredData>();

  void setData(List<StoredData> d) {
    _SearchState().setState(() {
      _SearchState().oData = d;
    });
  }
}
...
class _SearchState extends State<Search> {
  ...
  List<StoredData> oData;
  Map data = {};


  @override
  Widget build(BuildContext context) {
    data = data.isNModalRoute.of(context).settings.arguments;
    oData = data.isNotEmpty ? data['storeddata'];
