...
class _SearchState extends State<Search> {
  ...
  List<StoredData> displayedDaya = List<StoredData>();
  ...
  Widget build(BuildContext context) {
    ...
    storedData = storedData.isNotEmpty ? storedData : data['storeddata'];

    print(storedData[0].name);
              ...
              child: DecoratedBox(
                  ...
                  child: TextField(
                    ...
                    onChanged: (txt) {
                      txt = txt.toLowerCase();
                      setState(() {
                        storedData = storedData.where((stock) {
          ...
          Container(
            ...
            child: ListView.builder(
              itemBuilder: (context, index) {
                return Card(child: Text(storedData[index].name));
              },
