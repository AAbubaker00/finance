...
class _SearchState extends State<Search> {
  static List<YahooSelectedStockDataResult> SelectedStockData;
                            ...
                            onChanged: (txt) {
                              ...
                              setState(() {
                                displayedData = storedData.where((stock) {
                                  var SelectedStockDataName = stock.name.toLowerCase();
                                  return SelectedStockDataName.contains(txt);
                                }).toList();
                              });
                            },
                          ))),
  ...
  void getStockData() async {
    await Future.delayed(Duration(seconds: 1), () async {
      SelectedStockData = await YahooApiService.getYahooSelectedStockData();
