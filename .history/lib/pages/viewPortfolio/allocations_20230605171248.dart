                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Flexible(
                            child: Text(diversificationCDT[diversificationSelectedIndex].name,
        ...
        for (var holding in widget.dataObject.onPortfolio!.holdings) {
          if (holding.dividendSupport) {
            if (diversificationCDT.isEmpty) {
              ...
              var isObjectExist =
                  diversificationCDT.indexWhere ((type) => type.name == 'Dividends', orElse: () => null);
      ...
      case 'Sectors':
        for (var holding in widget.dataObject.onPortfolio.holdings) {
          if (diversificationCDT.isEmpty) {
            ...
            var isGeneralObjectExist = diversificationCDT.firstWhere(
                (region) => region.name == holding.sector,
                orElse: () => null);
      ...
      case 'Industries':
        for (var holding in widget.dataObject.onPortfolio.holdings) {
          if (diversificationCDT.isEmpty) {
            ...
            var isGeneralObjectExist = diversificationCDT.firstWhere(
                (region) => region.name == holding.industry,
                orElse: () => null);
