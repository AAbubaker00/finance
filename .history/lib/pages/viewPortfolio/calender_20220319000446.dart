...
class _Calender extends State<Calender> with WidgetsBindingObserver {
  @override
  void dispose() {
  ...
  Future<bool> init() async {
    ...
    if ((widget.dataObject.earnings.isEmpty && widget.dataObject.dividends.isEmpty) ||
            ...
            children: [
              ...
              InkWell(
                ...
                child: Ink(
                  ...
                  decoration: CustomDecoration(widget.dataObject.theme, false).bottomsheetDecoration,
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
            ...
            body: widget.dataObject.userFire.isAnonymous
                ...
                : CWListView(
                    centerWidget: selectedMonth['events'].isEmpty
                        ...
                        : null,
                    children: selectedMonth['groupedEvents'].map<Widget>((groupedEvent) {
                      return Column(
                        children: [
                          Container(
                              ...
                              children: groupedEvent['events']
                                  .map<Widget>((event) => Column(children: [
                                        ...
                                        groupedEvent['events'].last == event
                                            ? Container()
                                            : Padding(
                                                padding: EdgeInsets.only(left: 5.0, right: 5, top: 15, bottom: 15),
                                                child: Divider(
                                                  thickness: .8,
  ...
  Widget getEventType(dynamic event) {
    ...
    if (event.runtimeType == Earnings) {
    ...
    } else if (event.runtimeType == Container) {
      // print(event.date);
      return isAdLoaded == false
          ...
          : Padding(
              ...
              child: CustomeAdWidget(isAdLoaded, _floatingBottomAd).checkBannerAdStatus(),
            );
    } else {
      return Text('0');
    }
