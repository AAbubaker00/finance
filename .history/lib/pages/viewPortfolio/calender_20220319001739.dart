            ...
            body: widget.dataObject.userFire.isAnonymous
                ...
                : CWListView(
                    centerWidget: selectedMonth['events'].isEmpty
                        ...
                        : null,
                    children: List.generate(selectedMonth['groupedEvents'].length+1, (index) => index == 0? Container() ? selectedMonth['groupedEvents']) selectedMonth['groupedEvents'].map<Widget>((groupedEvent) {
                      return Column(
                        children: [
                          Container(
