            ...
            body: widget.dataObject.userFire.isAnonymous
                ...
                : CWListView(
                    centerWidget: selectedMonth['events'].isEmpty
                        ...
                        : null,
                    children: List.generate(selectedMonth['groupedEvents'].length+1, (index) => index == 0? Container : selectedMonth['groupedEvents'][index-1]) selectedMonth['groupedEvents'].map<Widget>((groupedEvent) {
                      return Column(
                        children: [
                          Container(
                              ...
                              children: groupedEvent['events']
                                  .map<Widget>((event) => Column(children: [
                                        ...
                                        groupedEvent['events'].last == event
                                            ...
                                            : Padding(
                                                padding:
                                                    EdgeInsets.only(left: 5.0, right: 5, top: 15, bottom: 15),
                                                child: Divider(
                                                  thickness: .8,
