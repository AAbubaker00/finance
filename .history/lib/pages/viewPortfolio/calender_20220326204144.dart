            ...
            body: widget.dataObject.userFire.isAnonymous
                ...
                : CWListView(
                    centerWidget: selectedMonth['events'].isEmpty
                        ...
                        : null,
                    children: List.generate(selectedMonth['groupedEvents']['events'].length+1, (index) => index==0? Container(): selectedMonth['groupedEvents']['events'][index-1]).map<Widget>((groupedEvent) {
                      return groupedEvent.runtimeType == Container?
                      Container(
                        padding: EdgeInsets.symmetric(left: 15,right: 15, bottom: 10 ),
                        decoration: CustomDecoration(widget.dataObject.theme, false).topWidgetDecoration,
                        child: Row(),
                      )
                      :
                      Column(
