            ...
            body: widget.dataObject.userFire.isAnonymous
                ...
                : CWListView(
                    ...
                    children: List.generate(
                            selectedMonth['groupedEvents']['events'].length + 1,
                            (index) => index == 0
                                ? Container()
                                : selectedMonth['groupedEvents']['events'][index - 1]).toList()
                      ...
                      return groupedEvent.runtimeType == Container
                          ? Container(
                              ...
                              child: Row(
                                children: [Text('Last update: ${widget.dataObject.lastCalenderUpdate}', )],
                              ),
                            )
                          : Column(
                              children: [
