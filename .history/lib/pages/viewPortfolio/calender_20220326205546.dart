            ...
            body: widget.dataObject.userFire.isAnonymous
                ...
                : CWListView(
                    ...
                    children: List.generate(
                            selectedMonth['groupedEvents'].length + 1,
                            (index) => index == 0
                                ? Container()
                                : selectedMonth['groupedEvents'][index - 1])
                        .map<Widget>((groupedEvent) {
                      return groupedEvent.runtimeType == Container?
                      Container(
                        child: Row(
                          children: [
                            Text('Last updated: ${widget.dataObject.lastCalenderUpdate}', style: style: CustomTextStyles(dataObject.theme)
                    .subSectionTextStyle,)
                          ],
                        ),
                      )
