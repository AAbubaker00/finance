                ...
                : CWListView(
                    ...
                    children: List.generate(selectedMonth['groupedEvents'].length + 1,
                      ...
                      return groupedEvent.runtimeType == Container
                          ? Container(
                              padding: EdgeInsets.only(left: 15, right: 5, bottom: 5),
                              decoration:
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    'Last updated: ${CustomDateFormatter().formatDateStyle(DateTime.parse(groupedEvent['date']).toString())}${widget.dataObject.lastCalenderUpdate}',
