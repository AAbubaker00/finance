                        ...
                        children: [
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                    '${CustomDateFormatter().weekdaysFull[(DateTime.parse(groupedEvent['date']).weekday - 1)].toString()}',
                                    style: CustomTextStyles(widget.dataObject.theme).holdingSubValueStyle.copyWith(color: UserThemes(widget.dataObject.theme).textColor)),
                                Text(
                                    '${CustomDateFormatter().formatDateStyle(DateTime.parse(groupedEvent['date']).toString())}',
                                    style: CustomTextStyles(widget.dataObject.theme).holdingSubValueStyle),
                              ],
                            ),
                          ),
