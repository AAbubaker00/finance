                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    selectedMonth['exTotal'] != 0
                                        ? CircleAvatar(
                                          radius: 3,
                                            backgroundColor: UserThemes(widget.dataObject.theme).purpleVarient,
                                          )
                                        : Container(),
                                    selectedMonth['divTotal'] != 0
                                        ? CircleAvatar(
                                          radius: 3,
                                            backgroundColor: UserThemes(widget.dataObject.theme).goldVarient,
                                          )
                                        : Container(),
                                    selectedMonth['earnTotal'] != 0
                                        ? CircleAvatar(
                                          radius: 3,
                                            backgroundColor: UserThemes(widget.dataObject.theme).blueVarient,
                                          )
                                        : Container(),
                                  ],
                                )
