                        ...
                        children: [
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                    '${CustomDateFormatter().weekdaysFull[(DateTime.parse(groupedEvent['date']).weekday - 1)].toString()}, ${CustomDateFormatter().formatDateStyleCalendervarient(date)(DateTime.parse(groupedEvent['date']).toString())}',
                                    style: CustomTextStyles(widget.dataObject.theme).holdingSubValueStyle),
                              ],
                            ),
                          ),
