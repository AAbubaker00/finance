                            ...
                            decoration: BoxDecoration(
                              border: Border.symmetric(
                                  horizontal: BorderSide(
                                      color: UserThemes(widget.dataObject.theme).seperator.withOpacity(1),
                                      width: 1)),
                            ),
                            child: Row(
                              ...
                              children: [
                                Text(
                                    '${CustomDateFormatter().weekdaysFull[(DateTime.parse(groupedEvent['date']).weekday - 1)].toString()}, ${CustomDateFormatter().formatDateStyleCalendervarient(DateTime.parse(groupedEvent['date']).toString())}',
                                    style: CustomTextStyles(widget.dataObject.theme).holdingSubValueStyle),
                              ],
                            ),
                          ),
