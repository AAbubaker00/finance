...
class _Dividends extends State<Dividends> {
  ...
  SimpleSwipeConfig _simpleSwipeConfig;
  ...
  void initState() {
    ...
    _simpleSwipeConfig = SimpleSwipeConfig(
        verticalThreshold: 25.0, swipeDetectionBehavior: SwipeDetectionBehavior.continuousDistinct);
  }
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: month['dividends'].map((dividend) {
                        print(dividend);
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(dividend['symbol'],
                                              style: TextStyle(
                                                  color: UserThemes(isDark).textColor, fontSize: 20)),
                                        ),
                                        Text(dividend['name'],
                                            style: TextStyle(
                                                color: UserThemes(isDark).textColorVarient,
                                        ...
                                        Row(
                                          children: [
                                            Text(
                                              currencySymbol,
                                              style: TextStyle(
                                                  color: UserThemes(isDark).goldVarient, fontSize: 20),
                                            ),
                                            Text(
                                                (dividend['totalPayment'] * dividend['shares'])
                                                    .toStringAsFixed(2),
                                                style: TextStyle(
                                                    color: UserThemes(isDark).goldVarient, fontSize: 25)),
                                          ],
                                        ),
                                        Text(
                                          ' Ex-Date 12, Jun, 2020',
      ...
      child: SafeArea(
          child: Scaffold(
              ...
              appBar: AppBar(
                ...
                elevation: 0,
                centerTitle: true,
                title: _monthsPopUpMenu(),
              ),
              body: SingleChildScrollView(
                child: Column(
                    children: months
                        // .firstWhere((month) => month == selectedMonth)['dividends']
                        .map<Widget>((dividend) {
                  return Ink(
                    padding: EdgeInsets.symmetric(horizontal: 10),
                    child: Column(
                        ...
                        Row(
                          ...
                          children: [
                            Column(
                              children: [
                                Text(
                                  DateTime.parse(dividend['day']).day.toString(),
                                  style: TextStyle(
                                ...
                                Text(
                                  weekdays[DateTime.parse(dividend['day']).weekday - 1]
                                      .toString()
                                      .capitalizeAll()
                                      .replaceRange(
                                          3,
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '2 events, 2 dividends',
                                  style: TextStyle(color: UserThemes(isDark).textColorVarient),
                                ),
                              ],
                            ),
                          ],
                                                  ...
                                                  Row(
                                                    children: [
                                                      Text(
                                                        currencySymbol,
                                                        style: TextStyle(
                                                            color: UserThemes(isDark).goldVarient,
                                                            fontSize: 20),
                                                      ),
                                                      Text(
                                                          (div['totalPayment'] * div['shares'])
                                                              .toStringAsFixed(2),
                                                          style: TextStyle(
                                                              color: UserThemes(isDark).goldVarient,
                                                              fontSize: 25)),
        ...
        child: Row(
          ...
          children: [
            Text(
              selectedMonth['id'],
              style:
                  TextStyle(fontSize: 20, fontWeight: FontWeight.w400, color: UserThemes(isDark).textColor),
            ),
            SizedBox(
              width: 5,
            ),
            Icon(
              Icons.expand_more,
              color: UserThemes(isDark).iconColour,
              size: 20,
            ),
          ],
        ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: CircleAvatar(
                          radius: 10,
                          backgroundColor: UserThemes(isDark).summaryColour,
                          child: Text(
  ...
  getDividendsBeta() {
    ...
    for (Map dividend in events) {
      ...
      if (month['dividends'].isEmpty) {
        month['events']++;
        month['dividends'] = [
          {
            'day': dividend['paymentDate'],
            'dividend': [dividend]
          }
        ];
      } else {
        ...
        // PrintFunctions().printStartEndLine(month);

        var firstDayDiv = month['dividends']
            .firstWhere((dayDivided) => dayDivided['day'] == dividend['paymentDate'], orElse: () => null);
        ...
        if (firstDayDiv == null) {
          ...
          firstDayDiv['dividend'].add(dividend);
        }
      }
    ...
    months = (months.where((month) => month['dividends'].isNotEmpty).toList()).forEach((month) => month['dividends']
        .sort((a, b) => DateTime.parse(a['day']).day.compareTo(DateTime.parse(b['day']).day)));
  }
      ...
      children: List.generate(
          ...
          (index) => index != 4
              ...
              : Align(
                  ...
                  child: CircleAvatar(
                    backgroundColor: Colors.white,
                    child: CircleAvatar(radius: 15, child: Text('+5')),
                  ))),
    );
  }
}
