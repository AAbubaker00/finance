...
class _Dividends extends State<Dividends> {
  ...
  Widget build(BuildContext context) {
    ...
    // themeMode = (data['data']['data']['states']['states']['dark']);
    initializeData();
    getDividendsBeta();
    ...
    subStyle = TextStyle(color: UserThemes(themeMode).textColor, fontWeight: FontWeight.w600, fontSize: 20);
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                              ...
                              child: Text('Dividends', style: CustomTextStyles(themeMode).feedDescriptonStyle)),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: month['dividends'].map<Widget>((dividend) {
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  child: Ink(
                                    decoration:
                                        CustomDecoration(themeMode, false).baseContainerDecoration,
                                    child: Padding(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  'In 2 days',
                                  style: TextStyle(color: UserThemes(themeMode).textColor, fontSize: 20),
                                ),
                                SizedBox(
                                  height: 10,
                                ),
                                Text(
                                  ...
                                  style: TextStyle(color: UserThemes(themeMode).textColorVarient),
                                ),
                              ],
                            ),
                          ],
        ...
        child: Row(
          ...
          children: [
            Text(
              selectedMonth['id'],
              style:
                  TextStyle(fontSize: 20, fontWeight: FontWeight.w400, color: UserThemes(themeMode).textColor),
            ),
            SizedBox(
              width: 5,
            ),
