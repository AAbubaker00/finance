                        ...
                        children: [
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                  '${DateTime.parse(dividend['paymentDate']).day.toString()} ${months[DateTime.parse(dividend['paymentDate']['filledOn']).month - 1]['id']} ${DateTime.parse(event['filledOn']).year.toString()}',
                                  style: headStyle),
                            ],
                          ),
                        ),
                          Padding(
                              ...
                              child:
                                  Text('Dividends', style: CustomTextStyles(themeMode).feedDescriptonStyle)),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
