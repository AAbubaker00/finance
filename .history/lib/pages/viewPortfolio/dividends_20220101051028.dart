...
import 'package:Strice/shared/update/initialise.dart';
...
class Dividends extends StatefulWidget {
  ...
  const Dividends({Key key, this.dataObject}) : super(key: key);
                                  ...
                                  child: Ink(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            '+${widget.dataObject.userCurrencySymbol}${(dividend['totalPayment'] * dividend['shares']).toStringAsFixed(2)}',
                                            style: CustomTextStyles(themeMode).sectionHeader)
                                      ],
                                    ),
                                  ),
