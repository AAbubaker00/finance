...
class _FinancialCalender extends State<FinancialCalender> {
  ...
  List events = [
    {"paymentDate": "2020-09-02", "label": "September 02, 20", "adjDividend": 0.02, "symbol": "BOL.PA"},
    {"paymentDate": "2020-08-02", "label": "September 02, 20", "adjDividend": 0.02, "symbol": "BOL.PA"},
    {"paymentDate": "2020-05-02", "label": "September 02, 20", "adjDividend": 0.02, "symbol": "BOL.PA"},
    {"paymentDate": "2020-07-02", "label": "September 02, 20", "adjDividend": 0.02, "symbol": "BOL.PA"},
    {"paymentDate": "2020-01-01", "label": "September 01, 20", "adjDividend": 0.47, "symbol": "WKL.AS"},
    {"paymentDate": "2020-02-01", "label": "September 01, 20", "adjDividend": 0.47, "symbol": "WKL.AS"},
    {"paymentDate": "2020-03-01", "label": "September 01, 20", "adjDividend": 0.002809, "symbol": "ITUB"},
    {"paymentDate": "2020-09-01", "label": "September 01, 20", "adjDividend": 0.05, "symbol": "FEI"}
  ];

  double ratio;

  bool isDark = true, isLoaded = false;
