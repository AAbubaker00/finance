...
class _FinancialCalender extends State<FinancialCalender> {
  ...
  List<> months = [
    {'id': "January", 'stocks': [], 'isSelected': false, 'status': false, 'index': 1, 'totalPayment': 0},
    {'id': "February", 'stocks': [], 'isSelected': false, 'status': false, 'index': 2, 'totalPayment': 0},
    {'id': "March", 'stocks': [], 'isSelected': false, 'status': false, 'index': 3, 'totalPayment': 0},
    {'id': "April", 'stocks': [], 'isSelected': false, 'status': false, 'index': 4, 'totalPayment': 0},
    {'id': "May", 'stocks': [], 'isSelected': false, 'status': false, 'index': 5, 'totalPayment': 0},
    {'id': "June", 'stocks': [], 'isSelected': false, 'status': false, 'index': 6, 'totalPayment': 0},
    {'id': "July", 'stocks': [], 'isSelected': false, 'status': false, 'index': 7, 'totalPayment': 0},
    {'id': "August", 'stocks': [], 'isSelected': false, 'status': false, 'index': 8, 'totalPayment': 0},
    {'id': "September", 'stocks': [], 'isSelected': false, 'status': false, 'index': 9, 'totalPayment': 0},
    {'id': "October", 'stocks': [], 'isSelected': false, 'status': false, 'index': 10, 'totalPayment': 0},
    {'id': "November", 'stocks': [], 'isSelected': false, 'status': false, 'index': 11, 'totalPayment': 0},
    {'id': "December", 'stocks': [], 'isSelected': false, 'status': false, 'index': 12, 'totalPayment': 0}
  ];
  List events = [
  ...
  getDividendsBeta() {
    for (Map dividend in events) {
      var month =
          months.firstWhere((month) => months[DateTime.parse(dividend['paymentDate']).month-1]['id'] == month['id']);

          month['stocks'].add(dividend);
          month['totalPayment'] += dividend['']
    }
  }
