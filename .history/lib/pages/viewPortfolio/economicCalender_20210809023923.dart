...
import 'dart:ui';
import 'package:Strice/extensions/';
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Column(
                                                children: [
                                                  Text(weekdays[
                                                      DateTime.parse(dividend['paymentDate']).weekday - 1].toString()..replaceRange(3, weekdays[
                                                      DateTime.parse(dividend['paymentDate']).weekday - 1].toString().length, '')),
                                                      Text(
