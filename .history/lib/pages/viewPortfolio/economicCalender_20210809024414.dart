                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Column(
                                                children: [
                                                  Text(weekdays[
                                                          DateTime.parse(dividend['paymentDate']).weekday - 1]
                                                      .toString()
                                                      .capitalizeAll()
                                                      .replaceRange(
                                                          3,
                                                  ...
                                                  Text(
                                                      DateTime.parse(dividend['paymentDate']).day.toString(), style: TextStyle(color: DarkTheme(isDark).textColorVarient, fontSize: 17),),
                                                ],
                                              )
                                            ],
                                          ),
