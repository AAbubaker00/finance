...
class _FinancialCalender extends State<FinancialCalender> {
  ...
  List events = [
    {"paymentDate": "2020-09-02", "label": "September 02, 20", "totalPayment": 0.02, "symbol": "BOL.PA", 'name': 'dsdadads'},
    {"paymentDate": "2020-08-20", "label": "September 02, 20", "totalPayment": 0.02, "symbol": "BOL.PA", 'name': 'dsdadads'},
                                                  ...
                                                  children: [
                                                    Column(
                                                      children: [
                                                        ...
                                                        Text(dividend['symbol'], style: TextStyle(color: DarkTheme(isDark).textColorVarient, fontSize: 20)), 
                                                      ],
                                                    )
                                                  ],
                                                ),
