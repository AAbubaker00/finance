                                              ...
                                              Expanded(
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Column(
                                                      children: [
                                                        Text((dividend['totalPayment'] * dividend['shares']).toStringAsFixed(2), style: TextStyle(color: DarkTheme(isDark).goldVarient, fontSize: 25)),Text('${dividend['shares']} x ${divided['totalPay]}')
                                                      ],
                                                    )
                                                  ],
                                                ),
