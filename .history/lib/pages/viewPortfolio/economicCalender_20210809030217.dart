...
class _FinancialCalender extends State<FinancialCalender> {
  ...
  List events = [
    {"paymentDate": "2020-09-02", "label": "September 02, 20", "totalPayment": 0.02, "symbol": "BOL.PA", 'name': 'dsdadads', 'shares' : 100},
    {"paymentDate": "2020-08-20", "label": "September 02, 20", "totalPayment": 0.02, "symbol": "BOL.PA", 'name': 'dsdadads', 'shares' : 202},
    {"paymentDate": "2020-05-12", "label": "September 02, 20", "totalPayment": 0.02, "symbol": "BOL.PA", 'name': 'dsdadads', 'shares' : 63},
    {"paymentDate": "2020-07-22", "label": "September 02, 20", "totalPayment": 0.02, "symbol": "BOL.PA", 'name': 'dsdadads', 'shares' : 22},
    {"paymentDate": "2020-01-17", "label": "September 01, 20", "totalPayment": 0.47, "symbol": "WKL.AS", 'name': 'dsdadads', 'shares' : 2333},
    {"paymentDate": "2020-02-07", "label": "September 01, 20", "totalPayment": 0.47, "symbol": "WKL.AS", 'name': 'dsdadads', 'shares' : 243},
    {"paymentDate": "2020-03-19", "label": "September 01, 20", "totalPayment": 0.002809, "symbol": "ITUB", 'name': 'dsdadads', 'shares' : 33},
    {"paymentDate": "2020-09-06", "label": "September 01, 20", "totalPayment": 0.05, "symbol": "FEI", 'name': 'dsdadads', 'shares' : 238}
  ];
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Column(
                                                children: [
                                                  Text(
                                                    weekdays[DateTime.parse(dividend['paymentDate']).weekday -
                                                            1]
                                                        .toString()
                                                        .capitalizeAll()
                                                        .replaceRange(
                                                  ...
                                                  Text(
                                                    DateTime.parse(dividend['paymentDate']).day.toString(),
                                                    style: TextStyle(
                                                  ...
                                                  children: [
                                                    Column(
                                                      children: [
                                                        ...
                                                        Text(dividend['symbol'], style: TextStyle(color: DarkTheme(isDark).textColor, fontSize: 20)), 
                                                        Text(dividend['name'], style: TextStyle(color: DarkTheme(isDark).textColorVarient))
                                                      ],
                                                    ), 
                                                    Column(
                                                      children: [
                                                        Text((dividend['totalPayment'] * dividend['shares']).toStringAsFixed(2), style: TextStyle(color: DarkTheme(isDark).goldVarient, fontSize: 25)),Text('${dividend['shares']} x ${dividend['totalPayment']}', style: TextStyle(color: DarkTheme(isDark).textColorVarient),)
                                                      ],
                                                    )
                                                  ],
                                                ),
