                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              'Delete Portfolio',
                              style: CustomTextStyles(themeMode).portfolioNameStyle.copyWith(color: UserThemes(themeMode).redVarient),
                            ),
                          ],
                        ),
                      ),
        ...
        children: [
          Container(
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(Units().circularRadius),
                color: UserThemes(widget.themeMode).redVarient.withOpacity(.08)),
            child: Column(
              children: [
                Padding(
                  padding: EdgeInsets.all(10.0),
                  child: Text(
                    ...
                    style: CustomTextStyles(widget.themeMode).feedDescriptonStyle,
                  ),
                ),
                InkWell(
                  // onTap: () async {
                  ...
                  //       .updateUserData(portfolios: mainData['portfolios'], userDetails: data['userDetails']);
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        border: Border(
                            top: BorderSide(color: UserThemes(widget.themeMode).seperator.withOpacity(.5)))),
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'Confirm',
                          style: CustomTextStyles(widget.themeMode).portfolioNameStyle.copyWith(
                              color: UserThemes(widget.themeMode).redVarient, fontWeight: FontWeight.w500),
                        ),
                      ],
                    ),
                  ),
