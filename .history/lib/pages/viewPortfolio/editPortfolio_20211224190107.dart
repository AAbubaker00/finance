...
class _EditPortfolioState extends State<EditPortfolio> {
  ...
  Widget build(BuildContext context) {
    ...
    headerStyle =
        TextStyle(fontSize: 20, color: UserThemes(widget.dataObject.themeMode).textColorVarient, fontWeight: FontWeight.w400);
    subStyle = TextStyle(fontSize: 20, color: UserThemes(widget.dataObject.themeMode).textColor, fontWeight: FontWeight.w600);
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text('Edit', style: CustomTextStyles(widget.dataObject.themeMode).pageHeaderStyle)
                        ],
                      ),
                      InkWell(
                        onTap: () async {
                        ...
                        child: Icon(Icons.done,
                            color: isDataChanged
                                ...
                                : UserThemes(widget.dataObject.themeMode).greenVarient.withOpacity(.5),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: TextFormField(
                                  ...
                                  style: CustomTextStyles(widget.dataObject.themeMode).holdingValueStyle,
                                  decoration: InputDecoration(
                                    hintStyle: TextStyle(
                                        color: UserThemes(widget.dataObject.themeMode).textColor, fontWeight: FontWeight.w400),
                                    hintText: name,
                          ...
                          children: [
                            Text(
                              ...
                              style: CustomTextStyles(widget.dataObject.themeMode)
                                  .portfolioNameStyle
                                  .copyWith(color: UserThemes(widget.dataObject.themeMode).redVarient),
                            ),
                          ],
                        ),
                      ),
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        border:
                            Border(top: BorderSide(color: UserThemes(widget.dataObject.themeMode).seperator.withOpacity(.5)))),
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          ...
                          style: CustomTextStyles(widget.dataObject.themeMode)
                              .portfolioNameStyle
                              .copyWith(color: UserThemes(widget.dataObject.themeMode).redVarient, fontWeight: FontWeight.w500),
                        ),
                      ],
                    ),
                  ),
