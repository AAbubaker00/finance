...
class _MarketOrderState extends State<MarketOrder> {
  ...
  Widget build(BuildContext context) {
    ...
    CustomTextStyles(widget.dataObject.theme).portfolioSubValuetyle = TextStyle(
      color: UserThemes(isDark).textColorVarient,
      fontSize: 20,
      fontWeight: FontWeight.w400,
    );
    CustomTextStyles(widget.dataObject.theme).portfolioNameStyle = TextStyle(color: UserThemes(isDark).textColor, fontWeight: FontWeight.w400, fontSize: 20);
