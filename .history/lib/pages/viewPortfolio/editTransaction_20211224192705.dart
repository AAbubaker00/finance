...
class _MarketOrderState extends State<MarketOrder> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: SafeArea(
        child: Scaffold(
          backgroundColor: UserThemes(widget.dataObject.theme).backgroundColour,
          appBar: AppBar(
            actions: [
              IconButton(
                  onPressed: () {
            ...
            iconTheme: IconThemeData(
              color: UserThemes(widget.dataObject.theme).backColour, //change your color here
            ),
            title: Text(
              'Market Order',
              style:
                  TextStyle(color: UserThemes(widget.dataObject.theme).textColor, fontSize: 20, fontWeight: FontWeight.w400),
            ),
          ),
          body: Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border(
                      top: BorderSide(color: UserThemes(widget.dataObject.theme).border, width: 1),
                      bottom: BorderSide(color: UserThemes(widget.dataObject.theme).border))),
              child: Form(
                key: _formKey,
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'Order Type:',
                            style: CustomTextStyles(widget.dataObject.theme).portfolioSubValuetyle,
                          ),
                          Container(
                            // color: Colors.red,
                            child: DropdownButton<String>(
                              ...
                              items: <String>['Buy', 'Sell'].map<DropdownMenuItem<String>>((String option) {
                                return DropdownMenuItem<String>(
                                  ...
                                  child: Text(
                                    option,
                                    style: TextStyle(color: UserThemes(widget.dataObject.theme).textColor),
                                  ),
                                );
                              }).toList(),
                            ),
                    ...
                    DottedLine(
                      ...
                      lineThickness: 1.0,
                      dashLength: 4.0,
                      dashColor: UserThemes(widget.dataObject.theme).border,
                      dashRadius: 0.0,
                      dashGapLength: 4.0,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'Avalible Shares:',
                            style: CustomTextStyles(widget.dataObject.theme).portfolioSubValuetyle.copyWith(
                              fontWeight: FontWeight.w400,
                              color: UserThemes(widget.dataObject.theme).textColorVarient.withOpacity(.7),
                            ),
                          ),
                          Text(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintStyle: TextStyle(
                                    color: UserThemes(widget.dataObject.theme).textColorVarient, fontWeight: FontWeight.w400),
                                hintText: hintText_1,
                                helperStyle: TextStyle(color: UserThemes(widget.dataObject.theme).textColorVarient),
                                focusedBorder: UnderlineInputBorder(
                                    borderSide: BorderSide(color: UserThemes(widget.dataObject.theme).border)),
                                border: InputBorder.none,
                                enabledBorder: InputBorder.none,
