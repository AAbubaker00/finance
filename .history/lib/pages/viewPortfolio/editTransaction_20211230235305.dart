        ...
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Text("What's coming?", style: CustomTextStyles(widget.dataObject.themeMode).sectionSubTextStyle),
                Text('Calender', style: CustomTextStyles(widget.dataObject.themeMode).pageHeaderStyle)
              ],
            ),
          ),
                Container(
                                  ...
                                  items: <String>['Buy', 'Sell'].map<DropdownMenuItem<String>>((String option) {
                                    return DropdownMenuItem<String>(
                                      ...
                                      child: Text(
                                        option,
                                        style:
                                            TextStyle(color: UserThemes(widget.dataObject.themeMode).textColor),
                                      ),
                                    );
                                  }).toList(),
                                ),
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    focusedBorder: UnderlineInputBorder(
                                        borderSide:
                                            BorderSide(color: UserThemes(widget.dataObject.themeMode).border)),
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'Avalible Shares:',
                                style:
                                    CustomTextStyles(widget.dataObject.themeMode).portfolioSubValuetyle.copyWith(
                                          fontWeight: FontWeight.w400,
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                    color:
                                        UserThemes(widget.dataObject.themeMode).textColorVarient.withOpacity(.7),
                                    fontWeight: FontWeight.w400,
                                    fontSize: 20),
                              ),
                            ],
