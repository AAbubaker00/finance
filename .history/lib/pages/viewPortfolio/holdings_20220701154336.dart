import 'package:Onvest/pages/search/viewInstrument.dart';
...
import 'package:Onvest/shared/widgets.dart';
          ...
          child: Ink(
            ...
            child: Row(
              children: [
                        ...
                        child: Padding(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: CustomTextStyles(widget.dataObject.theme).tableHeaderStyle.copyWith(
                                  color: UserThemes(widget.dataObject.theme).textColorVarient,
                                  fontWeight: FontWeight.w300),
                              isDense: true,
                              labelStyle: CustomTextStyles(widget.dataObject.theme).tableHeaderStyle.copyWith(
                                  color: UserThemes(widget.dataObject.theme).textColorVarient,
                                  fontWeight: FontWeight.w300),
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 2.5, bottom: 2.5, left: 5, right: 3),
                  child: InkWell(
                                ...
                                ? Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        width: 20,
                                        height: 20,
                                        color: UserThemes(widget.dataObject.theme).redVarient.withOpacity(.7),
                                      )),
                                    ),
                                  )
                                : Container(),
