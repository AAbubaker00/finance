                            ...
                            child: Row(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      '${instrument['quote']['fullExchangeName'].toString()}, ${instrument['quote']['symbol']}',
                                      style: CustomTextStyles(themeMode).portfolioNameStyle.copyWith(
                                          color: UserThemes(themeMode).textColorVarient, fontSize: 17),
                                    ),
                                    Text(
                                      'Market Order',
