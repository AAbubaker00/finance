...
class _MarketOrderState extends State<MarketOrder> {
  ...
  double _width, quantity, purchasePrice, outstandingShares;
  ...
  Map instrument = {};
  List changes = [], modifiedPortfolios = [];

  bool isMainLoaded = false, isDateError = false, isAddNewPortfolio = false, isPortfolioSelected = false;
  var themeMode = true;
  ...
  loadData() {
    ...
    if (data['event'] != null && !isMainLoaded) {
      ...
      purchasePrice = double.parse(data['event']['fillPrice'].toString());
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        onChanged: (txt) => setState(() => purchasePrice = double.parse(txt)),
                                      ),
                                    ),
                                  ],
                                ),
