      ...
      child: SafeArea(
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              'Market Order',
              style: TextStyle(color: UserThemes(themeMode).textColor, fontSize: 20, fontWeight: FontWeight.w400),
            ),
          ),
          body: Padding(
            padding: EdgeInsets.symmetric(top: 5.0),
            child: Container(
              padding: EdgeInsets.symmetric(horizontal: 10),
              decoration: BoxDecoration(
                  color: UserThemes(themeMode).summaryColour,
                  border: Border(
                      top: BorderSide(color: UserThemes(themeMode).border, width: 1),
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              dropdownColor: UserThemes(themeMode).summaryColour,
                              icon: Text(
                                selectedEvent,
                                style: subStyle,
                              ),
                              ...
                              items: <String>['Buy', 'Sell'].map<DropdownMenuItem<String>>((String option) {
                                return DropdownMenuItem<String>(
                                  ...
                                  child: Text(
                                    option,
                                    style: TextStyle(color: UserThemes(themeMode).textColor),
                                  ),
                                );
                              }).toList(),
                            ),
                    ...
                    DottedLine(
                      ...
                      lineThickness: 1.0,
                      dashLength: 4.0,
                      dashColor: UserThemes(themeMode).border,
                      dashRadius: 0.0,
                      dashGapLength: 4.0,
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintStyle: TextStyle(
                                    color: UserThemes(themeMode).textColorVarient, fontWeight: FontWeight.w400),
                                hintText: hintText_1,
                                helperStyle: TextStyle(color: UserThemes(themeMode).textColorVarient),
                                focusedBorder: UnderlineInputBorder(
                                    borderSide: BorderSide(color: UserThemes(themeMode).border)),
                                border: InputBorder.none,
                                enabledBorder: InputBorder.none,
