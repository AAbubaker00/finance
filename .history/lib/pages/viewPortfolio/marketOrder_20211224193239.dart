...
class _MarketOrderState extends State<MarketOrder> {
  ...
  Widget build(BuildContext context) {
    ...
    subStyle = TextStyle(color: UserThemes(widget.dataObject.themeMode).textColor, fontWeight: FontWeight.w400, fontSize: 20);
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text('Edit', style: CustomTextStyles(widget.dataObject.themeMode).portfolioNameStyle),
                            Text(
                              'Transaction',
