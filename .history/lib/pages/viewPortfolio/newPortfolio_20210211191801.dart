                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            'Name',
                            style: TextStyle(fontSize: 20, color: DarkTheme().textColorVarient, fontWeight: FontWeight.w400),
                          ),
                        ),
                        Stack(
                          children: [
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  hintStyle: TextStyle(color: DarkTheme().textColorVarient, fontWeight: FontWeight.w400),
                                  hintText: 'Portfolio Name',
                                  focusedBorder:
                                      UnderlineInputBorder(borderSide: BorderSide(color: DarkTheme().border)),
                        ...
                        Padding(
                          ...
                          child: Text(
                            'Base Currency',
                            style: TextStyle(fontSize: 20, color: DarkTheme().textColorVarient, fontWeight: FontWeight.w200),
                          ),
                        ),
                        Stack(
                          ...
                          children: [
                            Align(
                              ...
                              child: DropdownButton<String>(
                                ...
                                icon: Text(
                                  baseCurrency,
                                  style: TextStyle(color: DarkTheme().iconColour, fontWeight: FontWeight.w400),
                                ),
