                          ...
                          children: [
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                style:
                                    TextStyle(fontSize: 25, color: DarkTheme().textColor, fontWeight: FontWeight.w600),
                                decoration: InputDecoration(
                                  hintStyle: TextStyle(color: DarkTheme().textColorVarient, fontWeight: FontWeight.w200),
