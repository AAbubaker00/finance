            ...
            ? InkWell(
                ...
                child: ClipRRect(
                    child: Image.asset('assets/icons/bin.png',
                        width: 21, height: 21, color: UserThemes(dataObjectwidget.dataObject.theme).iconColour)))
            : Container()
      ],
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              Container(
                                child: DropdownButton<String>(
                                  dropdownColor: UserThemes(dataObjectwidget.dataObject.theme).summaryColour,
                                  icon: Text(
                                    selectedEvent,
                        ...
                        Padding(
                          ...
                          child: Divider(
                            color: UserThemes(dataObjectwidget.dataObject.theme).seperator,
                          ),
                        ),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  isCollapsed: true,
                                  hintStyle: TextStyle(
                                      color: UserThemes(dataObjectwidget.dataObject.theme).textColorVarient,
                                      fontWeight: FontWeight.w400),
                                  hintText: hintText_0,
                                  focusedBorder: UnderlineInputBorder(
                                      borderSide:
                                          BorderSide(color: UserThemes(dataObjectwidget.dataObject.theme).border)),
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: hintText_1,
                                  helperStyle:
                                      TextStyle(color: UserThemes(dataObjectwidget.dataObject.theme).textColorVarient),
                                  focusedBorder: UnderlineInputBorder(
                                      borderSide:
                                          BorderSide(color: UserThemes(dataObjectwidget.dataObject.theme).border)),
                                  border: InputBorder.none,
