            ...
            children: [
              InkWell(
                ...
                child: ClipRRect(
                  ...
                  width: 20,
                  height: 20,
                  color: UserThemes(dataObjectwidget.dataObject.theme).textColorVarient.withOpacity(.2),
                )),
              ),
    ...
    return Ink(
      ...
      child: Column(
        ...
        children: [
              ...
              Flexible(
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorStyle: TextStyle(color: UserThemes(dataObjectwidget.dataObject.theme).redVarient),
                  ),
                  onChanged: (txt) {
                    if (txt != '') {
                      isDataChanged = true;
          ...
          //   child:
          //       Divider(thickness: .8, color: UserThemes(dataObjectwidget.dataObject.theme).seperator.withOpacity(.5)),
          // ),
          // Row(
          //   crossAxisAlignment: CrossAxisAlignment.start,
          //   children: [
