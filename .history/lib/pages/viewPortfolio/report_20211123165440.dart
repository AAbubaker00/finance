      ...
      child: SafeArea(
        child: Scaffold(
            ...
            appBar: AppBar(
              ...
              elevation: 0,
              backgroundColor: UserThemes(isDark).backgroundColour,
              title: Text('Analysis', style: TextStyle(color: UserThemes(isDark).textColor, fontSize: 20)),
            ),
            body: Scrollbar(
                      ...
                      Container(
                       ...
                       decoration: BoxDecoration(
                          ...
                          children: [
                            ...
                            Container(
                              height: _height * 0.25,
                              child: CustomeCharts(isDark).customeBarChart(
                                allYearData,
                                years,
                              ),
                            ),
                            Padding(
                              ...
                              child: DataTable(
                                  ...
                                  headingRowColor: MaterialStateProperty.resolveWith<Color>((states) {
                                    return UserThemes(isDark).border;
                                  }),
                                  headingRowHeight: 30,
                        ...
                        padding: EdgeInsets.all(10),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                height: _height * 0.2,
                                child: CustomeCharts(isDark).customeLineChart(
      ...
      BarChartData(
          ...
          titlesData: FlTitlesData(
            ...
            bottomTitles: SideTitles(
              ...
              getTextStyles: (value) => TextStyle(
                  color: UserThemes(isDark).textColorVarient, fontWeight: FontWeight.w500, fontSize: 15),
              margin: 30,
          ...
          gridData: FlGridData(
            ...
            getDrawingHorizontalLine: (value) =>
                FlLine(color: UserThemes(isDark).border.withOpacity(.3), strokeWidth: 1),
