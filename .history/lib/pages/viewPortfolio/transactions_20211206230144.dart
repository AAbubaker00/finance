...
class _TransactionsState extends State<Transactions> with SingleTickerProviderStateMixin {
  ...
  loadData() {
    ...
    setState(() {
      if (!isMainLoaded) {
        ...
        assetCurrency = data['asset']['marketData']['quote']['currency'].toString().capitalizeAll();
  ...
  Widget build(BuildContext context) {
    ...
    isDark = (data['data']['data']['states']['theme']);
    ...
    subStyle = TextStyle(color: UserThemes(isDark).textColor, fontWeight: FontWeight.w400, fontSize: 22);
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
              iconTheme: IconThemeData(
                color: UserThemes(isDark).backColour, //changes your color here
              ),
              elevation: 0,
              backgroundColor: UserThemes(isDark).backgroundColour,
              centerTitle: true,
              title: Text(
                'Orders',
                style:
                    TextStyle(color: UserThemes(isDark).textColor, fontSize: 20, fontWeight: FontWeight.w400),
              ),
              actions: [
                IconButton(
                    icon: Icon(
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text('${data['asset']['marketData']['quote']['longName']}', style: headStyle),
                              SizedBox(height: 5),
                              Row(
                                children: [
                                  Text(
                                  ...
                                  Text(
                                    ' @ ',
                                    style: subStyle.copyWith(color: UserThemes(isDark).textColorVarient),
                                  ),
                                  Text(
                          ...
                          //         ? '${data['asset']['symbol']} Buy Price'
                          //         : '${data['asset']['symbol']} Sell Price',
                          //     style: headStyle),
                          // Text(
                          //   '$assetCurrencySymbol${event['fillPrice'].toStringAsFixed(2)}',
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'Remove',
                            style: TextStyle(fontSize: 20, color: UserThemes(isDark).redVarient),
                          )
                        ],
                      ),
                    ),
                  ...
                  if (portfolio['name'] == data['pName']) {
                    for (var assetType in portfolio['assets']) {
                      for (var stock in assetType['items']) {
                        if (stock['symbol'] == data['asset']['symbol']) {
