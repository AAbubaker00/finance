                          ...
                          child: Ink(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '${widget.dataObject.userCurrencySymbol}${(event['filledQuantity'] * event['fillPrice'] * MarketUpdate(widget.dataObject.userCurrency).getRate(rates, assetCurrency)).toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}',
                                  style: CustomTextStyles(widget.dataObject.themeMode).sectionHeader,
                                ),
                              ],
                            ),
