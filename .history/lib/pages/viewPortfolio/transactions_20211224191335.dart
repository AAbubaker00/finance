...
class Transactions extends StatefulWidget {
  ...
  const Transactions({Key key, this.dataObject}) : super(key: key);
...
class _TransactionsState extends State<Transactions> with SingleTickerProviderStateMixin {
  ...
  loadData() {
    ...
    setState(() {
      ...
      avgPrice = oravgP * MarketUpdate(widget.dataObject.userCurrency).getRate(widget.dataObject.rates, assetCurrency);
  ...
  Widget build(BuildContext context) {
    ...
    subStyle = TextStyle(color: UserThemes(widget.dataObject.themeMode).textColor, fontWeight: FontWeight.w400, fontSize: 22);
                        ...
                        children: [
                          Text(
                            ...
                            style: CustomTextStyles(widget.dataObject.themeMode)
                                .portfolioNameStyle
                                .copyWith(color: UserThemes(widget.dataObject.themeMode).textColorVarient, fontSize: 17),
                          ),
                          Text(
                            'Transactions',
                            style: CustomTextStyles(widget.dataObject.themeMode)
                          ...
                          child: Ink(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '${widget.dataObject.userCurrencySymbol}${(event['filledQuantity'] * event['fillPrice'] * MarketUpdate(widget.dataObject.userCurrency).getRate(widget.dataObject., assetCurrency)).toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}',
                                  style: CustomTextStyles(widget.dataObject.themeMode).sectionHeader,
                                ),
                              ],
                            ),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'Remove',
                            style: TextStyle(fontSize: 20, color: UserThemes(widget.dataObject.themeMode).redVarient),
                          )
                        ],
                      ),
                    ),
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Confirm',
                      style: TextStyle(fontSize: 20, color: UserThemes(widget.dataObject.themeMode).greenVarient),
                    ),
                  ),
                ],
              ),
