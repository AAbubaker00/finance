...
import 'package:Strice/pages/viewPortfolio/editTransaction.dart';
...
class _TransactionsState extends State<Transactions> with SingleTickerProviderStateMixin {
  ...
  loadData() {
    ...
    setState(() {
      if (!isMainLoaded) {
        assetCurrency = widget.dataObject.onHolding['marketData']['quote']['currency'].toString().capitalizeAll();

        ePortfolio = widget.dataObject.onPortfolio;
        ...
        holding = widget.dataObject.onHolding;

        oriEvent = widget.dataObject.onHolding['history'];
                      ...
                      IconButton(
                          ...
                          onPressed: () async {
                            var result = await Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => MarketOrder(dataObject: widget.dataObject),
                        ...
                        InkWell(
                          ...
                          child: Ink(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                    '${widget.dataObject.onHolding['marketData']['quote']['longName'].toString().removeStr()}',
                  ...
                  if (portfolio['name'] == data['pName']) {
                    for (var assetType in portfolio['assets']) {
                      for (var stock in assetType['items']) {
                        if (stock['symbol'] == widget.dataObject.onHolding['symbol']) {
