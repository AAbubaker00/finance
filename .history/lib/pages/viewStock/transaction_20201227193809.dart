    ...
    return Container(
      ...
      child: SafeArea(
        child: Scaffold(
                      ...
                      children: [
                        ...
                        Padding(
                            ...
                            child: Text(
                              'Purchase Date',
                              style:
                                  TextStyle(color: Colors.white, fontWeight: FontWeight.w200, fontSize: 12),
                            ))
                      ],
                    ),
                  )
          ...
          floatingActionButtonLocation: FloatingActionButtonLocation.miniEndDceocked,
            ...
            child: Container(
              child: DecoratedBox(
                decoration: BoxDecoration(
                  ...
                  child: Text('Submit Order', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w200),),
                ),
              ),
            ),
          ),
