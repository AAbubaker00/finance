...
class _ViewStockState extends State<ViewStock> {
  ...
  _getDefaultLineChart() {
    ...
    for (var plot in selectedStock['chartData']['max']['close']) {
      // if (plot == 'null') {
      ...
      print(plot.toString().toString().toStringAsFixed(2));

      // prevValue = double.parse(plot.toStringAsFixed(2));
...
class _ChartData {
  _ChartData(this.price, this.dateIndex);
  final double price;
