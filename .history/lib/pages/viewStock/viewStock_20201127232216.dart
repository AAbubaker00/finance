...
class _ViewStockState extends State<ViewStock> {
  ...
  _getDefaultLineChart() {
    ...
    List maxValues_low = selectedStock['chartData']['max']['low'];
    List maxValues_high = selectedStock['chartData']['max']['high'];
    List maxValues_open = selectedStock['chartData']['max']['open'];
    List maxValues_close = selectedStock['chartData']['max']['close'];
    ...
    return SfCartesianChart(
      ...
      borderWidth: 0,
      zoomPanBehavior: PanAndZoomBehavior,
