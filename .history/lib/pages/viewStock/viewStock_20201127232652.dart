...
class _ViewStockState extends State<ViewStock> {
  ...
  _getDefaultLineChart() {
    ...
    List maxValues_low = selectedStock['chartData']['1mo']['low'];
    List maxValues_high = selectedStock['chartData']['1mo']['high'];
    List maxValues_open = selectedStock['chartData']['1mo']['open'];
    List maxValues_close = selectedStock['chartData']['1mo']['close'];

    for (var date in selectedStock['chartData']['1mo']['timestamp']) {
