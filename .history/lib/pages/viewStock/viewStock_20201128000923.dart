...
class _ViewStockState extends State<ViewStock> {
  ...
  _getDefaultLineChart() {
    ...
    List maxValues_low = selectedStock['chartData']['1d']['low'];
    List maxValues_high = selectedStock['chartData']['1d']['high'];
    List maxValues_open = selectedStock['chartData']['1d']['open'];
    List maxValues_close = selectedStock['chartData']['1d']['close'];

    for (var date in selectedStock['chartData']['1d']['timestamp']) {
    ...
    return SfCartesianChart(
      ...
      indicators: <TechnicalIndicators<dynamic, dynamic>>[
        ...
        SmaIndicator<dynamic, dynamic>(
          isVisible: false,
            seriesName: 'HiloOpenClose', valueField: 'close'),
      ...
      series: <ChartSeries<_ChartData, dynamic>>[
        ...
        FastLineSeries<_ChartData, num>(
            ...
            yValueMapper: (_ChartData sales, _) => sales.i,
            width: 0.5,
