                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [Text('+0.3 ', style: TextStyle(color: Colors.white38, fon)), Text('+6% ', style: TextStyle(color: Colors.white38)), Text('TODAY', style: TextStyle(color: Colors.white38))],
                      )
                    ],
                  ),
                ),
