...
class _ViewStockState extends State<ViewStock> {
  ...
  TextStyle headerStyle = TextStyle(fontSize: 25, color: Colors.white);
  @override
          ...
          body: ListView(
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('price', style: TextStyle(color: Colors.white38),),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [Text('2342342 ', style: TextStyle(color: Colors.white, fontSize: 40)), Text('USD')],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [Text('+0.3 ', style: TextStyle(color: Colors.white38, fontSize: 10)), Text('+6% ', style: TextStyle(color: Colors.white38)), Text('TODAY', style: TextStyle(color: Colors.white38))],
                      )
                    ],
                  ),
                ),
              ...
              Padding(
                ...
                child: Text('Key Ratios', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20),),
              ),
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [Text('Market Cap',style: headerStyle,),Text('23423424')],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
