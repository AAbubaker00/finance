...
class _ViewStockState extends State<ViewStock> {
  ...
  TextStyle sublineStyle = TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold);
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [Text('Sector', style: headerStyle), Text('23423424',style: sublineStyle),],
                    ),
                    Divider(
                      color: Colors.grey[700],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [Text('P/E Ratio', style: headerStyle), Text('23423424',style: sublineStyle),],
                    ),
                    Divider(
                      color: Colors.grey[700],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [Text('REVENUE', style: headerStyle), Text('23423424',style: sublineStyle),],
                    ),
                    Divider(
                      color: Colors.grey[700],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [Text('EPS', style: headerStyle), Text('23423424',style: sublineStyle),],
                    ),
                    Divider(
                      color: Colors.grey[700],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [Text('BETA', style: headerStyle), Text('23423424',style: sublineStyle),],
                    ),
                    Divider(
                      color: Colors.grey[700],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [Text('VOLUME', style: headerStyle), Text('23423424',style: sublineStyle),],
                    ),
                  ],
                ),
              )
