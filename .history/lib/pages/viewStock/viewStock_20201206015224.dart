          ...
          body: ListView(
            children: [
              Row(
                ...
                children: [
                  Text('AAPL ', style: TextStyle(color: Colors.white38)),
                  Icon(Icons.circle, size: 5,color: Colors.white54,),
                  Text(' STOCK ', style: TextStyle(color: Colors.white38)),
                  Icon(Icons.circle, size: 5,color: Colors.white54,),

                  Text(' NASDAQ', style: TextStyle(color: Colors.white38))
                ],
              ),
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        crossAxisAlignment: crosssa,
                        children: [
                          Text('2342342 ', style: TextStyle(color: Colors.white, fontSize: 40)),
                          Text('USD',style: TextStyle(color: Colors.white38,))
                        ],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('+0.3 ', style: TextStyle(color: Colors.white38, )),
                          Text('+6% ', style: TextStyle(color: Colors.white38, )),
