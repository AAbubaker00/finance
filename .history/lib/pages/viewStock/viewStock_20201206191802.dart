            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text(slStock['quote']['market'], style: TextStyle(color: Colors.white38)),
                  Icon(
                    Icons.circle,
                    size: 5,
                    color: Colors.white54,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(slStock['quote']['regularMarketPrice'], style: TextStyle(color: Colors.white, fontSize: 40)),
                          Text(slStock['quote']['curren'],
                              style: TextStyle(
                                color: Colors.white38,
                              ))
                        ],
