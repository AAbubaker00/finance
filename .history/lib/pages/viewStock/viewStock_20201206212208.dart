                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [Text('50 shares', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),), 
                      Text('£637', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold))],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
