                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          '50 shares',
                          style: TextStyle(color: Colors.white, fontWeight: FontWeight.w100, fontSize: 20, fontFamily: Font),
                        ),
                        Text('£637', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 25))
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [Text('50 shares'), Text('£637')],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [Text('50 shares'), Text('£637')],
