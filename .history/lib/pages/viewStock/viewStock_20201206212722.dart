              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [Text('Return', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w400, fontSize: 25)), Text('£637', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w400, fontSize: 25))],
                    ),
                    Divider(
                      color: Colors.grey[700],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [Text('Average Price shares', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w400, fontSize: 25)), Text('£637')],
                    ),
