          ...
          body: ListView(
            children: [
              Row(
                ...
                children: [
                  Text('${slStock['quote']['symbol']} ', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w100)),
                  Icon(
                    Icons.circle,
                    size: 5,
                    color: Colors.white54,
                  ),
                  Text(' ${slStock['quote']['market'].toString()} ', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w100)),
                  Icon(
                    Icons.circle,
                    size: 5,
                    color: Colors.white54,
                  ),
                  Text(' ${slStock['quote']['fullExchangeName']}', style: TextStyle(color: Colors.white))
                ],
              ),
              Padding(
                      ...
                      child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: DecoratedBox(
                                ...
                                child: Center(
                                    child: Text('SELL', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w300))),
                              ),
                            ),
                          ),
                    ),
