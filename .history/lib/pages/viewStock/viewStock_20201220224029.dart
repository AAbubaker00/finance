...
class _ViewStockState extends State<ViewStock> {
  ...
  TextStyle headerStyle = TextStyle(fontSize: 10, color: Colors.white, fontWeight: FontWeight.w100);
  TextStyle sublineStyle = TextStyle(fontSize: 15, color: Colors.white, fontWeight: FontWeight.w300);
