...
class SelectionLineHighlight extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // return new charts.LineChart(seriesList, domainAxis: charts.NumericAxisSpec(
//       showAxisLine: false, renderSpec: charts.NoneRenderSpec()),
//       primaryMeasureAxis: charts.NumericAxisSpec(showAxisLine: false),
// secondaryMeasureAxis: new charts.NumericAxisSpec(
//           tickProviderSpec:
//               new charts.BasicNumericTickProviderSpec(desiredTickCount: 4), showAxisLine: false, ),      animate: animate, );
  }
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    ...
    return [
      new charts.Series<LinearSales, int>(
          ...
          data: data,
          areaColorFn: (_, __) => charts.Color(r: 240, g: 246, b: 244, a: 160),
          colorFn: (_, __) => charts.Color.fromHex(code: "#f4e400"),
          labelAccessorFn: : (_,__) => charts.Color.transparent,
          )
