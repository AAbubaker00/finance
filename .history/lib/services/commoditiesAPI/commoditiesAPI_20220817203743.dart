...
class CommoditiesAPI {
  ...
  List supportedCommodities = [
    {'name': '', 'rate': '', 'symbol': 'BRENTOIL'},
    {'name': '', 'rate': '', 'symbol': 'CANO'},
    {'name': '', 'rate': '', 'symbol': 'COAL'},
    {'name': '', 'rate': '', 'symbol': 'COCOA'},
    {'name': '', 'rate': '', 'symbol': 'COFFEE'},
    {'name': '', 'rate': '', 'symbol': 'CORN'},
    {'name': '', 'rate': '', 'symbol': 'COTTON'},
    {'name': '', 'rate': '', 'symbol': 'CPO'},
    {'name': '', 'rate': '', 'symbol': 'ETHANOL'},
    {'name': '', 'rate': '', 'symbol': 'LCO'},
    {'name': '', 'rate': '', 'symbol': 'LUMBER'},
    {'name': '', 'rate': '', 'symbol': 'NG'},
    {'name': '', 'rate': '', 'symbol': 'NI'},
    {'name': '', 'rate': '', 'symbol': 'OAT'},
    {'name': '', 'rate': '', 'symbol': 'RICE'},
    {'name': '', 'rate': '', 'symbol': 'ROBUSTA'},
