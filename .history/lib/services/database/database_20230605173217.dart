...
class DatabaseService {
  ...
  Stream<QuerySnapshot<Object?>>? get feed {
    try {
  ...
  updateFeed({required PostObject post, required String feedUid, bool isCommentUpdate = false, required Map originalComment}) {
    try {
      if (isCommentUpdate) {
