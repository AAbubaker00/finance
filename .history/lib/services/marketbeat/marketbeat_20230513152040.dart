...
//Getting the response from the targeted url
    ...
    if (response.statusCode == 200) {
      ...
      for (var section in document.getElementsByClassName('m-0 p-0'). .removeRange(6, document.getElementsByClassName('m-0 p-0').length)) {
        print(section.children.first.children.first.text);
      }
    }
  }
