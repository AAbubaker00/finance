...
//Getting the response from the targeted url
    ...
    if (response.statusCode == 200) {
      ...
      debugPrint(document.getElementsByClassName('price')[0].children.first.text.replaceRange(1, document.getElementsByClassName('price')[0].children.first.text.length, '')); //price
      // debugPrint(document.getElementsByClassName('price')[0].children.first.text); //exchange
