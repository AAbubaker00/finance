...
//Getting the response from the targeted url
    ...
    if (response.statusCode == 200) {
      ...
      // debugPrint(document.getElementsByClassName('price')[0].children.first.text.replaceRange(0, 1, '')); //price
      ...
      debugPrint(ForexConversion().currencySymbols.firstWhere((Map currency) => currency['symbol'] == document.getElementsByClassName('price')[0].children.first.text.replaceRange(
          1, document.getElementsByClassName('price')[0].children.first.text.length, ''), orElse: () => null)['short']  ); //symbol
