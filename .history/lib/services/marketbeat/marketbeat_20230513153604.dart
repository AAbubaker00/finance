...
//Getting the response from the targeted url
    ...
    if (response.statusCode == 200) {
      ...
      debugPrint(ForexConversion().currencySymbols.firstWhere(( currency) => currency['symbol'] == document.getElementsByClassName('price')[0].children.first.text.replaceRange(
