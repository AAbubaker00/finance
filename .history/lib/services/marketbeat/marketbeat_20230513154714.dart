...
//Getting the response from the targeted url
    ...
    if (response.statusCode == 200) {
      ...
      debugPrint((document.getElementsByClassName('price')[0].children[1].text.replaceRange(0, 1, '').split(' ').first.replaceRange(document.getElementsByClassName('price')[0].children[1].text.replaceRange(0, 1, '').split(' ').first.indexOf(pattern), end, replacement) ).toString()); //regularmarketPrice
