...
//Getting the response from the targeted url
    ...
    final response = await http.Client().get(Uri.parse('https://www.marketbeat.com/stocks/LON/LLOY/'));
    ...
    if (response.statusCode == 200) {
      ...
      //     .toString()); //regularmarketChangePercentage
      ...
      debugPrint(document.getElementsByClassName('m-0 p-0')[1].children[3].children[1].text); //sector
