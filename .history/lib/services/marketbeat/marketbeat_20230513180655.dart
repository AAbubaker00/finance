...
//Getting the response from the targeted url
    ...
    if (response.statusCode == 200) {
      ...
      debugPrint(document.getElementsByClassName('price')[0].children.first.text.replaceAll(new RegExp(r"\d"), '').replaceAll(' .', '').length.toString().replaceAll('from', replace)); //symbol
