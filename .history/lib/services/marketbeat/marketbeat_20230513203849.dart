...
//Getting the response from the targeted url
  ...
  Future<QuoteObject> getMarketbeatQuoteList(List<QuoteObject> holdings) async {
    try {
      List<Future> resposeFutures = List.generate(
          holdings.length,
          (index) =>
              http.get(Uri.parse('https://www.marketbeat.com/stocks/${getExchange(holdings)}/$symbol/')));
