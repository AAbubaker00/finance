  ...
  Future<QuoteObject> getMarketbeatQuote(Map result) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(document.getElementsByClassName('PageTitleHOne').removeRange(document.getElementsByClassName('PageTitleHOne').first.text.indexOf('pattern'), end).text.indexOf('('));
