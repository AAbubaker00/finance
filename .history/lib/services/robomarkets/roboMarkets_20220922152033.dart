...
class RoboMarketsHolidayObject {
  ...
  RoboMarketsHolidayObject.fromElement(dom.Element element, ) : date = element.children[0].text, country = element.children[1].text, exchange = element.children[2].text, holdiay = element.children[0].text;
}
