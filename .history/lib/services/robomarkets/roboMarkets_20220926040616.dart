...
class RoboMarketsHolidayObject {
  ...
  RoboMarketsHolidayObject.fromElement(
    dom.Element element,
  )   : date = element.children[1].text.toString().removeStr() == 'Canada' || element.children[1].text.toString().removeStr() == 'United States'? element.children[0].text:element.children[0].text,
