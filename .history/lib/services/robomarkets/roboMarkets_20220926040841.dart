...
class RoboMarketsHolidayObject {
  ...
  RoboMarketsHolidayObject.fromElement(
    dom.Element element,
  )   : date = element.children[1].text.toString().removeStr() == 'Canada' ||
                element.children[1].text.toString().removeStr() == 'United States'
            ? DateTime.parse(element.children[0].text).subtract(Duration(days: 1)).toString()
