...
//!  nio?device=console&returnMeta=true
  ...
  Future<Map<String, dynamic>> getAllAssetData({required String symbol, String exchange}) async {
  ...
  Future<QuoteObject> getYahooQuote({String symbol, String exchange}) async {
