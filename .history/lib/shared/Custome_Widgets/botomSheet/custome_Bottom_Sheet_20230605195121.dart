      ...
      children: [
        Padding(
          ...
          child: Container(
              ...
              decoration:
                  CustomDecoration(appBarColourOption: null).curvedContainerDecoration.copyWith(color: backgroundColourVarient),
              child: Row(children: [])),
        ),
        Ink(
          ...
          children: sortOptions
              .map((sort) => Column(
                    children: [
                      ...
                      sortOptions.last == sort ? Container() : CustomDivider(color: null,)
                    ],
                  ))
              .toList(),
        ),
