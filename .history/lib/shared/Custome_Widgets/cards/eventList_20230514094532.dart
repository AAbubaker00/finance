                      ...
                      header: Padding(
                          ...
                          child: Container(
                              ...
                              child: Container(
                                  decoration: BoxDecoration(
                                    color: summaryColour,
                                    // border: Border(bottom: BorderSide(color: seperator, width: .7)),
                                  ),
                      ...
                      sliver: SliverList(
                          delegate: SliverChildBuilderDelegate(
                              (context, index) => Padding(
                                  padding: EdgeInsets.only(bottom: selectedMonth['groupedEvents'].last == groupedEvent && index == groupedEvent['events'].length - 1 ? 90 : 8.0),
