    ...
    return InkWell(
      ...
      child: Container(
        decoration: BoxDecoration(
            border: Border(
                bottom: BorderSide(
                    color: isLast ? Colors.transparent : DarkTheme(isDark).border.withOpacity(.7)))),
        child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              "${stock['symbol']}",
                              style:
                                  TextStyle(color: DarkTheme(isDark).textColor, fontWeight: FontWeight.w500),
                            ),
                          ),
                        ),
                      )
                          ...
                          child: Text(
                              isPrivate
                                  ...
                                  : stock['shares'] > 1000000
                                      ...
                                      : '${stock['shares'].toString().replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} SHARES',
                              style: TextStyle(
                                  color: DarkTheme(isDark).textColorVarient,
                                  fontWeight: FontWeight.w500,
                                  fontSize: 16)),
