                  ...
                  : ClipRRect(
                    ...
                    child: Image.network(stock['logo'],
                        errorBuilder: (context, error, stackTrace) => Container(
                              height: 45, //(ratio <= 1.6) ? _height * 0.06 : _height * 0.2,
                              width: 45, //(ratio <= 1.6) ? _width * 0.045 : _width * 0.11,
                              decoration: BoxDecoration(
                                color: UserThemes(themeMode).backgroundColour,
                                borderRadius: BorderRadius.circular(10),
                              ),
                        ...
                        height: 40, //(ratio <= 1.6) ? _height * 0.06 : _height * 0.2,
                        width: 40, //(ratio <= 1.6) ? _width * 0.045 : _width * 0.11,
