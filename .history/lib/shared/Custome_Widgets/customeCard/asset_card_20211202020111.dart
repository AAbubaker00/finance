                  ...
                  : ClipRRect(
                    ...
                    child: Image.network(stock['logo'],
                        errorBuilder: (context, error, stackTrace) => Container(
                              height: 47, //(ratio <= 1.6) ? _height * 0.06 : _height * 0.2,
                              width: 46, //(ratio <= 1.6) ? _width * 0.045 : _width * 0.11,
                              decoration: BoxDecoration(
                                color: UserThemes(themeMode).backgroundColour,
                    ...
                    children: [
                      FittedBox(
                        ...
                        child: Text(
                            ...
                            style: CustomTextStyles(themeMode).holdingSubSValueStyle),
                      ),
                      Row(
                        children: [
                          FittedBox(
                            ...
                            child: Text(
                                ...
                                style:  CustomTextStyles(themeMode).holdingSubSValueStyle.copyWith(
                                    fontSize: 15,
