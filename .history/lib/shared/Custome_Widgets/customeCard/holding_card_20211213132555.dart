    ...
    return Ink(
      ...
      child: Row(
        ...
        children: [
          ...
          //     child: Image.network(holding['logo'],
          ...
          //         height: 54, //(ratio <= 1.6) ? _height * 0.06 : _height * 0.2,
          //         width: 53, //(ratio <= 1.6) ? _width * 0.045 : _width * 0.11,
              ...
              children: [
                  ...
                  children: [
                    Flexible(
                      child: Padding(
                        ...
                        child: Text(
                          "${holding['marketData']['quote']['longName'].toString()}",
                      ...
                      child: Text(
                        isPrivate
                            ...
                            : holding['value'] > 1000000000
                                ? '$currencySymbol${NumberFormat.compact().format(holding['value'])}'
                ...
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Text(
                          ...
                          style: TextStyle(color: UserThemes(themeMode).textColor, fontWeight: FontWeight.w500, fontSize:19 ),
                        ),
                        Text(
                    ...
                    Text(
                        holding['change'] < 0
                            ? '-$currencySymbol${(holding['change'] * -1).toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} (${(holding['percDiff'] * -1).toStringAsFixed(2)}%)'
                            : '+$currencySymbol${(holding['change']).toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} (${holding['percDiff'].toStringAsFixed(2)}%)',
                        style: CustomTextStyles(themeMode).holdingSubValueStyle.copyWith(
                            color: double.parse(holding['change'].toString()) < 0
