...
class CustomeHoldingCard extends StatelessWidget {
  ...
  CustomeHoldingCard(this.holding, this.ratio, this.isPrivate, this.currencySymbol,
                  ...
                  children: [
                    Flexible(
                      child: Padding(
                        ...
                        child: Text(
                          "${holding['marketzz]} ${holding['marketData']['quote']['longName'].toString().removeStr()}",
