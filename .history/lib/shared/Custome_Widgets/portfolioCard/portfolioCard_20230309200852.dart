  ...
  Widget build(BuildContext context) {
    return Ink(
      ...
      decoration: BoxDecoration(
        ...
        color: VarientColours().customColours[index].withOpacity(.1),
      ),
      child: Column(
                    ...
                    Row(
                      children: [
                        Text(
                            ((portfolio['change'] >= 10000000 || portfolio['change'] <= -10000000)
                                ...
                                : (portfolio['change'] >= 0)
                                    ...
                                    : '-${dataObject.userCurrencySymbol}${(double.parse(portfolio['change'].toString()) * -1).toStringAsFixed(2).addCommas()}') + (${(portfolio['returnPercentage']).toStringAsFixed(2)}%),
                            style: CustomTextStyles(dataObject.theme, dataObject.context)
                                .portfolioNameStyle
                                .copyWith(
                                    fontWeight: FontWeight.w500,
                        ...
                        Padding(
                          ...
                          child: Text('(${(portfolio['returnPercentage']).toStringAsFixed(2)}%)',
                              style: CustomTextStyles(dataObject.theme, dataObject.context)
                                  .portfolioNameStyle
                                  .copyWith(
