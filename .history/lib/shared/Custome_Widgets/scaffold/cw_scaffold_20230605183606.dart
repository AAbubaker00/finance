...
class CWScaffold extends StatelessWidget {
  ...
  const CWScaffold(
      ...
      required this.showFloatingBtn = false,
      ...
      this.isAppBarOnlineBlur = false, this.resizeToAvoidBottomInset = true})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: SafeArea(
        child: Scaffold(
          backgroundColor:
              scaffoldBgColour == BgTheme.DARK ? backgroundColour : summaryColour,
