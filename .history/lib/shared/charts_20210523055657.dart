    ...
    return LineChart(LineChartData(
      ...
      lineTouchData: LineTouchData(
        ...
        touchTooltipData: LineTouchTooltipData(
            tooltipBgColor: DarkTheme(isDark).blueVarient.withOpacity(0.1),
            ...
            getTooltipItems: (List<LineBarSpot> touchedBarSpots) {
              return touchedBarSpots.map((barSpot) {
                ...
                return LineTooltipItem(
                  '${flSpot.y.toInt()} \n${DateTime.parse(cagrData[flSpot.x.toInt()]['date'].toString()).day} ${months[DateTime.parse(cagrData[flSpot.x.toInt()]['date'].toString()).month - 1]} ${months[DateTime.parse(cagrData[flSpot.x.toInt()]['date'].toString()).month - 1]}',
      ...
      lineBarsData: [
        LineChartBarData(
          ...
          belowBarData: BarAreaData(
            ...
            colors: [
              DarkTheme(isDark).blueVarient.withOpacity(.05),
              DarkTheme(isDark).blueVarient.withOpacity(.008)
            ],
          ),
        ),
      ],
