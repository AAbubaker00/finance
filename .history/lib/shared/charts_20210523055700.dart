            ...
            getTooltipItems: (List<LineBarSpot> touchedBarSpots) {
              return touchedBarSpots.map((barSpot) {
                ...
                return LineTooltipItem(
                  '${flSpot.y.toInt()} \n${DateTime.parse(cagrData[flSpot.x.toInt()]['date'].toString()).day} ${months[DateTime.parse(cagrData[flSpot.x.toInt()]['date'].toString()).month - 1]} ${months[DateTime.parse(cagrData[flSpot.x.toInt()]['date'].toString()).year - 1]}',
