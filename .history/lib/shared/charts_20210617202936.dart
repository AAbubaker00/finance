    ...
    return LineChart(LineChartData(
      gridData: FlGridData(
        ...
        getDrawingHorizontalLine: (value) =>
            FlLine(color: DarkTheme(isDark).border.withOpacity(.7), strokeWidth: 1),
      ),
      titlesData: FlTitlesData(
        ...
        leftTitles: SideTitles(
          ...
          getTextStyles: (value) => TextStyle(
            letterSpacing: 0,
            color: DarkTheme(isDark).chartTextColour.withOpacity(.7),
            fontSize: 10,
          ),
          reservedSize: 35,
        ),
      ...
      lineBarsData: [
        LineChartBarData(
          ...
          belowBarData: BarAreaData(
            ...
            colors: [
              DarkTheme(isDark).blueVarient.withOpacity(.07),
              DarkTheme(isDark).blueVarient.withOpacity(.010)
            ],
          ),
        ),
      ],
