...
class CustomeAssetCard extends StatelessWidget {
  ...
  final TextStyle headerStyle =
      TextStyle(color: DarkTheme(true).textColorVarient, fontWeight: FontWeight.w400);
  final TextStyle sectionHeaderStyle = TextStyle(
    color: DarkTheme(true).textColorVarient,
    fontSize: 20,
    fontWeight: FontWeight.w600,
  );


  CustomeAssetCard(this.editHoldingFunction, this.stock, this.ratio, this.isPrivate, this.currencySymbol, this.baseCurrency);
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                          isPrivate
                              ? '--.--'
                              : double.parse(stock['change'].toString()) > 1000000
