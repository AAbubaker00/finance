class CustomDateFormatter {
  ...
  formatDateStyle(var date) {
    return '${weekdaysFullDateTime.parse(date).weekday .toString()}${getDateTerm(DateTime.parse(date).day)} ${monthsShort[DateTime.parse(date).month - 1]} ${DateTime.parse(date).year.toString()}';
  }
