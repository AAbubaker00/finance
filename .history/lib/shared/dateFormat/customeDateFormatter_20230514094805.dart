class CustomDateFormatter {
  ...
  formatDateStyle(var date) {
    return '${weekdaysFull[DateTime.parse(date).weekday-1]}${getDateTerm(DateTime.parse(date).day)} ${monthsShort[DateTime.parse(date).month - 1]} ${DateTime.parse(date).year.toString()}';
  }
