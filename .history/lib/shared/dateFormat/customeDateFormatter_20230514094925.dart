class CustomDateFormatter {
  ...
  formatDateWeekdays(var date) {
    return '${weekdaysFull[DateTime.parse(date).day-1]} ${DateTime.parse(date).day.toString()}${getDateTerm(DateTime.parse(date).day)} ${monthsShort[DateTime.parse(date).month - 1]} ${DateTime.parse(date).year.toString()}';
  }
