class CustomDateFormatter {
  ...
  formatDateWeekdays(var date) {
    return '${weekdaysFull[DateTime.parse(date).weekday-1]} ${DateTime.parse(date).day.toString()}${getDateTerm(DateTime.parse(date).day)} ${monthsShort[DateTime.parse(date).month - 1]} ${DateTime.parse(date).year.toString()}';
  }
