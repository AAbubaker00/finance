        ...
        builder: (context) => Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Flexible(child: Text('Unable to connect to. Please check your connection and try again.', textAlign: TextAlign.center, style: TextStyle(color: DarkTheme(isDark).textColor, font),))
                    ],
                  )
                ],
              ),
