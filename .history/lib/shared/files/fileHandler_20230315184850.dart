...
class LocalDataSet {
  updateLocalData(DataObject dataObject) async {
    ...
    await writePortfolios(decodedData);
  }

  updateLocalDataSring(String data) async {
    await writePortfolios('');
  }

  writePortfolios(String text) async {
    final Directory directory = await getApplicationDocumentsDirectory();
    final File file = File('${directory.path}/LocalCalenderEventsDataSet.json');
