          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                    holding.change < 0
                        ? '-${dataObject.userCurrencySymbol}${(holding.change * -1).toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} (${(earningsPecentage * -1).toStringAsFixed(2).addCommas()}%)'
