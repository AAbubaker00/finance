...
class CustomInputDecoration extends InputDecoration {
  ...
  CustomInputDecoration(this.text, this.context, this.isBorder,
      {this.prefixIcon,
      this.contentPadding = const EdgeInsets.only(left: 15, top: 15, bottom: 15),
      this.radius = 50})
      : this.hintStyle =
            CustomTextStyles(context).portfolioNameStyle.copyWith(color: textColor.withOpacity(.7)),
        ...
        this.enabledBorder = OutlineInputBorder(
          borderSide: new BorderSide(color: seperator.withOpacity(.7), width: .7),
          borderRadius: new BorderRadius.circular(radius),
        ),
