...
class NewsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Ink(
        decoration: CustomDecoration(dataObject.theme).curvedContainerDecoration,
        padding: EdgeInsets.s(5),
        child: Row(
                ...
                ? Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(feed.imgURL,
                          ...
                          height: 70, //(ratio <= 1.6) ? _height * 0.06 : _height * 0.2,
                          width: 70, //(ratio <= 1.6) ? _width * 0.045 : _width * 0.11,
                          fit: BoxFit.contain),
                    ),
                  )
                : Container()
