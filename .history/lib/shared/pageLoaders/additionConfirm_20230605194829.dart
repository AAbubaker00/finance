...
class AdditionCompletedNotification extends StatelessWidget {
  const AdditionCompletedNotification({required this.isStock, required this.name, required this.secondaryName});
  ...
  Widget build(BuildContext context) {
    return CWScaffold(
      ...
      appBarActions: [], appBarBottomWidget: null, appBarTitle: '', appBarTitleWidget: null, appBarWidget: null, customFloatinfActionButtonWidget: null, floatingActionButttonLocation: null, floatingBtnFunction: null, isCenter: null,
    );
  }
}
