        ...
        children: [
          Padding(
            ...
            child: Container(
              ...
              decoration: CustomDecoration(dataObject.theme, true).baseContainerDecoration,
              // .copyWith(
              //     color:
              ...
              child: Row(
                ...
                children: [
                  ...
                  CircleAvatar(
                    backgroundColor: dividend.dividendType == 'ex'
                        ? UserThemes(dataObject.theme).purpleVarient.withOpacity(.8)
                        : UserThemes(dataObject.theme).goldVarient.withOpacity(.8),
                    radius: 4,
                  ),
                ],
              ),
          ...
          InkWell(
            ...
            child: Ink(
              padding: EdgeInsets.all(10),
              decoration: CustomDecoration(dataObject.theme, false).baseContainerDecoration,
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('dividend.name', style: CustomTextStyles(dataObject.theme).tableHeaderStyle),
                      Text(dividend.yield,
                    ...
                    children: [
                      ...
                      Text(
                          dividend.dividendType == 'ex'
                              ? '${dividend.amount}'
                              : '+${dividend.amount[0]}${(double.parse((dividend.amount.replaceRange(0, 1, '').toString())) * dividend.shares).toStringAsFixed(2)}',
                          style: CustomTextStyles(dataObject.theme)
