...
class ShimmerHome extends StatelessWidget {
  ...
  const ShimmerHome({Key key, this.dataObject, this.theme}) : super(key: key);
    ...
    return CWScaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Shimmer.fromColors(
            ...
            baseColor: UserThemes(dataObject == null ? theme : dataObject.theme).summaryColour,
            highlightColor: UserThemes(dataObject==null? theme:dataObject.theme).textColorVarient,
            child: GridView(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: CustomDecoration(
                                      dataObject == null ? theme : dataObject.theme, true)
