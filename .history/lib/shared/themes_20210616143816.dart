...
class DarkTheme {
  ...
  DarkTheme(this.isDark) {
    ...
    backgroundColour = isDark ? Color(0xFF2E313B) : Color(0xFFECEDF1);
    iconColour = isDark ? Color(0xFFDFE8FE) : Color(0xFF000000).withOpacity(.87);
    summaryColour = isDark ? Color(0xFF363845) : Color(0xFFFEFEFE);
    insideColour = isDark ? Color(0xFF363845) : Color(0xFFFEFEFE);
    ...
    redVarient = isDark ? Color(0xFFE24C4F) : Color(0xFFE24C4F);
    greenVarient = isDark ? Color(0xFF30C196) : Color(0xFF30C196);
    purpleVarient = Color(0xFF7D55C7);
  ...
  Color secondary = Color(0xFF8e94ab);
