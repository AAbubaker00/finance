...
class MarketUpdate {
  ...
  updateValues(List portfolios, BuildContext context, Map data) {
    ...
    getRates();
    return getMarketData(portfolios, context, data);
  }
  ...
  Future<List> getMarketData(List portfolios, BuildContext context, Map data) async {
...
holding['marketData'] =
    ...
    assetFilter.forEach((asset) async {
