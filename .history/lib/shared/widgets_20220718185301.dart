...
class HoldingViewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Ink(
      decoration: CustomDecoration(dataObject.dataObject.theme).curvedBaseContainerDecoration,
              ...
              Flexible(
                child: Padding(
                  ...
                  child: Text(
                    ...
                    style: CustomTextStyles(dataObject.theme, context).portfolioNameStyle,
              ...
              Text(
                isPrivate
                    ...
                    : holding['value'] > 1000000000
                        ...
                        : '${dataObject.userCurrencySymbol}currencySymbol${holding['value'].toStringAsFixed(2).replaceAllMapped(new RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}',
                style: CustomTextStyles(dataObject.theme, context).holdingValueStyle,
                softWrap: true,
              ),
            ],
          ),
                ...
                Row(
                  children: [
                    ...
                    Text(
                        ...
                        style: CustomTextStyles(dataObject.theme, context).holdingSubValueStyle),
                  ],
                ),
                Ink(
                  ...
                  child: FittedBox(
                    ...
                    child: Text(
                        ...
                        style: CustomTextStyles(dataObject.theme, context).holdingSubValueStyle.copyWith(
...
class Investment {
  Widget getInvestment(
      {holding, dataObject.theme, DataObject dataObject, context, String returnOption, bool isPrivate}) {
