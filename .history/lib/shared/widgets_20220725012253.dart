...
class HoldingViewCard extends StatelessWidget {
  ...
  const HoldingViewCard({Key key, this.holding, this.dataObject, this.returnOption, this.isPrivate, this.isCoin = false})
      : super(key: key);
            ...
            children: [
              Flexible(
                child: Padding(
                  ...
                  child: Text(
                    isCoin? holding['name']: holding['marketData']['quote'].containsKey('longName')
