...
class HoldingViewCard extends StatelessWidget {
  ...
  const HoldingViewCard(
      {Key key, this.holding, this.dataObject, this.returnOption, this.isPrivate, this.isCoin = false})
      : super(key: key);
                ...
                Row(
                  children: [
                    ...
                    Text(
                        ...
                        style: CustomTextStyles(dataObject.theme, dataObject.context).holdingSubValueStyle.copyWith(color: UserThemes(dataObject.theme).blueVarient.withOpacity(.4))),
                  ],
                ),
                Ink(
