        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text('Comments', style: CustomTextStyles(widget.dataObject.context).sectionHeader),
                Padding(
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              onTap: () async {
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  await DatabaseService().updateFeed(
                                      post: widget.post, feedUid: widget.feedUid, originalComment: {});
                              ...
                              child: Image.asset(
                                ...
                                width: 25,
                                height: 25,
                                color: purpleVarient.withOpacity(comment.isEmpty ? .5 : 1),
                              ),
                            ),
                          ),
                        ],
