...
class Terms extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //           to it, still belong to Interfekt.
    //         </p> <p>
    //           Interfekt is committed to ensuring that the app is
    ...
    //         </p> <p>
    //           The Valuid app stores and processes personal data that
    ...
    //           that the Valuid app won’t work properly or at all.
    //         </p> <div><p>
    ...
    //           Interfekt will not take responsibility for. Certain
    //           functions of the app will require the app to have an active
    //           internet connection. The connection can be Wi-Fi or provided
    //           by your mobile network provider, but Interfekt
    ...
    //         </p> <p>
    //           Along the same lines, Interfekt cannot always take
    //           responsibility for the way you use the app i.e. You need to
    //           make sure that your device stays charged – if it runs out of
    //           battery and you can’t turn it on to avail the Service,
    //           Interfekt cannot accept responsibility.
    //         </p> <p>
    //           With respect to Interfekt’s responsibility for your
    //           use of the app, when you’re using the app, it’s important to
    //           bear in mind that although we endeavor to ensure that it is
    //           updated and correct at all times, we do rely on third parties
    //           to provide information to us so that we can make it available
    //           to you. Interfekt accepts no liability for any
    ...
    //           using the app. Interfekt does not promise that it
...
class Privacy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //             Interfekt built the Valuid app as
    //             an Ad Supported app. This SERVICE is provided by
    //             Interfekt at no cost and is intended for use as
    //             is.
    //           </p> <p>
    ...
    //             Valuid unless otherwise defined in this Privacy Policy.
    ...
    //             this page.
    //           </p> <p>This policy is effective as of 2022-07-07</p> <p><strong>Contact Us</strong></p> <p>
    //             If you have any questions or suggestions about our
    //             Privacy Policy, do not hesitate to contact us at a.a.abubaker00@gmail.com.
