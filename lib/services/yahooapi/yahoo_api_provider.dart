...
//   Future<QuoteObject> getYahooQuote({required String symbol, required String exchange}) async {
...
//   //                                                                                     //
  ...
  Future<List> getTickerSearchResultUpdated({required String search}) async {
  ...
  Future<List> getTickerSearchResult({required String search}) async {
